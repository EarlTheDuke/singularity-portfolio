...
`)+`
`+p);const M=w+m+o,_=w+p+a,T=yl(s,s.VERTEX_SHADER,M),b=yl(s,s.FRAGMENT_SHADER,_);s.attachShader(x,T),s.attachShader(x,b),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function v(P){if(i.debug.checkShaderErrors){const W=s.getProgramInfoLog(x).trim(),q=s.getShaderInfoLog(T).trim(),V=s.getShaderInfoLog(b).trim();let O=!0,B=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(O=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,T,b);else{const Z=Sl(s,T,"vertex"),H=Sl(s,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
Program Info Log: `+W+`
`+Z+`
`+H)}else W!==""?console.warn("THREE.WebGLProgram: Program Info Log:",W):(q===""||V==="")&&(B=!1);B&&(P.diagnostics={runnable:O,programLog:W,vertexShader:{log:q,prefix:m},fragmentShader:{log:V,prefix:p}})}s.deleteShader(T),s.deleteShader(b),C=new Zr(s,x),S=Y0(s,x)}let C;this.getUniforms=function(){return C===void 0&&v(this),C};let S;this.getAttributes=function(){return S===void 0&&v(this),S};let y=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return y===!1&&(y=s.getProgramParameter(x,B0)),y},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(x),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=k0++,this.cacheKey=t,this.usedTimes=1,this.program=x,this.vertexShader=T,this.fragmentShader=b,this}let rg=0;class og{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t){const e=t.vertexShader,n=t.fragmentShader,s=this._getShaderStage(e),r=this._getShaderStage(n),o=this._getShaderCacheForMaterial(t);return o.has(s)===!1&&(o.add(s),s.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(t){const e=this.materialCache.get(t);for(const n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderID(t){return this._getShaderStage(t.vertexShader).id}getFragmentShaderID(t){return this._getShaderStage(t.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){const e=this.materialCache;let n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){const e=this.shaderCache;let n=e.get(t);return n===void 0&&(n=new ag(t),e.set(t,n)),n}}class ag{constructor(t){this.id=rg++,this.code=t,this.usedTimes=0}}function cg(i,t,e,n,s,r,o){const a=new xc,c=new og,l=new Set,u=[],h=s.logarithmicDepthBuffer,d=s.vertexTextures;let f=s.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function x(S){return l.add(S),S===0?"uv":`uv${S}`}function m(S,y,P,W,q){const V=W.fog,O=q.geometry,B=S.isMeshStandardMaterial?W.environment:null,Z=(S.isMeshStandardMaterial?e:t).get(S.envMap||B),H=Z&&Z.mapping===lo?Z.image.height:null,Y=g[S.type];S.precision!==null&&(f=s.getMaxPrecision(S.precision),f!==S.precision&&console.warn("THREE.WebGLProgram.getParameters:",S.precision,"not supported, using",f,"instead."));const vt=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,X=vt!==void 0?vt.length:0;let et=0;O.morphAttributes.position!==void 0&&(et=1),O.morphAttributes.normal!==void 0&&(et=2),O.morphAttributes.color!==void 0&&(et=3);let ft,Q,nt,gt;if(Y){const ae=Pn[Y];ft=ae.vertexShader,Q=ae.fragmentShader}else ft=S.vertexShader,Q=S.fragmentShader,c.update(S),nt=c.getVertexShaderID(S),gt=c.getFragmentShaderID(S);const it=i.getRenderTarget(),st=i.state.buffers.depth.getReversed(),L=q.isInstancedMesh===!0,U=q.isBatchedMesh===!0,G=!!S.map,k=!!S.matcap,j=!!Z,D=!!S.aoMap,mt=!!S.lightMap,rt=!!S.bumpMap,xt=!!S.normalMap,ct=!!S.displacementMap,Et=!!S.emissiveMap,z=!!S.metalnessMap,A=!!S.roughnessMap,E=S.anisotropy>0,$=S.clearcoat>0,ut=S.dispersion>0,pt=S.iridescence>0,ht=S.sheen>0,Ft=S.transmission>0,Tt=E&&!!S.anisotropyMap,Dt=$&&!!S.clearcoatMap,te=$&&!!S.clearcoatNormalMap,yt=$&&!!S.clearcoatRoughnessMap,Lt=pt&&!!S.iridescenceMap,Xt=pt&&!!S.iridescenceThicknessMap,qt=ht&&!!S.sheenColorMap,Ut=ht&&!!S.sheenRoughnessMap,se=!!S.specularMap,Zt=!!S.specularColorMap,de=!!S.specularIntensityMap,K=Ft&&!!S.transmissionMap,Ct=Ft&&!!S.thicknessMap,lt=!!S.gradientMap,_t=!!S.alphaMap,Rt=S.alphaTest>0,Pt=!!S.alphaHash,Yt=!!S.extensions;let we=ci;S.toneMapped&&(it===null||it.isXRRenderTarget===!0)&&(we=i.toneMapping);const Ie={shaderID:Y,shaderType:S.type,shaderName:S.name,vertexShader:ft,fragmentShader:Q,defines:S.defines,customVertexShaderID:nt,customFragmentShaderID:gt,isRawShaderMaterial:S.isRawShaderMaterial===!0,glslVersion:S.glslVersion,precision:f,batching:U,batchingColor:U&&q._colorsTexture!==null,instancing:L,instancingColor:L&&q.instanceColor!==null,instancingMorph:L&&q.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:it===null?i.outputColorSpace:it.isXRRenderTarget===!0?it.texture.colorSpace:vs,alphaToCoverage:!!S.alphaToCoverage,map:G,matcap:k,envMap:j,envMapMode:j&&Z.mapping,envMapCubeUVHeight:H,aoMap:D,lightMap:mt,bumpMap:rt,normalMap:xt,displacementMap:d&&ct,emissiveMap:Et,normalMapObjectSpace:xt&&S.normalMapType===ed,normalMapTangentSpace:xt&&S.normalMapType===Hu,metalnessMap:z,roughnessMap:A,anisotropy:E,anisotropyMap:Tt,clearcoat:$,clearcoatMap:Dt,clearcoatNormalMap:te,clearcoatRoughnessMap:yt,dispersion:ut,iridescence:pt,iridescenceMap:Lt,iridescenceThicknessMap:Xt,sheen:ht,sheenColorMap:qt,sheenRoughnessMap:Ut,specularMap:se,specularColorMap:Zt,specularIntensityMap:de,transmission:Ft,transmissionMap:K,thicknessMap:Ct,gradientMap:lt,opaque:S.transparent===!1&&S.blending===rs&&S.alphaToCoverage===!1,alphaMap:_t,alphaTest:Rt,alphaHash:Pt,combine:S.combine,mapUv:G&&x(S.map.channel),aoMapUv:D&&x(S.aoMap.channel),lightMapUv:mt&&x(S.lightMap.channel),bumpMapUv:rt&&x(S.bumpMap.channel),normalMapUv:xt&&x(S.normalMap.channel),displacementMapUv:ct&&x(S.displacementMap.channel),emissiveMapUv:Et&&x(S.emissiveMap.channel),metalnessMapUv:z&&x(S.metalnessMap.channel),roughnessMapUv:A&&x(S.roughnessMap.channel),anisotropyMapUv:Tt&&x(S.anisotropyMap.channel),clearcoatMapUv:Dt&&x(S.clearcoatMap.channel),clearcoatNormalMapUv:te&&x(S.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:yt&&x(S.clearcoatRoughnessMap.channel),iridescenceMapUv:Lt&&x(S.iridescenceMap.channel),iridescenceThicknessMapUv:Xt&&x(S.iridescenceThicknessMap.channel),sheenColorMapUv:qt&&x(S.sheenColorMap.channel),sheenRoughnessMapUv:Ut&&x(S.sheenRoughnessMap.channel),specularMapUv:se&&x(S.specularMap.channel),specularColorMapUv:Zt&&x(S.specularColorMap.channel),specularIntensityMapUv:de&&x(S.specularIntensityMap.channel),transmissionMapUv:K&&x(S.transmissionMap.channel),thicknessMapUv:Ct&&x(S.thicknessMap.channel),alphaMapUv:_t&&x(S.alphaMap.channel),vertexTangents:!!O.attributes.tangent&&(xt||E),vertexColors:S.vertexColors,vertexAlphas:S.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,pointsUvs:q.isPoints===!0&&!!O.attributes.uv&&(G||_t),fog:!!V,useFog:S.fog===!0,fogExp2:!!V&&V.isFogExp2,flatShading:S.flatShading===!0,sizeAttenuation:S.sizeAttenuation===!0,logarithmicDepthBuffer:h,reverseDepthBuffer:st,skinning:q.isSkinnedMesh===!0,morphTargets:O.morphAttributes.position!==void 0,morphNormals:O.morphAttributes.normal!==void 0,morphColors:O.morphAttributes.color!==void 0,morphTargetsCount:X,morphTextureStride:et,numDirLights:y.directional.length,numPointLights:y.point.length,numSpotLights:y.spot.length,numSpotLightMaps:y.spotLightMap.length,numRectAreaLights:y.rectArea.length,numHemiLights:y.hemi.length,numDirLightShadows:y.directionalShadowMap.length,numPointLightShadows:y.pointShadowMap.length,numSpotLightShadows:y.spotShadowMap.length,numSpotLightShadowsWithMaps:y.numSpotLightShadowsWithMaps,numLightProbes:y.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:S.dithering,shadowMapEnabled:i.shadowMap.enabled&&P.length>0,shadowMapType:i.shadowMap.type,toneMapping:we,decodeVideoTexture:G&&S.map.isVideoTexture===!0&&oe.getTransfer(S.map.colorSpace)===fe,decodeVideoTextureEmissive:Et&&S.emissiveMap.isVideoTexture===!0&&oe.getTransfer(S.emissiveMap.colorSpace)===fe,premultipliedAlpha:S.premultipliedAlpha,doubleSided:S.side===Re,flipSided:S.side===$e,useDepthPacking:S.depthPacking>=0,depthPacking:S.depthPacking||0,index0AttributeName:S.index0AttributeName,extensionClipCullDistance:Yt&&S.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Yt&&S.extensions.multiDraw===!0||U)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:S.customProgramCacheKey()};return Ie.vertexUv1s=l.has(1),Ie.vertexUv2s=l.has(2),Ie.vertexUv3s=l.has(3),l.clear(),Ie}function p(S){const y=[];if(S.shaderID?y.push(S.shaderID):(y.push(S.customVertexShaderID),y.push(S.customFragmentShaderID)),S.defines!==void 0)for(const P in S.defines)y.push(P),y.push(S.defines[P]);return S.isRawShaderMaterial===!1&&(w(y,S),M(y,S),y.push(i.outputColorSpace)),y.push(S.customProgramCacheKey),y.join()}function w(S,y){S.push(y.precision),S.push(y.outputColorSpace),S.push(y.envMapMode),S.push(y.envMapCubeUVHeight),S.push(y.mapUv),S.push(y.alphaMapUv),S.push(y.lightMapUv),S.push(y.aoMapUv),S.push(y.bumpMapUv),S.push(y.normalMapUv),S.push(y.displacementMapUv),S.push(y.emissiveMapUv),S.push(y.metalnessMapUv),S.push(y.roughnessMapUv),S.push(y.anisotropyMapUv),S.push(y.clearcoatMapUv),S.push(y.clearcoatNormalMapUv),S.push(y.clearcoatRoughnessMapUv),S.push(y.iridescenceMapUv),S.push(y.iridescenceThicknessMapUv),S.push(y.sheenColorMapUv),S.push(y.sheenRoughnessMapUv),S.push(y.specularMapUv),S.push(y.specularColorMapUv),S.push(y.specularIntensityMapUv),S.push(y.transmissionMapUv),S.push(y.thicknessMapUv),S.push(y.combine),S.push(y.fogExp2),S.push(y.sizeAttenuation),S.push(y.morphTargetsCount),S.push(y.morphAttributeCount),S.push(y.numDirLights),S.push(y.numPointLights),S.push(y.numSpotLights),S.push(y.numSpotLightMaps),S.push(y.numHemiLights),S.push(y.numRectAreaLights),S.push(y.numDirLightShadows),S.push(y.numPointLightShadows),S.push(y.numSpotLightShadows),S.push(y.numSpotLightShadowsWithMaps),S.push(y.numLightProbes),S.push(y.shadowMapType),S.push(y.toneMapping),S.push(y.numClippingPlanes),S.push(y.numClipIntersection),S.push(y.depthPacking)}function M(S,y){a.disableAll(),y.supportsVertexTextures&&a.enable(0),y.instancing&&a.enable(1),y.instancingColor&&a.enable(2),y.instancingMorph&&a.enable(3),y.matcap&&a.enable(4),y.envMap&&a.enable(5),y.normalMapObjectSpace&&a.enable(6),y.normalMapTangentSpace&&a.enable(7),y.clearcoat&&a.enable(8),y.iridescence&&a.enable(9),y.alphaTest&&a.enable(10),y.vertexColors&&a.enable(11),y.vertexAlphas&&a.enable(12),y.vertexUv1s&&a.enable(13),y.vertexUv2s&&a.enable(14),y.vertexUv3s&&a.enable(15),y.vertexTangents&&a.enable(16),y.anisotropy&&a.enable(17),y.alphaHash&&a.enable(18),y.batching&&a.enable(19),y.dispersion&&a.enable(20),y.batchingColor&&a.enable(21),S.push(a.mask),a.disableAll(),y.fog&&a.enable(0),y.useFog&&a.enable(1),y.flatShading&&a.enable(2),y.logarithmicDepthBuffer&&a.enable(3),y.reverseDepthBuffer&&a.enable(4),y.skinning&&a.enable(5),y.morphTargets&&a.enable(6),y.morphNormals&&a.enable(7),y.morphColors&&a.enable(8),y.premultipliedAlpha&&a.enable(9),y.shadowMapEnabled&&a.enable(10),y.doubleSided&&a.enable(11),y.flipSided&&a.enable(12),y.useDepthPacking&&a.enable(13),y.dithering&&a.enable(14),y.transmission&&a.enable(15),y.sheen&&a.enable(16),y.opaque&&a.enable(17),y.pointsUvs&&a.enable(18),y.decodeVideoTexture&&a.enable(19),y.decodeVideoTextureEmissive&&a.enable(20),y.alphaToCoverage&&a.enable(21),S.push(a.mask)}function _(S){const y=g[S.type];let P;if(y){const W=Pn[y];P=ms.clone(W.uniforms)}else P=S.uniforms;return P}function T(S,y){let P;for(let W=0,q=u.length;W<q;W++){const V=u[W];if(V.cacheKey===y){P=V,++P.usedTimes;break}}return P===void 0&&(P=new sg(i,y,S,r),u.push(P)),P}function b(S){if(--S.usedTimes===0){const y=u.indexOf(S);u[y]=u[u.length-1],u.pop(),S.destroy()}}function v(S){c.remove(S)}function C(){c.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:_,acquireProgram:T,releaseProgram:b,releaseShaderCache:v,programs:u,dispose:C}}function lg(){let i=new WeakMap;function t(o){return i.has(o)}function e(o){let a=i.get(o);return a===void 0&&(a={},i.set(o,a)),a}function n(o){i.delete(o)}function s(o,a,c){i.get(o)[a]=c}function r(){i=new WeakMap}return{has:t,get:e,remove:n,update:s,dispose:r}}function ug(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.material.id!==t.material.id?i.material.id-t.material.id:i.z!==t.z?i.z-t.z:i.id-t.id}function Al(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.z!==t.z?t.z-i.z:i.id-t.id}function Cl(){const i=[];let t=0;const e=[],n=[],s=[];function r(){t=0,e.length=0,n.length=0,s.length=0}function o(h,d,f,g,x,m){let p=i[t];return p===void 0?(p={id:h.id,object:h,geometry:d,material:f,groupOrder:g,renderOrder:h.renderOrder,z:x,group:m},i[t]=p):(p.id=h.id,p.object=h,p.geometry=d,p.material=f,p.groupOrder=g,p.renderOrder=h.renderOrder,p.z=x,p.group=m),t++,p}function a(h,d,f,g,x,m){const p=o(h,d,f,g,x,m);f.transmission>0?n.push(p):f.transparent===!0?s.push(p):e.push(p)}function c(h,d,f,g,x,m){const p=o(h,d,f,g,x,m);f.transmission>0?n.unshift(p):f.transparent===!0?s.unshift(p):e.unshift(p)}function l(h,d){e.length>1&&e.sort(h||ug),n.length>1&&n.sort(d||Al),s.length>1&&s.sort(d||Al)}function u(){for(let h=t,d=i.length;h<d;h++){const f=i[h];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:e,transmissive:n,transparent:s,init:r,push:a,unshift:c,finish:u,sort:l}}function hg(){let i=new WeakMap;function t(n,s){const r=i.get(n);let o;return r===void 0?(o=new Cl,i.set(n,[o])):s>=r.length?(o=new Cl,r.push(o)):o=r[s],o}function e(){i=new WeakMap}return{get:t,dispose:e}}function dg(){const i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new R,color:new Wt};break;case"SpotLight":e={position:new R,direction:new R,color:new Wt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new R,color:new Wt,distance:0,decay:0};break;case"HemisphereLight":e={direction:new R,skyColor:new Wt,groundColor:new Wt};break;case"RectAreaLight":e={color:new Wt,position:new R,halfWidth:new R,halfHeight:new R};break}return i[t.id]=e,e}}}function fg(){const i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new dt};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new dt};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new dt,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[t.id]=e,e}}}let pg=0;function mg(i,t){return(t.castShadow?2:0)-(i.castShadow?2:0)+(t.map?1:0)-(i.map?1:0)}function gg(i){const t=new dg,e=fg(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new R);const s=new R,r=new re,o=new re;function a(l){let u=0,h=0,d=0;for(let S=0;S<9;S++)n.probe[S].set(0,0,0);let f=0,g=0,x=0,m=0,p=0,w=0,M=0,_=0,T=0,b=0,v=0;l.sort(mg);for(let S=0,y=l.length;S<y;S++){const P=l[S],W=P.color,q=P.intensity,V=P.distance,O=P.shadow&&P.shadow.map?P.shadow.map.texture:null;if(P.isAmbientLight)u+=W.r*q,h+=W.g*q,d+=W.b*q;else if(P.isLightProbe){for(let B=0;B<9;B++)n.probe[B].addScaledVector(P.sh.coefficients[B],q);v++}else if(P.isDirectionalLight){const B=t.get(P);if(B.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const Z=P.shadow,H=e.get(P);H.shadowIntensity=Z.intensity,H.shadowBias=Z.bias,H.shadowNormalBias=Z.normalBias,H.shadowRadius=Z.radius,H.shadowMapSize=Z.mapSize,n.directionalShadow[f]=H,n.directionalShadowMap[f]=O,n.directionalShadowMatrix[f]=P.shadow.matrix,w++}n.directional[f]=B,f++}else if(P.isSpotLight){const B=t.get(P);B.position.setFromMatrixPosition(P.matrixWorld),B.color.copy(W).multiplyScalar(q),B.distance=V,B.coneCos=Math.cos(P.angle),B.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),B.decay=P.decay,n.spot[x]=B;const Z=P.shadow;if(P.map&&(n.spotLightMap[T]=P.map,T++,Z.updateMatrices(P),P.castShadow&&b++),n.spotLightMatrix[x]=Z.matrix,P.castShadow){const H=e.get(P);H.shadowIntensity=Z.intensity,H.shadowBias=Z.bias,H.shadowNormalBias=Z.normalBias,H.shadowRadius=Z.radius,H.shadowMapSize=Z.mapSize,n.spotShadow[x]=H,n.spotShadowMap[x]=O,_++}x++}else if(P.isRectAreaLight){const B=t.get(P);B.color.copy(W).multiplyScalar(q),B.halfWidth.set(P.width*.5,0,0),B.halfHeight.set(0,P.height*.5,0),n.rectArea[m]=B,m++}else if(P.isPointLight){const B=t.get(P);if(B.color.copy(P.color).multiplyScalar(P.intensity),B.distance=P.distance,B.decay=P.decay,P.castShadow){const Z=P.shadow,H=e.get(P);H.shadowIntensity=Z.intensity,H.shadowBias=Z.bias,H.shadowNormalBias=Z.normalBias,H.shadowRadius=Z.radius,H.shadowMapSize=Z.mapSize,H.shadowCameraNear=Z.camera.near,H.shadowCameraFar=Z.camera.far,n.pointShadow[g]=H,n.pointShadowMap[g]=O,n.pointShadowMatrix[g]=P.shadow.matrix,M++}n.point[g]=B,g++}else if(P.isHemisphereLight){const B=t.get(P);B.skyColor.copy(P.color).multiplyScalar(q),B.groundColor.copy(P.groundColor).multiplyScalar(q),n.hemi[p]=B,p++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=At.LTC_FLOAT_1,n.rectAreaLTC2=At.LTC_FLOAT_2):(n.rectAreaLTC1=At.LTC_HALF_1,n.rectAreaLTC2=At.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=h,n.ambient[2]=d;const C=n.hash;(C.directionalLength!==f||C.pointLength!==g||C.spotLength!==x||C.rectAreaLength!==m||C.hemiLength!==p||C.numDirectionalShadows!==w||C.numPointShadows!==M||C.numSpotShadows!==_||C.numSpotMaps!==T||C.numLightProbes!==v)&&(n.directional.length=f,n.spot.length=x,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=w,n.directionalShadowMap.length=w,n.pointShadow.length=M,n.pointShadowMap.length=M,n.spotShadow.length=_,n.spotShadowMap.length=_,n.directionalShadowMatrix.length=w,n.pointShadowMatrix.length=M,n.spotLightMatrix.length=_+T-b,n.spotLightMap.length=T,n.numSpotLightShadowsWithMaps=b,n.numLightProbes=v,C.directionalLength=f,C.pointLength=g,C.spotLength=x,C.rectAreaLength=m,C.hemiLength=p,C.numDirectionalShadows=w,C.numPointShadows=M,C.numSpotShadows=_,C.numSpotMaps=T,C.numLightProbes=v,n.version=pg++)}function c(l,u){let h=0,d=0,f=0,g=0,x=0;const m=u.matrixWorldInverse;for(let p=0,w=l.length;p<w;p++){const M=l[p];if(M.isDirectionalLight){const _=n.directional[h];_.direction.setFromMatrixPosition(M.matrixWorld),s.setFromMatrixPosition(M.target.matrixWorld),_.direction.sub(s),_.direction.transformDirection(m),h++}else if(M.isSpotLight){const _=n.spot[f];_.position.setFromMatrixPosition(M.matrixWorld),_.position.applyMatrix4(m),_.direction.setFromMatrixPosition(M.matrixWorld),s.setFromMatrixPosition(M.target.matrixWorld),_.direction.sub(s),_.direction.transformDirection(m),f++}else if(M.isRectAreaLight){const _=n.rectArea[g];_.position.setFromMatrixPosition(M.matrixWorld),_.position.applyMatrix4(m),o.identity(),r.copy(M.matrixWorld),r.premultiply(m),o.extractRotation(r),_.halfWidth.set(M.width*.5,0,0),_.halfHeight.set(0,M.height*.5,0),_.halfWidth.applyMatrix4(o),_.halfHeight.applyMatrix4(o),g++}else if(M.isPointLight){const _=n.point[d];_.position.setFromMatrixPosition(M.matrixWorld),_.position.applyMatrix4(m),d++}else if(M.isHemisphereLight){const _=n.hemi[x];_.direction.setFromMatrixPosition(M.matrixWorld),_.direction.transformDirection(m),x++}}}return{setup:a,setupView:c,state:n}}function Rl(i){const t=new gg(i),e=[],n=[];function s(u){l.camera=u,e.length=0,n.length=0}function r(u){e.push(u)}function o(u){n.push(u)}function a(){t.setup(e)}function c(u){t.setupView(e,u)}const l={lightsArray:e,shadowsArray:n,camera:null,lights:t,transmissionRenderTarget:{}};return{init:s,state:l,setupLights:a,setupLightsView:c,pushLight:r,pushShadow:o}}function _g(i){let t=new WeakMap;function e(s,r=0){const o=t.get(s);let a;return o===void 0?(a=new Rl(i),t.set(s,[a])):r>=o.length?(a=new Rl(i),o.push(a)):a=o[r],a}function n(){t=new WeakMap}return{get:e,dispose:n}}class sh extends fi{static get type(){return"MeshDepthMaterial"}constructor(t){super(),this.isMeshDepthMaterial=!0,this.depthPacking=td,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(t)}copy(t){return super.copy(t),this.depthPacking=t.depthPacking,this.map=t.map,this.alphaMap=t.alphaMap,this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this}}class xg extends fi{static get type(){return"MeshDistanceMaterial"}constructor(t){super(),this.isMeshDistanceMaterial=!0,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(t)}copy(t){return super.copy(t),this.map=t.map,this.alphaMap=t.alphaMap,this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this}}const vg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function Mg(i,t,e){let n=new vc;const s=new dt,r=new dt,o=new ge,a=new sh({depthPacking:Vu}),c=new xg,l={},u=e.maxTextureSize,h={[hi]:$e,[$e]:hi,[Re]:Re},d=new Oe({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new dt},radius:{value:4}},vertexShader:vg,fragmentShader:yg}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new Se;g.setAttribute("position",new Ne(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new N(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Su;let p=this.type;this.render=function(b,v,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;const S=i.getRenderTarget(),y=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),W=i.state;W.setBlending(In),W.buffers.color.setClear(1,1,1,1),W.buffers.depth.setTest(!0),W.setScissorTest(!1);const q=p!==Wn&&this.type===Wn,V=p===Wn&&this.type!==Wn;for(let O=0,B=b.length;O<B;O++){const Z=b[O],H=Z.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",Z,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;s.copy(H.mapSize);const Y=H.getFrameExtents();if(s.multiply(Y),r.copy(H.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/Y.x),s.x=r.x*Y.x,H.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/Y.y),s.y=r.y*Y.y,H.mapSize.y=r.y)),H.map===null||q===!0||V===!0){const X=this.type!==Wn?{minFilter:Xe,magFilter:Xe}:{};H.map!==null&&H.map.dispose(),H.map=new gn(s.x,s.y,X),H.map.texture.name=Z.name+".shadowMap",H.camera.updateProjectionMatrix()}i.setRenderTarget(H.map),i.clear();const vt=H.getViewportCount();for(let X=0;X<vt;X++){const et=H.getViewport(X);o.set(r.x*et.x,r.y*et.y,r.x*et.z,r.y*et.w),W.viewport(o),H.updateMatrices(Z,X),n=H.getFrustum(),_(v,C,H.camera,Z,this.type)}H.isPointLightShadow!==!0&&this.type===Wn&&w(H,C),H.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(S,y,P)};function w(b,v){const C=t.update(x);d.defines.VSM_SAMPLES!==b.blurSamples&&(d.defines.VSM_SAMPLES=b.blurSamples,f.defines.VSM_SAMPLES=b.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new gn(s.x,s.y)),d.uniforms.shadow_pass.value=b.map.texture,d.uniforms.resolution.value=b.mapSize,d.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(v,null,C,d,x,null),f.uniforms.shadow_pass.value=b.mapPass.texture,f.uniforms.resolution.value=b.mapSize,f.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(v,null,C,f,x,null)}function M(b,v,C,S){let y=null;const P=C.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(P!==void 0)y=P;else if(y=C.isPointLight===!0?c:a,i.localClippingEnabled&&v.clipShadows===!0&&Array.isArray(v.clippingPlanes)&&v.clippingPlanes.length!==0||v.displacementMap&&v.displacementScale!==0||v.alphaMap&&v.alphaTest>0||v.map&&v.alphaTest>0){const W=y.uuid,q=v.uuid;let V=l[W];V===void 0&&(V={},l[W]=V);let O=V[q];O===void 0&&(O=y.clone(),V[q]=O,v.addEventListener("dispose",T)),y=O}if(y.visible=v.visible,y.wireframe=v.wireframe,S===Wn?y.side=v.shadowSide!==null?v.shadowSide:v.side:y.side=v.shadowSide!==null?v.shadowSide:h[v.side],y.alphaMap=v.alphaMap,y.alphaTest=v.alphaTest,y.map=v.map,y.clipShadows=v.clipShadows,y.clippingPlanes=v.clippingPlanes,y.clipIntersection=v.clipIntersection,y.displacementMap=v.displacementMap,y.displacementScale=v.displacementScale,y.displacementBias=v.displacementBias,y.wireframeLinewidth=v.wireframeLinewidth,y.linewidth=v.linewidth,C.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const W=i.properties.get(y);W.light=C}return y}function _(b,v,C,S,y){if(b.visible===!1)return;if(b.layers.test(v.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&y===Wn)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,b.matrixWorld);const q=t.update(b),V=b.material;if(Array.isArray(V)){const O=q.groups;for(let B=0,Z=O.length;B<Z;B++){const H=O[B],Y=V[H.materialIndex];if(Y&&Y.visible){const vt=M(b,Y,S,y);b.onBeforeShadow(i,b,v,C,q,vt,H),i.renderBufferDirect(C,null,q,vt,b,H),b.onAfterShadow(i,b,v,C,q,vt,H)}}}else if(V.visible){const O=M(b,V,S,y);b.onBeforeShadow(i,b,v,C,q,O,null),i.renderBufferDirect(C,null,q,O,b,null),b.onAfterShadow(i,b,v,C,q,O,null)}}const W=b.children;for(let q=0,V=W.length;q<V;q++)_(W[q],v,C,S,y)}function T(b){b.target.removeEventListener("dispose",T);for(const C in l){const S=l[C],y=b.target.uuid;y in S&&(S[y].dispose(),delete S[y])}}}const Sg={[ga]:_a,[xa]:Ma,[va]:Sa,[ls]:ya,[_a]:ga,[Ma]:xa,[Sa]:va,[ya]:ls};function wg(i,t){function e(){let K=!1;const Ct=new ge;let lt=null;const _t=new ge(0,0,0,0);return{setMask:function(Rt){lt!==Rt&&!K&&(i.colorMask(Rt,Rt,Rt,Rt),lt=Rt)},setLocked:function(Rt){K=Rt},setClear:function(Rt,Pt,Yt,we,Ie){Ie===!0&&(Rt*=we,Pt*=we,Yt*=we),Ct.set(Rt,Pt,Yt,we),_t.equals(Ct)===!1&&(i.clearColor(Rt,Pt,Yt,we),_t.copy(Ct))},reset:function(){K=!1,lt=null,_t.set(-1,0,0,0)}}}function n(){let K=!1,Ct=!1,lt=null,_t=null,Rt=null;return{setReversed:function(Pt){if(Ct!==Pt){const Yt=t.get("EXT_clip_control");Ct?Yt.clipControlEXT(Yt.LOWER_LEFT_EXT,Yt.ZERO_TO_ONE_EXT):Yt.clipControlEXT(Yt.LOWER_LEFT_EXT,Yt.NEGATIVE_ONE_TO_ONE_EXT);const we=Rt;Rt=null,this.setClear(we)}Ct=Pt},getReversed:function(){return Ct},setTest:function(Pt){Pt?it(i.DEPTH_TEST):st(i.DEPTH_TEST)},setMask:function(Pt){lt!==Pt&&!K&&(i.depthMask(Pt),lt=Pt)},setFunc:function(Pt){if(Ct&&(Pt=Sg[Pt]),_t!==Pt){switch(Pt){case ga:i.depthFunc(i.NEVER);break;case _a:i.depthFunc(i.ALWAYS);break;case xa:i.depthFunc(i.LESS);break;case ls:i.depthFunc(i.LEQUAL);break;case va:i.depthFunc(i.EQUAL);break;case ya:i.depthFunc(i.GEQUAL);break;case Ma:i.depthFunc(i.GREATER);break;case Sa:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}_t=Pt}},setLocked:function(Pt){K=Pt},setClear:function(Pt){Rt!==Pt&&(Ct&&(Pt=1-Pt),i.clearDepth(Pt),Rt=Pt)},reset:function(){K=!1,lt=null,_t=null,Rt=null,Ct=!1}}}function s(){let K=!1,Ct=null,lt=null,_t=null,Rt=null,Pt=null,Yt=null,we=null,Ie=null;return{setTest:function(ae){K||(ae?it(i.STENCIL_TEST):st(i.STENCIL_TEST))},setMask:function(ae){Ct!==ae&&!K&&(i.stencilMask(ae),Ct=ae)},setFunc:function(ae,nn,vn){(lt!==ae||_t!==nn||Rt!==vn)&&(i.stencilFunc(ae,nn,vn),lt=ae,_t=nn,Rt=vn)},setOp:function(ae,nn,vn){(Pt!==ae||Yt!==nn||we!==vn)&&(i.stencilOp(ae,nn,vn),Pt=ae,Yt=nn,we=vn)},setLocked:function(ae){K=ae},setClear:function(ae){Ie!==ae&&(i.clearStencil(ae),Ie=ae)},reset:function(){K=!1,Ct=null,lt=null,_t=null,Rt=null,Pt=null,Yt=null,we=null,Ie=null}}}const r=new e,o=new n,a=new s,c=new WeakMap,l=new WeakMap;let u={},h={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,w=null,M=null,_=null,T=null,b=null,v=new Wt(0,0,0),C=0,S=!1,y=null,P=null,W=null,q=null,V=null;const O=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let B=!1,Z=0;const H=i.getParameter(i.VERSION);H.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(H)[1]),B=Z>=1):H.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),B=Z>=2);let Y=null,vt={};const X=i.getParameter(i.SCISSOR_BOX),et=i.getParameter(i.VIEWPORT),ft=new ge().fromArray(X),Q=new ge().fromArray(et);function nt(K,Ct,lt,_t){const Rt=new Uint8Array(4),Pt=i.createTexture();i.bindTexture(K,Pt),i.texParameteri(K,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(K,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Yt=0;Yt<lt;Yt++)K===i.TEXTURE_3D||K===i.TEXTURE_2D_ARRAY?i.texImage3D(Ct,0,i.RGBA,1,1,_t,0,i.RGBA,i.UNSIGNED_BYTE,Rt):i.texImage2D(Ct+Yt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Rt);return Pt}const gt={};gt[i.TEXTURE_2D]=nt(i.TEXTURE_2D,i.TEXTURE_2D,1),gt[i.TEXTURE_CUBE_MAP]=nt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),gt[i.TEXTURE_2D_ARRAY]=nt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),gt[i.TEXTURE_3D]=nt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),it(i.DEPTH_TEST),o.setFunc(ls),rt(!1),xt(Nc),it(i.CULL_FACE),D(In);function it(K){u[K]!==!0&&(i.enable(K),u[K]=!0)}function st(K){u[K]!==!1&&(i.disable(K),u[K]=!1)}function L(K,Ct){return h[K]!==Ct?(i.bindFramebuffer(K,Ct),h[K]=Ct,K===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=Ct),K===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=Ct),!0):!1}function U(K,Ct){let lt=f,_t=!1;if(K){lt=d.get(Ct),lt===void 0&&(lt=[],d.set(Ct,lt));const Rt=K.textures;if(lt.length!==Rt.length||lt[0]!==i.COLOR_ATTACHMENT0){for(let Pt=0,Yt=Rt.length;Pt<Yt;Pt++)lt[Pt]=i.COLOR_ATTACHMENT0+Pt;lt.length=Rt.length,_t=!0}}else lt[0]!==i.BACK&&(lt[0]=i.BACK,_t=!0);_t&&i.drawBuffers(lt)}function G(K){return g!==K?(i.useProgram(K),g=K,!0):!1}const k={[Mi]:i.FUNC_ADD,[Ih]:i.FUNC_SUBTRACT,[Lh]:i.FUNC_REVERSE_SUBTRACT};k[Uh]=i.MIN,k[Nh]=i.MAX;const j={[Fh]:i.ZERO,[Oh]:i.ONE,[Bh]:i.SRC_COLOR,[pa]:i.SRC_ALPHA,[Wh]:i.SRC_ALPHA_SATURATE,[Hh]:i.DST_COLOR,[zh]:i.DST_ALPHA,[kh]:i.ONE_MINUS_SRC_COLOR,[ma]:i.ONE_MINUS_SRC_ALPHA,[Gh]:i.ONE_MINUS_DST_COLOR,[Vh]:i.ONE_MINUS_DST_ALPHA,[Xh]:i.CONSTANT_COLOR,[qh]:i.ONE_MINUS_CONSTANT_COLOR,[Yh]:i.CONSTANT_ALPHA,[Zh]:i.ONE_MINUS_CONSTANT_ALPHA};function D(K,Ct,lt,_t,Rt,Pt,Yt,we,Ie,ae){if(K===In){x===!0&&(st(i.BLEND),x=!1);return}if(x===!1&&(it(i.BLEND),x=!0),K!==Dh){if(K!==m||ae!==S){if((p!==Mi||_!==Mi)&&(i.blendEquation(i.FUNC_ADD),p=Mi,_=Mi),ae)switch(K){case rs:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ve:i.blendFunc(i.ONE,i.ONE);break;case Fc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Oc:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",K);break}else switch(K){case rs:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ve:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Fc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Oc:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",K);break}w=null,M=null,T=null,b=null,v.set(0,0,0),C=0,m=K,S=ae}return}Rt=Rt||Ct,Pt=Pt||lt,Yt=Yt||_t,(Ct!==p||Rt!==_)&&(i.blendEquationSeparate(k[Ct],k[Rt]),p=Ct,_=Rt),(lt!==w||_t!==M||Pt!==T||Yt!==b)&&(i.blendFuncSeparate(j[lt],j[_t],j[Pt],j[Yt]),w=lt,M=_t,T=Pt,b=Yt),(we.equals(v)===!1||Ie!==C)&&(i.blendColor(we.r,we.g,we.b,Ie),v.copy(we),C=Ie),m=K,S=!1}function mt(K,Ct){K.side===Re?st(i.CULL_FACE):it(i.CULL_FACE);let lt=K.side===$e;Ct&&(lt=!lt),rt(lt),K.blending===rs&&K.transparent===!1?D(In):D(K.blending,K.blendEquation,K.blendSrc,K.blendDst,K.blendEquationAlpha,K.blendSrcAlpha,K.blendDstAlpha,K.blendColor,K.blendAlpha,K.premultipliedAlpha),o.setFunc(K.depthFunc),o.setTest(K.depthTest),o.setMask(K.depthWrite),r.setMask(K.colorWrite);const _t=K.stencilWrite;a.setTest(_t),_t&&(a.setMask(K.stencilWriteMask),a.setFunc(K.stencilFunc,K.stencilRef,K.stencilFuncMask),a.setOp(K.stencilFail,K.stencilZFail,K.stencilZPass)),Et(K.polygonOffset,K.polygonOffsetFactor,K.polygonOffsetUnits),K.alphaToCoverage===!0?it(i.SAMPLE_ALPHA_TO_COVERAGE):st(i.SAMPLE_ALPHA_TO_COVERAGE)}function rt(K){y!==K&&(K?i.frontFace(i.CW):i.frontFace(i.CCW),y=K)}function xt(K){K!==Rh?(it(i.CULL_FACE),K!==P&&(K===Nc?i.cullFace(i.BACK):K===Ph?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):st(i.CULL_FACE),P=K}function ct(K){K!==W&&(B&&i.lineWidth(K),W=K)}function Et(K,Ct,lt){K?(it(i.POLYGON_OFFSET_FILL),(q!==Ct||V!==lt)&&(i.polygonOffset(Ct,lt),q=Ct,V=lt)):st(i.POLYGON_OFFSET_FILL)}function z(K){K?it(i.SCISSOR_TEST):st(i.SCISSOR_TEST)}function A(K){K===void 0&&(K=i.TEXTURE0+O-1),Y!==K&&(i.activeTexture(K),Y=K)}function E(K,Ct,lt){lt===void 0&&(Y===null?lt=i.TEXTURE0+O-1:lt=Y);let _t=vt[lt];_t===void 0&&(_t={type:void 0,texture:void 0},vt[lt]=_t),(_t.type!==K||_t.texture!==Ct)&&(Y!==lt&&(i.activeTexture(lt),Y=lt),i.bindTexture(K,Ct||gt[K]),_t.type=K,_t.texture=Ct)}function $(){const K=vt[Y];K!==void 0&&K.type!==void 0&&(i.bindTexture(K.type,null),K.type=void 0,K.texture=void 0)}function ut(){try{i.compressedTexImage2D.apply(i,arguments)}catch(K){console.error("THREE.WebGLState:",K)}}function pt(){try{i.compressedTexImage3D.apply(i,arguments)}catch(K){console.error("THREE.WebGLState:",K)}}function ht(){try{i.texSubImage2D.apply(i,arguments)}catch(K){console.error("THREE.WebGLState:",K)}}function Ft(){try{i.texSubImage3D.apply(i,arguments)}catch(K){console.error("THREE.WebGLState:",K)}}function Tt(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(K){console.error("THREE.WebGLState:",K)}}function Dt(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(K){console.error("THREE.WebGLState:",K)}}function te(){try{i.texStorage2D.apply(i,arguments)}catch(K){console.error("THREE.WebGLState:",K)}}function yt(){try{i.texStorage3D.apply(i,arguments)}catch(K){console.error("THREE.WebGLState:",K)}}function Lt(){try{i.texImage2D.apply(i,arguments)}catch(K){console.error("THREE.WebGLState:",K)}}function Xt(){try{i.texImage3D.apply(i,arguments)}catch(K){console.error("THREE.WebGLState:",K)}}function qt(K){ft.equals(K)===!1&&(i.scissor(K.x,K.y,K.z,K.w),ft.copy(K))}function Ut(K){Q.equals(K)===!1&&(i.viewport(K.x,K.y,K.z,K.w),Q.copy(K))}function se(K,Ct){let lt=l.get(Ct);lt===void 0&&(lt=new WeakMap,l.set(Ct,lt));let _t=lt.get(K);_t===void 0&&(_t=i.getUniformBlockIndex(Ct,K.name),lt.set(K,_t))}function Zt(K,Ct){const _t=l.get(Ct).get(K);c.get(Ct)!==_t&&(i.uniformBlockBinding(Ct,_t,K.__bindingPointIndex),c.set(Ct,_t))}function de(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},Y=null,vt={},h={},d=new WeakMap,f=[],g=null,x=!1,m=null,p=null,w=null,M=null,_=null,T=null,b=null,v=new Wt(0,0,0),C=0,S=!1,y=null,P=null,W=null,q=null,V=null,ft.set(0,0,i.canvas.width,i.canvas.height),Q.set(0,0,i.canvas.width,i.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:it,disable:st,bindFramebuffer:L,drawBuffers:U,useProgram:G,setBlending:D,setMaterial:mt,setFlipSided:rt,setCullFace:xt,setLineWidth:ct,setPolygonOffset:Et,setScissorTest:z,activeTexture:A,bindTexture:E,unbindTexture:$,compressedTexImage2D:ut,compressedTexImage3D:pt,texImage2D:Lt,texImage3D:Xt,updateUBOMapping:se,uniformBlockBinding:Zt,texStorage2D:te,texStorage3D:yt,texSubImage2D:ht,texSubImage3D:Ft,compressedTexSubImage2D:Tt,compressedTexSubImage3D:Dt,scissor:qt,viewport:Ut,reset:de}}function Pl(i,t,e,n){const s=bg(n);switch(e){case Nu:return i*t;case Ou:return i*t;case Bu:return i*t*2;case dc:return i*t/s.components*s.byteLength;case fc:return i*t/s.components*s.byteLength;case ku:return i*t*2/s.components*s.byteLength;case pc:return i*t*2/s.components*s.byteLength;case Fu:return i*t*3/s.components*s.byteLength;case mn:return i*t*4/s.components*s.byteLength;case mc:return i*t*4/s.components*s.byteLength;case Gr:case Wr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case Xr:case qr:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Ta:case Ca:return Math.max(i,16)*Math.max(t,8)/4;case Ea:case Aa:return Math.max(i,8)*Math.max(t,8)/2;case Ra:case Pa:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*8;case Da:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case Ia:return Math.floor((i+3)/4)*Math.floor((t+3)/4)*16;case La:return Math.floor((i+4)/5)*Math.floor((t+3)/4)*16;case Ua:return Math.floor((i+4)/5)*Math.floor((t+4)/5)*16;case Na:return Math.floor((i+5)/6)*Math.floor((t+4)/5)*16;case Fa:return Math.floor((i+5)/6)*Math.floor((t+5)/6)*16;case Oa:return Math.floor((i+7)/8)*Math.floor((t+4)/5)*16;case Ba:return Math.floor((i+7)/8)*Math.floor((t+5)/6)*16;case ka:return Math.floor((i+7)/8)*Math.floor((t+7)/8)*16;case za:return Math.floor((i+9)/10)*Math.floor((t+4)/5)*16;case Va:return Math.floor((i+9)/10)*Math.floor((t+5)/6)*16;case Ha:return Math.floor((i+9)/10)*Math.floor((t+7)/8)*16;case Ga:return Math.floor((i+9)/10)*Math.floor((t+9)/10)*16;case Wa:return Math.floor((i+11)/12)*Math.floor((t+9)/10)*16;case Xa:return Math.floor((i+11)/12)*Math.floor((t+11)/12)*16;case Yr:case qa:case Ya:return Math.ceil(i/4)*Math.ceil(t/4)*16;case zu:case Za:return Math.ceil(i/4)*Math.ceil(t/4)*8;case ja:case $a:return Math.ceil(i/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function bg(i){switch(i){case Zn:case Iu:return{byteLength:1,components:1};case Ys:case Lu:case Ln:return{byteLength:2,components:1};case uc:case hc:return{byteLength:2,components:4};case wi:case lc:case Dn:return{byteLength:4,components:1};case Uu:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Eg(i,t,e,n,s,r,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new dt,u=new WeakMap;let h;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,E){return f?new OffscreenCanvas(A,E):Jr("canvas")}function x(A,E,$){let ut=1;const pt=z(A);if((pt.width>$||pt.height>$)&&(ut=$/Math.max(pt.width,pt.height)),ut<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const ht=Math.floor(ut*pt.width),Ft=Math.floor(ut*pt.height);h===void 0&&(h=g(ht,Ft));const Tt=E?g(ht,Ft):h;return Tt.width=ht,Tt.height=Ft,Tt.getContext("2d").drawImage(A,0,0,ht,Ft),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+pt.width+"x"+pt.height+") to ("+ht+"x"+Ft+")."),Tt}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+pt.width+"x"+pt.height+")."),A;return A}function m(A){return A.generateMipmaps}function p(A){i.generateMipmap(A)}function w(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function M(A,E,$,ut,pt=!1){if(A!==null){if(i[A]!==void 0)return i[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let ht=E;if(E===i.RED&&($===i.FLOAT&&(ht=i.R32F),$===i.HALF_FLOAT&&(ht=i.R16F),$===i.UNSIGNED_BYTE&&(ht=i.R8)),E===i.RED_INTEGER&&($===i.UNSIGNED_BYTE&&(ht=i.R8UI),$===i.UNSIGNED_SHORT&&(ht=i.R16UI),$===i.UNSIGNED_INT&&(ht=i.R32UI),$===i.BYTE&&(ht=i.R8I),$===i.SHORT&&(ht=i.R16I),$===i.INT&&(ht=i.R32I)),E===i.RG&&($===i.FLOAT&&(ht=i.RG32F),$===i.HALF_FLOAT&&(ht=i.RG16F),$===i.UNSIGNED_BYTE&&(ht=i.RG8)),E===i.RG_INTEGER&&($===i.UNSIGNED_BYTE&&(ht=i.RG8UI),$===i.UNSIGNED_SHORT&&(ht=i.RG16UI),$===i.UNSIGNED_INT&&(ht=i.RG32UI),$===i.BYTE&&(ht=i.RG8I),$===i.SHORT&&(ht=i.RG16I),$===i.INT&&(ht=i.RG32I)),E===i.RGB_INTEGER&&($===i.UNSIGNED_BYTE&&(ht=i.RGB8UI),$===i.UNSIGNED_SHORT&&(ht=i.RGB16UI),$===i.UNSIGNED_INT&&(ht=i.RGB32UI),$===i.BYTE&&(ht=i.RGB8I),$===i.SHORT&&(ht=i.RGB16I),$===i.INT&&(ht=i.RGB32I)),E===i.RGBA_INTEGER&&($===i.UNSIGNED_BYTE&&(ht=i.RGBA8UI),$===i.UNSIGNED_SHORT&&(ht=i.RGBA16UI),$===i.UNSIGNED_INT&&(ht=i.RGBA32UI),$===i.BYTE&&(ht=i.RGBA8I),$===i.SHORT&&(ht=i.RGBA16I),$===i.INT&&(ht=i.RGBA32I)),E===i.RGB&&$===i.UNSIGNED_INT_5_9_9_9_REV&&(ht=i.RGB9_E5),E===i.RGBA){const Ft=pt?uo:oe.getTransfer(ut);$===i.FLOAT&&(ht=i.RGBA32F),$===i.HALF_FLOAT&&(ht=i.RGBA16F),$===i.UNSIGNED_BYTE&&(ht=Ft===fe?i.SRGB8_ALPHA8:i.RGBA8),$===i.UNSIGNED_SHORT_4_4_4_4&&(ht=i.RGBA4),$===i.UNSIGNED_SHORT_5_5_5_1&&(ht=i.RGB5_A1)}return(ht===i.R16F||ht===i.R32F||ht===i.RG16F||ht===i.RG32F||ht===i.RGBA16F||ht===i.RGBA32F)&&t.get("EXT_color_buffer_float"),ht}function _(A,E){let $;return A?E===null||E===wi||E===ds?$=i.DEPTH24_STENCIL8:E===Dn?$=i.DEPTH32F_STENCIL8:E===Ys&&($=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===wi||E===ds?$=i.DEPTH_COMPONENT24:E===Dn?$=i.DEPTH_COMPONENT32F:E===Ys&&($=i.DEPTH_COMPONENT16),$}function T(A,E){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==Xe&&A.minFilter!==En?Math.log2(Math.max(E.width,E.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?E.mipmaps.length:1}function b(A){const E=A.target;E.removeEventListener("dispose",b),C(E),E.isVideoTexture&&u.delete(E)}function v(A){const E=A.target;E.removeEventListener("dispose",v),y(E)}function C(A){const E=n.get(A);if(E.__webglInit===void 0)return;const $=A.source,ut=d.get($);if(ut){const pt=ut[E.__cacheKey];pt.usedTimes--,pt.usedTimes===0&&S(A),Object.keys(ut).length===0&&d.delete($)}n.remove(A)}function S(A){const E=n.get(A);i.deleteTexture(E.__webglTexture);const $=A.source,ut=d.get($);delete ut[E.__cacheKey],o.memory.textures--}function y(A){const E=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let ut=0;ut<6;ut++){if(Array.isArray(E.__webglFramebuffer[ut]))for(let pt=0;pt<E.__webglFramebuffer[ut].length;pt++)i.deleteFramebuffer(E.__webglFramebuffer[ut][pt]);else i.deleteFramebuffer(E.__webglFramebuffer[ut]);E.__webglDepthbuffer&&i.deleteRenderbuffer(E.__webglDepthbuffer[ut])}else{if(Array.isArray(E.__webglFramebuffer))for(let ut=0;ut<E.__webglFramebuffer.length;ut++)i.deleteFramebuffer(E.__webglFramebuffer[ut]);else i.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&i.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&i.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let ut=0;ut<E.__webglColorRenderbuffer.length;ut++)E.__webglColorRenderbuffer[ut]&&i.deleteRenderbuffer(E.__webglColorRenderbuffer[ut]);E.__webglDepthRenderbuffer&&i.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const $=A.textures;for(let ut=0,pt=$.length;ut<pt;ut++){const ht=n.get($[ut]);ht.__webglTexture&&(i.deleteTexture(ht.__webglTexture),o.memory.textures--),n.remove($[ut])}n.remove(A)}let P=0;function W(){P=0}function q(){const A=P;return A>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),P+=1,A}function V(A){const E=[];return E.push(A.wrapS),E.push(A.wrapT),E.push(A.wrapR||0),E.push(A.magFilter),E.push(A.minFilter),E.push(A.anisotropy),E.push(A.internalFormat),E.push(A.format),E.push(A.type),E.push(A.generateMipmaps),E.push(A.premultiplyAlpha),E.push(A.flipY),E.push(A.unpackAlignment),E.push(A.colorSpace),E.join()}function O(A,E){const $=n.get(A);if(A.isVideoTexture&&ct(A),A.isRenderTargetTexture===!1&&A.version>0&&$.__version!==A.version){const ut=A.image;if(ut===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ut.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Q($,A,E);return}}e.bindTexture(i.TEXTURE_2D,$.__webglTexture,i.TEXTURE0+E)}function B(A,E){const $=n.get(A);if(A.version>0&&$.__version!==A.version){Q($,A,E);return}e.bindTexture(i.TEXTURE_2D_ARRAY,$.__webglTexture,i.TEXTURE0+E)}function Z(A,E){const $=n.get(A);if(A.version>0&&$.__version!==A.version){Q($,A,E);return}e.bindTexture(i.TEXTURE_3D,$.__webglTexture,i.TEXTURE0+E)}function H(A,E){const $=n.get(A);if(A.version>0&&$.__version!==A.version){nt($,A,E);return}e.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture,i.TEXTURE0+E)}const Y={[qs]:i.REPEAT,[oi]:i.CLAMP_TO_EDGE,[jr]:i.MIRRORED_REPEAT},vt={[Xe]:i.NEAREST,[Du]:i.NEAREST_MIPMAP_NEAREST,[Os]:i.NEAREST_MIPMAP_LINEAR,[En]:i.LINEAR,[Hr]:i.LINEAR_MIPMAP_NEAREST,[ai]:i.LINEAR_MIPMAP_LINEAR},X={[nd]:i.NEVER,[cd]:i.ALWAYS,[id]:i.LESS,[Gu]:i.LEQUAL,[sd]:i.EQUAL,[ad]:i.GEQUAL,[rd]:i.GREATER,[od]:i.NOTEQUAL};function et(A,E){if(E.type===Dn&&t.has("OES_texture_float_linear")===!1&&(E.magFilter===En||E.magFilter===Hr||E.magFilter===Os||E.magFilter===ai||E.minFilter===En||E.minFilter===Hr||E.minFilter===Os||E.minFilter===ai)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,Y[E.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,Y[E.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,Y[E.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,vt[E.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,vt[E.minFilter]),E.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,X[E.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Xe||E.minFilter!==Os&&E.minFilter!==ai||E.type===Dn&&t.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||n.get(E).__currentAnisotropy){const $=t.get("EXT_texture_filter_anisotropic");i.texParameterf(A,$.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,s.getMaxAnisotropy())),n.get(E).__currentAnisotropy=E.anisotropy}}}function ft(A,E){let $=!1;A.__webglInit===void 0&&(A.__webglInit=!0,E.addEventListener("dispose",b));const ut=E.source;let pt=d.get(ut);pt===void 0&&(pt={},d.set(ut,pt));const ht=V(E);if(ht!==A.__cacheKey){pt[ht]===void 0&&(pt[ht]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,$=!0),pt[ht].usedTimes++;const Ft=pt[A.__cacheKey];Ft!==void 0&&(pt[A.__cacheKey].usedTimes--,Ft.usedTimes===0&&S(E)),A.__cacheKey=ht,A.__webglTexture=pt[ht].texture}return $}function Q(A,E,$){let ut=i.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(ut=i.TEXTURE_2D_ARRAY),E.isData3DTexture&&(ut=i.TEXTURE_3D);const pt=ft(A,E),ht=E.source;e.bindTexture(ut,A.__webglTexture,i.TEXTURE0+$);const Ft=n.get(ht);if(ht.version!==Ft.__version||pt===!0){e.activeTexture(i.TEXTURE0+$);const Tt=oe.getPrimaries(oe.workingColorSpace),Dt=E.colorSpace===Xn?null:oe.getPrimaries(E.colorSpace),te=E.colorSpace===Xn||Tt===Dt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,E.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,E.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,te);let yt=x(E.image,!1,s.maxTextureSize);yt=Et(E,yt);const Lt=r.convert(E.format,E.colorSpace),Xt=r.convert(E.type);let qt=M(E.internalFormat,Lt,Xt,E.colorSpace,E.isVideoTexture);et(ut,E);let Ut;const se=E.mipmaps,Zt=E.isVideoTexture!==!0,de=Ft.__version===void 0||pt===!0,K=ht.dataReady,Ct=T(E,yt);if(E.isDepthTexture)qt=_(E.format===fs,E.type),de&&(Zt?e.texStorage2D(i.TEXTURE_2D,1,qt,yt.width,yt.height):e.texImage2D(i.TEXTURE_2D,0,qt,yt.width,yt.height,0,Lt,Xt,null));else if(E.isDataTexture)if(se.length>0){Zt&&de&&e.texStorage2D(i.TEXTURE_2D,Ct,qt,se[0].width,se[0].height);for(let lt=0,_t=se.length;lt<_t;lt++)Ut=se[lt],Zt?K&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,Ut.width,Ut.height,Lt,Xt,Ut.data):e.texImage2D(i.TEXTURE_2D,lt,qt,Ut.width,Ut.height,0,Lt,Xt,Ut.data);E.generateMipmaps=!1}else Zt?(de&&e.texStorage2D(i.TEXTURE_2D,Ct,qt,yt.width,yt.height),K&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,yt.width,yt.height,Lt,Xt,yt.data)):e.texImage2D(i.TEXTURE_2D,0,qt,yt.width,yt.height,0,Lt,Xt,yt.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){Zt&&de&&e.texStorage3D(i.TEXTURE_2D_ARRAY,Ct,qt,se[0].width,se[0].height,yt.depth);for(let lt=0,_t=se.length;lt<_t;lt++)if(Ut=se[lt],E.format!==mn)if(Lt!==null)if(Zt){if(K)if(E.layerUpdates.size>0){const Rt=Pl(Ut.width,Ut.height,E.format,E.type);for(const Pt of E.layerUpdates){const Yt=Ut.data.subarray(Pt*Rt/Ut.data.BYTES_PER_ELEMENT,(Pt+1)*Rt/Ut.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,Pt,Ut.width,Ut.height,1,Lt,Yt)}E.clearLayerUpdates()}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,0,Ut.width,Ut.height,yt.depth,Lt,Ut.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,lt,qt,Ut.width,Ut.height,yt.depth,0,Ut.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Zt?K&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,lt,0,0,0,Ut.width,Ut.height,yt.depth,Lt,Xt,Ut.data):e.texImage3D(i.TEXTURE_2D_ARRAY,lt,qt,Ut.width,Ut.height,yt.depth,0,Lt,Xt,Ut.data)}else{Zt&&de&&e.texStorage2D(i.TEXTURE_2D,Ct,qt,se[0].width,se[0].height);for(let lt=0,_t=se.length;lt<_t;lt++)Ut=se[lt],E.format!==mn?Lt!==null?Zt?K&&e.compressedTexSubImage2D(i.TEXTURE_2D,lt,0,0,Ut.width,Ut.height,Lt,Ut.data):e.compressedTexImage2D(i.TEXTURE_2D,lt,qt,Ut.width,Ut.height,0,Ut.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Zt?K&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,Ut.width,Ut.height,Lt,Xt,Ut.data):e.texImage2D(i.TEXTURE_2D,lt,qt,Ut.width,Ut.height,0,Lt,Xt,Ut.data)}else if(E.isDataArrayTexture)if(Zt){if(de&&e.texStorage3D(i.TEXTURE_2D_ARRAY,Ct,qt,yt.width,yt.height,yt.depth),K)if(E.layerUpdates.size>0){const lt=Pl(yt.width,yt.height,E.format,E.type);for(const _t of E.layerUpdates){const Rt=yt.data.subarray(_t*lt/yt.data.BYTES_PER_ELEMENT,(_t+1)*lt/yt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,_t,yt.width,yt.height,1,Lt,Xt,Rt)}E.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,yt.width,yt.height,yt.depth,Lt,Xt,yt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,qt,yt.width,yt.height,yt.depth,0,Lt,Xt,yt.data);else if(E.isData3DTexture)Zt?(de&&e.texStorage3D(i.TEXTURE_3D,Ct,qt,yt.width,yt.height,yt.depth),K&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,yt.width,yt.height,yt.depth,Lt,Xt,yt.data)):e.texImage3D(i.TEXTURE_3D,0,qt,yt.width,yt.height,yt.depth,0,Lt,Xt,yt.data);else if(E.isFramebufferTexture){if(de)if(Zt)e.texStorage2D(i.TEXTURE_2D,Ct,qt,yt.width,yt.height);else{let lt=yt.width,_t=yt.height;for(let Rt=0;Rt<Ct;Rt++)e.texImage2D(i.TEXTURE_2D,Rt,qt,lt,_t,0,Lt,Xt,null),lt>>=1,_t>>=1}}else if(se.length>0){if(Zt&&de){const lt=z(se[0]);e.texStorage2D(i.TEXTURE_2D,Ct,qt,lt.width,lt.height)}for(let lt=0,_t=se.length;lt<_t;lt++)Ut=se[lt],Zt?K&&e.texSubImage2D(i.TEXTURE_2D,lt,0,0,Lt,Xt,Ut):e.texImage2D(i.TEXTURE_2D,lt,qt,Lt,Xt,Ut);E.generateMipmaps=!1}else if(Zt){if(de){const lt=z(yt);e.texStorage2D(i.TEXTURE_2D,Ct,qt,lt.width,lt.height)}K&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,Lt,Xt,yt)}else e.texImage2D(i.TEXTURE_2D,0,qt,Lt,Xt,yt);m(E)&&p(ut),Ft.__version=ht.version,E.onUpdate&&E.onUpdate(E)}A.__version=E.version}function nt(A,E,$){if(E.image.length!==6)return;const ut=ft(A,E),pt=E.source;e.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+$);const ht=n.get(pt);if(pt.version!==ht.__version||ut===!0){e.activeTexture(i.TEXTURE0+$);const Ft=oe.getPrimaries(oe.workingColorSpace),Tt=E.colorSpace===Xn?null:oe.getPrimaries(E.colorSpace),Dt=E.colorSpace===Xn||Ft===Tt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,E.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,E.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Dt);const te=E.isCompressedTexture||E.image[0].isCompressedTexture,yt=E.image[0]&&E.image[0].isDataTexture,Lt=[];for(let _t=0;_t<6;_t++)!te&&!yt?Lt[_t]=x(E.image[_t],!0,s.maxCubemapSize):Lt[_t]=yt?E.image[_t].image:E.image[_t],Lt[_t]=Et(E,Lt[_t]);const Xt=Lt[0],qt=r.convert(E.format,E.colorSpace),Ut=r.convert(E.type),se=M(E.internalFormat,qt,Ut,E.colorSpace),Zt=E.isVideoTexture!==!0,de=ht.__version===void 0||ut===!0,K=pt.dataReady;let Ct=T(E,Xt);et(i.TEXTURE_CUBE_MAP,E);let lt;if(te){Zt&&de&&e.texStorage2D(i.TEXTURE_CUBE_MAP,Ct,se,Xt.width,Xt.height);for(let _t=0;_t<6;_t++){lt=Lt[_t].mipmaps;for(let Rt=0;Rt<lt.length;Rt++){const Pt=lt[Rt];E.format!==mn?qt!==null?Zt?K&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Rt,0,0,Pt.width,Pt.height,qt,Pt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Rt,se,Pt.width,Pt.height,0,Pt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Zt?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Rt,0,0,Pt.width,Pt.height,qt,Ut,Pt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Rt,se,Pt.width,Pt.height,0,qt,Ut,Pt.data)}}}else{if(lt=E.mipmaps,Zt&&de){lt.length>0&&Ct++;const _t=z(Lt[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,Ct,se,_t.width,_t.height)}for(let _t=0;_t<6;_t++)if(yt){Zt?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,Lt[_t].width,Lt[_t].height,qt,Ut,Lt[_t].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,se,Lt[_t].width,Lt[_t].height,0,qt,Ut,Lt[_t].data);for(let Rt=0;Rt<lt.length;Rt++){const Yt=lt[Rt].image[_t].image;Zt?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Rt+1,0,0,Yt.width,Yt.height,qt,Ut,Yt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Rt+1,se,Yt.width,Yt.height,0,qt,Ut,Yt.data)}}else{Zt?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,0,0,qt,Ut,Lt[_t]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,0,se,qt,Ut,Lt[_t]);for(let Rt=0;Rt<lt.length;Rt++){const Pt=lt[Rt];Zt?K&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Rt+1,0,0,qt,Ut,Pt.image[_t]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+_t,Rt+1,se,qt,Ut,Pt.image[_t])}}}m(E)&&p(i.TEXTURE_CUBE_MAP),ht.__version=pt.version,E.onUpdate&&E.onUpdate(E)}A.__version=E.version}function gt(A,E,$,ut,pt,ht){const Ft=r.convert($.format,$.colorSpace),Tt=r.convert($.type),Dt=M($.internalFormat,Ft,Tt,$.colorSpace),te=n.get(E),yt=n.get($);if(yt.__renderTarget=E,!te.__hasExternalTextures){const Lt=Math.max(1,E.width>>ht),Xt=Math.max(1,E.height>>ht);pt===i.TEXTURE_3D||pt===i.TEXTURE_2D_ARRAY?e.texImage3D(pt,ht,Dt,Lt,Xt,E.depth,0,Ft,Tt,null):e.texImage2D(pt,ht,Dt,Lt,Xt,0,Ft,Tt,null)}e.bindFramebuffer(i.FRAMEBUFFER,A),xt(E)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ut,pt,yt.__webglTexture,0,rt(E)):(pt===i.TEXTURE_2D||pt>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&pt<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,ut,pt,yt.__webglTexture,ht),e.bindFramebuffer(i.FRAMEBUFFER,null)}function it(A,E,$){if(i.bindRenderbuffer(i.RENDERBUFFER,A),E.depthBuffer){const ut=E.depthTexture,pt=ut&&ut.isDepthTexture?ut.type:null,ht=_(E.stencilBuffer,pt),Ft=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Tt=rt(E);xt(E)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Tt,ht,E.width,E.height):$?i.renderbufferStorageMultisample(i.RENDERBUFFER,Tt,ht,E.width,E.height):i.renderbufferStorage(i.RENDERBUFFER,ht,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Ft,i.RENDERBUFFER,A)}else{const ut=E.textures;for(let pt=0;pt<ut.length;pt++){const ht=ut[pt],Ft=r.convert(ht.format,ht.colorSpace),Tt=r.convert(ht.type),Dt=M(ht.internalFormat,Ft,Tt,ht.colorSpace),te=rt(E);$&&xt(E)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,te,Dt,E.width,E.height):xt(E)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,te,Dt,E.width,E.height):i.renderbufferStorage(i.RENDERBUFFER,Dt,E.width,E.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function st(A,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,A),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ut=n.get(E.depthTexture);ut.__renderTarget=E,(!ut.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),O(E.depthTexture,0);const pt=ut.__webglTexture,ht=rt(E);if(E.depthTexture.format===os)xt(E)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,pt,0,ht):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,pt,0);else if(E.depthTexture.format===fs)xt(E)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,pt,0,ht):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,pt,0);else throw new Error("Unknown depthTexture format")}function L(A){const E=n.get(A),$=A.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==A.depthTexture){const ut=A.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),ut){const pt=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,ut.removeEventListener("dispose",pt)};ut.addEventListener("dispose",pt),E.__depthDisposeCallback=pt}E.__boundDepthTexture=ut}if(A.depthTexture&&!E.__autoAllocateDepthBuffer){if($)throw new Error("target.depthTexture not supported in Cube render targets");st(E.__webglFramebuffer,A)}else if($){E.__webglDepthbuffer=[];for(let ut=0;ut<6;ut++)if(e.bindFramebuffer(i.FRAMEBUFFER,E.__webglFramebuffer[ut]),E.__webglDepthbuffer[ut]===void 0)E.__webglDepthbuffer[ut]=i.createRenderbuffer(),it(E.__webglDepthbuffer[ut],A,!1);else{const pt=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ht=E.__webglDepthbuffer[ut];i.bindRenderbuffer(i.RENDERBUFFER,ht),i.framebufferRenderbuffer(i.FRAMEBUFFER,pt,i.RENDERBUFFER,ht)}}else if(e.bindFramebuffer(i.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=i.createRenderbuffer(),it(E.__webglDepthbuffer,A,!1);else{const ut=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,pt=E.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,pt),i.framebufferRenderbuffer(i.FRAMEBUFFER,ut,i.RENDERBUFFER,pt)}e.bindFramebuffer(i.FRAMEBUFFER,null)}function U(A,E,$){const ut=n.get(A);E!==void 0&&gt(ut.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),$!==void 0&&L(A)}function G(A){const E=A.texture,$=n.get(A),ut=n.get(E);A.addEventListener("dispose",v);const pt=A.textures,ht=A.isWebGLCubeRenderTarget===!0,Ft=pt.length>1;if(Ft||(ut.__webglTexture===void 0&&(ut.__webglTexture=i.createTexture()),ut.__version=E.version,o.memory.textures++),ht){$.__webglFramebuffer=[];for(let Tt=0;Tt<6;Tt++)if(E.mipmaps&&E.mipmaps.length>0){$.__webglFramebuffer[Tt]=[];for(let Dt=0;Dt<E.mipmaps.length;Dt++)$.__webglFramebuffer[Tt][Dt]=i.createFramebuffer()}else $.__webglFramebuffer[Tt]=i.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){$.__webglFramebuffer=[];for(let Tt=0;Tt<E.mipmaps.length;Tt++)$.__webglFramebuffer[Tt]=i.createFramebuffer()}else $.__webglFramebuffer=i.createFramebuffer();if(Ft)for(let Tt=0,Dt=pt.length;Tt<Dt;Tt++){const te=n.get(pt[Tt]);te.__webglTexture===void 0&&(te.__webglTexture=i.createTexture(),o.memory.textures++)}if(A.samples>0&&xt(A)===!1){$.__webglMultisampledFramebuffer=i.createFramebuffer(),$.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,$.__webglMultisampledFramebuffer);for(let Tt=0;Tt<pt.length;Tt++){const Dt=pt[Tt];$.__webglColorRenderbuffer[Tt]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,$.__webglColorRenderbuffer[Tt]);const te=r.convert(Dt.format,Dt.colorSpace),yt=r.convert(Dt.type),Lt=M(Dt.internalFormat,te,yt,Dt.colorSpace,A.isXRRenderTarget===!0),Xt=rt(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,Xt,Lt,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Tt,i.RENDERBUFFER,$.__webglColorRenderbuffer[Tt])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&($.__webglDepthRenderbuffer=i.createRenderbuffer(),it($.__webglDepthRenderbuffer,A,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ht){e.bindTexture(i.TEXTURE_CUBE_MAP,ut.__webglTexture),et(i.TEXTURE_CUBE_MAP,E);for(let Tt=0;Tt<6;Tt++)if(E.mipmaps&&E.mipmaps.length>0)for(let Dt=0;Dt<E.mipmaps.length;Dt++)gt($.__webglFramebuffer[Tt][Dt],A,E,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Tt,Dt);else gt($.__webglFramebuffer[Tt],A,E,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Tt,0);m(E)&&p(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Ft){for(let Tt=0,Dt=pt.length;Tt<Dt;Tt++){const te=pt[Tt],yt=n.get(te);e.bindTexture(i.TEXTURE_2D,yt.__webglTexture),et(i.TEXTURE_2D,te),gt($.__webglFramebuffer,A,te,i.COLOR_ATTACHMENT0+Tt,i.TEXTURE_2D,0),m(te)&&p(i.TEXTURE_2D)}e.unbindTexture()}else{let Tt=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(Tt=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(Tt,ut.__webglTexture),et(Tt,E),E.mipmaps&&E.mipmaps.length>0)for(let Dt=0;Dt<E.mipmaps.length;Dt++)gt($.__webglFramebuffer[Dt],A,E,i.COLOR_ATTACHMENT0,Tt,Dt);else gt($.__webglFramebuffer,A,E,i.COLOR_ATTACHMENT0,Tt,0);m(E)&&p(Tt),e.unbindTexture()}A.depthBuffer&&L(A)}function k(A){const E=A.textures;for(let $=0,ut=E.length;$<ut;$++){const pt=E[$];if(m(pt)){const ht=w(A),Ft=n.get(pt).__webglTexture;e.bindTexture(ht,Ft),p(ht),e.unbindTexture()}}}const j=[],D=[];function mt(A){if(A.samples>0){if(xt(A)===!1){const E=A.textures,$=A.width,ut=A.height;let pt=i.COLOR_BUFFER_BIT;const ht=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ft=n.get(A),Tt=E.length>1;if(Tt)for(let Dt=0;Dt<E.length;Dt++)e.bindFramebuffer(i.FRAMEBUFFER,Ft.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Dt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,Ft.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Dt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,Ft.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ft.__webglFramebuffer);for(let Dt=0;Dt<E.length;Dt++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(pt|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(pt|=i.STENCIL_BUFFER_BIT)),Tt){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Ft.__webglColorRenderbuffer[Dt]);const te=n.get(E[Dt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,te,0)}i.blitFramebuffer(0,0,$,ut,0,0,$,ut,pt,i.NEAREST),c===!0&&(j.length=0,D.length=0,j.push(i.COLOR_ATTACHMENT0+Dt),A.depthBuffer&&A.resolveDepthBuffer===!1&&(j.push(ht),D.push(ht),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,D)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,j))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Tt)for(let Dt=0;Dt<E.length;Dt++){e.bindFramebuffer(i.FRAMEBUFFER,Ft.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Dt,i.RENDERBUFFER,Ft.__webglColorRenderbuffer[Dt]);const te=n.get(E[Dt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,Ft.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Dt,i.TEXTURE_2D,te,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ft.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&c){const E=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[E])}}}function rt(A){return Math.min(s.maxSamples,A.samples)}function xt(A){const E=n.get(A);return A.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function ct(A){const E=o.render.frame;u.get(A)!==E&&(u.set(A,E),A.update())}function Et(A,E){const $=A.colorSpace,ut=A.format,pt=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||$!==vs&&$!==Xn&&(oe.getTransfer($)===fe?(ut!==mn||pt!==Zn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",$)),E}function z(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(l.width=A.naturalWidth||A.width,l.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(l.width=A.displayWidth,l.height=A.displayHeight):(l.width=A.width,l.height=A.height),l}this.allocateTextureUnit=q,this.resetTextureUnits=W,this.setTexture2D=O,this.setTexture2DArray=B,this.setTexture3D=Z,this.setTextureCube=H,this.rebindTextures=U,this.setupRenderTarget=G,this.updateRenderTargetMipmap=k,this.updateMultisampleRenderTarget=mt,this.setupDepthRenderbuffer=L,this.setupFrameBufferTexture=gt,this.useMultisampledRTT=xt}function Tg(i,t){function e(n,s=Xn){let r;const o=oe.getTransfer(s);if(n===Zn)return i.UNSIGNED_BYTE;if(n===uc)return i.UNSIGNED_SHORT_4_4_4_4;if(n===hc)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Uu)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Iu)return i.BYTE;if(n===Lu)return i.SHORT;if(n===Ys)return i.UNSIGNED_SHORT;if(n===lc)return i.INT;if(n===wi)return i.UNSIGNED_INT;if(n===Dn)return i.FLOAT;if(n===Ln)return i.HALF_FLOAT;if(n===Nu)return i.ALPHA;if(n===Fu)return i.RGB;if(n===mn)return i.RGBA;if(n===Ou)return i.LUMINANCE;if(n===Bu)return i.LUMINANCE_ALPHA;if(n===os)return i.DEPTH_COMPONENT;if(n===fs)return i.DEPTH_STENCIL;if(n===dc)return i.RED;if(n===fc)return i.RED_INTEGER;if(n===ku)return i.RG;if(n===pc)return i.RG_INTEGER;if(n===mc)return i.RGBA_INTEGER;if(n===Gr||n===Wr||n===Xr||n===qr)if(o===fe)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Gr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Wr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Xr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===qr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Gr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Wr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Xr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===qr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ea||n===Ta||n===Aa||n===Ca)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Ea)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ta)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Aa)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ca)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ra||n===Pa||n===Da)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Ra||n===Pa)return o===fe?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Da)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Ia||n===La||n===Ua||n===Na||n===Fa||n===Oa||n===Ba||n===ka||n===za||n===Va||n===Ha||n===Ga||n===Wa||n===Xa)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ia)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===La)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ua)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Na)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Fa)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Oa)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ba)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ka)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===za)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Va)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ha)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ga)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Wa)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Xa)return o===fe?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Yr||n===qa||n===Ya)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Yr)return o===fe?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===qa)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ya)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===zu||n===Za||n===ja||n===$a)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===Yr)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Za)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ja)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===$a)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ds?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}class Ag extends an{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class ie extends De{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Cg={type:"move"};class Xo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ie,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ie,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new R,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new R),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ie,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new R,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new R),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let s=null,r=null,o=null;const a=this._targetRay,c=this._grip,l=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(l&&t.hand){o=!0;for(const x of t.hand.values()){const m=e.getJointPose(x,n),p=this._getHandJoint(l,x);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const u=l.joints["index-finger-tip"],h=l.joints["thumb-tip"],d=u.position.distanceTo(h.position),f=.02,g=.005;l.inputState.pinching&&d>f+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!l.inputState.pinching&&d<=f-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(r=e.getPose(t.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=e.getPose(t.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Cg)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new ie;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}const Rg=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}_s.BlurDirectionX=new dt(1,0);_s.BlurDirectionY=new dt(0,1);const ax={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
    ...
    `,blending:ve,transparent:!0,depthWrite:!1})}const uu={gold:13214247,blue:3108789,red:11546672,green:5208634},Gx=14267535,hu=1842210,aa=new Map;function Br(i){if(!aa.has(i)){const t=_e(i);t.emissiveIntensity=.06,t.envMapIntensity=.15,t.roughness=.8,aa.set(i,t)}return aa.get(i)}function Wx({shirt:i="red",pose:t="stand",height:e=1.8}={}){const n=new ie;n.name=`Crew ${i}`;const s=e/1.8,r=Br(uu[i]||uu.red),o=.82*s,a=.58*s,c=.115*s,l=.45*s,u=new N(new Ot(.09*s,.11*s,o,8),Br(hu)),h=u.clone(),d=new N(new Ot(.08*s,.09*s,l,8),Br(hu)),f=d.clone(),g=new N(new bc(.17*s,a-.34*s,4,10),r),x=new N(new ee(c,12,10),Br(Gx)),m=new N(new Ot(.05*s,.045*s,.6*s,8),r),p=m.clone();return n.add(u,h,d,f,g,x,m,p),n.userData.parts={legs:u,legs2:h,shinL:d,shinR:f,torso:g,head:x,armL:m,armR:p,s,legL:o,torsoH:a,headR:c,hip:l},ac(n,t),n}function ac(i,t){const e=i.userData.parts;if(!e||i.userData.pose===t)return;i.userData.pose=t;const{legs:n,legs2:s,shinL:r,shinR:o,torso:a,head:c,armL:l,armR:u,s:h,legL:d,torsoH:f,headR:g,hip:x}=e;for(const m of[n,s,r,o,a,c,l,u])m.rotation.set(0,0,0),m.scale.set(1,1,1);r.visible=o.visible=t==="sit",t==="lie"?(n.rotation.x=Math.PI/2,n.position.set(-.1*h,.11*h,-d/2),s.rotation.x=Math.PI/2,s.position.set(.1*h,.11*h,-d/2),a.rotation.x=Math.PI/2,a.position.set(0,.18*h,f/2),c.position.set(0,.2*h,f+g+.05*h),l.rotation.x=Math.PI/2,l.position.set(-.24*h,.14*h,f/2),u.rotation.x=Math.PI/2,u.position.set(.24*h,.14*h,f/2)):t==="sit"?(n.rotation.x=Math.PI/2,n.scale.y=.55,n.position.set(-.1*h,x,.22*h),s.rotation.x=Math.PI/2,s.scale.y=.55,s.position.set(.1*h,x,.22*h),r.position.set(-.1*h,x/2,.42*h),o.position.set(.1*h,x/2,.42*h),a.position.set(0,x+f/2,0),c.position.set(0,x+f+g+.04*h,0),l.rotation.x=-.9,l.position.set(-.24*h,x+f*.55,.12*h),u.rotation.x=-.9,u.position.set(.24*h,x+f*.55,.12*h)):(n.position.set(-.1*h,d/2,0),s.position.set(.1*h,d/2,0),a.position.set(0,d+f/2,0),c.position.set(0,d+f+g+.04*h,0),l.position.set(-.24*h,d+f*.5,0),l.rotation.z=.08,u.position.set(.24*h,d+f*.5,0),u.rotation.z=-.08),i.userData.headY=c.position.y}function xs(i,t){const e=[];for(const n of t){const s=Wx({shirt:n.shirt,pose:n.pose});s.position.set(n.x,n.y,n.z),s.rotation.y=n.rotY||0,s.userData.crew=!0,s.userData.homePose=n.pose||"stand",s.userData.home={x:n.x,z:n.z,rotY:n.rotY||0},n.station&&(s.userData.station={x:n.station.x,z:n.station.z,rotY:n.station.rotY??n.rotY??0,sit:!!n.station.sit}),i.add(s),e.push(s)}return e}function Xx(i,t,e){i.traverse(n=>{if(!n.userData.crew||!n.userData.station)return;const s=n.userData.home,r=n.userData.station,o=s.x+(r.x-s.x)*t,a=s.z+(r.z-s.z)*t,c=Math.min(1,e*3.5);n.position.x+=(o-n.position.x)*c,n.position.z+=(a-n.position.z)*c;const l=Math.hypot(o-n.position.x,a-n.position.z),u=l>.15,h=t>.95&&l<.08;let f=(u?Math.atan2(o-n.position.x,a-n.position.z):t>.5?r.rotY:s.rotY)-n.rotation.y;f=Math.atan2(Math.sin(f),Math.cos(f)),n.rotation.y+=f*Math.min(1,e*6),u||t<.5?ac(n,t<.5&&!u?n.userData.homePose:"stand"):h&&r.sit&&Math.abs(f)<.25&&ac(n,"sit");const g=n.userData.parts.head,x=u?Math.abs(Math.sin(performance.now()*.012))*.05:0;g.position.y=n.userData.headY+x})}function ca(i,t=256,e=128,n=["#3fd0ff","#ffb347","#ff5a5a","#7dff9a","#e8eef4"]){const s=document.createElement("canvas");s.width=t,s.height=e;const r=s.getContext("2d"),o=_n(i);r.fillStyle="#06090f",r.fillRect(0,0,t,e);const a=3+Math.floor(o()*3),c=2+Math.floor(o()*2);for(let u=0;u<a;u++)for(let h=0;h<c;h++){if(o()<.25)continue;r.fillStyle=n[Math.floor(o()*n.length)],r.globalAlpha=.55+o()*.45;const d=t/a-8,f=e/c-8;r.fillRect(4+u*(t/a),4+h*(e/c),d*(.4+o()*.6),f*(.3+o()*.7))}r.globalAlpha=1;const l=new xn(s);return l.colorSpace=be,l}function qx(){const i=document.createElement("canvas");i.width=512,i.height=256;const t=i.getContext("2d");t.fillStyle="#020408",t.fillRect(0,0,512,256);const e=_n(77);for(let s=0;s<260;s++){const r=e()<.9?1:2;t.fillStyle=`rgba(${200+e()*55},${210+e()*45},255,${.5+e()*.5})`,t.fillRect(e()*512,e()*256,r,r)}const n=new xn(i);return n.colorSpace=be,n}function kr(i,t=1.2){return new An({map:i,emissive:16777215,emissiveMap:i,emissiveIntensity:t,roughness:.4,metalness:0})}function Yx(){const i=new ie;i.name="BridgeInterior";const t=Mt.cDeckTop+.1,e=7.7,n=(V,O=.04)=>{const B=_e(V);return B.emissiveIntensity=O,B.envMapIntensity=.12,B.roughness=.85,B},s=n(4858404,.03),r=n(10131345,.04),o=n(1382427,.02),a=n(9315878,.08),c=n(2237738,.02),l=new N(new Ot(4.4,4.4,.12,64),s);l.position.y=t,i.add(l);const u=new N(new Ot(e,e,.42,96),n(5911090,.03));u.position.y=t+.15,i.add(u);const h=new N(new Pi(4.4,e,96),s);h.rotation.x=-Math.PI/2,h.position.y=t+.37,i.add(h);const d=new N(new Pe(4.55,.06,8,96,Math.PI*1.7),a);d.rotation.x=Math.PI/2,d.rotation.z=Math.PI*.15+Math.PI/2,d.position.y=t+1.05,i.add(d);for(let V=0;V<12;V++){const O=V/12*Math.PI*2;if(Math.cos(O)>.86)continue;const B=new N(new Ot(.05,.05,.7,8),a);B.position.set(Math.sin(O)*4.55,t+.72,Math.cos(O)*4.55),i.add(B)}const f=new N(new wt(.9,.5,.9),c);f.position.set(0,t+.55,-.9),i.add(f);const g=new N(new wt(.9,1,.18),c);g.position.set(0,t+1.25,-1.3),i.add(g);const x=new N(new Ot(.28,.4,.35,16),o);x.position.set(0,t+.2,-.9),i.add(x);for(const V of[-.62,.62]){const O=new N(new wt(.22,.18,.8),o);O.position.set(V,t+.95,-.95),i.add(O);const B=new N(new Gt(.16,.5),Vt(16757575,1.4));B.rotation.x=-Math.PI/2,B.position.set(V,t+1.05,-.95),i.add(B)}const m=new N(new wt(3.4,.85,.75),o);m.position.set(0,t+.45,1.5),i.add(m);const p=new N(new Gt(3.2,.6),kr(ca(5,512,96),1.4));p.rotation.x=-Math.PI/2+.2,p.position.set(0,t+.9,1.45),i.add(p);const w=new N(new Ot(.28,.28,.45,20),Vt(8247551,1.6));w.position.set(0,t+1.1,1.55),i.add(w);for(const V of[-.8,.8]){const O=new N(new wt(.6,.45,.6),c);O.position.set(V,t+.48,.55),i.add(O);const B=new N(new wt(.6,.6,.12),c);B.position.set(V,t+1,.25),i.add(B)}[-2.35,-1.75,-1.15,1.15,1.75,2.35,Math.PI-.55,Math.PI+.55].forEach((V,O)=>{const Z=new N(new wt(1.9,.9,.55),o);Z.position.set(Math.sin(V)*6.75,t+.82,Math.cos(V)*6.75),Z.lookAt(0,t+.82,0),i.add(Z);const H=new N(new Gt(1.7,.42),kr(ca(20+O,256,64),1.3));H.position.set(Math.sin(V)*(6.75-.05),t+1.3,Math.cos(V)*(6.75-.05)),H.lookAt(0,t+1.3+1.2,0),i.add(H);const Y=new N(new wt(.6,.45,.6),c);Y.position.set(Math.sin(V)*(6.75-1.1),t+.6,Math.cos(V)*(6.75-1.1)),i.add(Y);const vt=new N(new Gt(1.9,1),kr(ca(40+O),1.1));vt.position.set(Math.sin(V)*(e-.15),t+2.55,Math.cos(V)*(e-.15)),vt.lookAt(0,t+2.55,0),i.add(vt)});const _=new N(new Ot(e+.05,e+.05,3.6,96,1,!0),r);_.position.y=t+1.8,i.add(_);const T=new N(new Pe(e,.08,8,96),a);T.rotation.x=Math.PI/2,T.position.y=t+1.95,i.add(T);const b=new N(new wt(5.4,3,.2),o);b.position.set(0,t+2.1,e-.3),i.add(b);const v=new N(new Gt(4.9,2.6),kr(qx(),1.6));v.position.set(0,t+2.1,e-.42),v.rotation.y=Math.PI,i.add(v);const C=new ie;for(const V of[-1,1]){const O=new N(new wt(.35,3,.3),r);O.position.set(V*1.05,t+1.5,-7.4),C.add(O)}const S=new N(new wt(2.4,.4,.3),r);S.position.set(0,t+2.8,-7.4),C.add(S),i.add(C);const y=[];for(const V of[-1,1]){const O=new N(new wt(.86,2.5,.1),a);O.position.set(V*.43,t+1.3,-7.2),O.userData.homeX=V*.43,O.userData.side=V,i.add(O),y.push(O)}i.userData.setDoor=V=>{for(const O of y)O.position.x=O.userData.homeX+O.userData.side*.86*V};const P=(V,O=5.6)=>({x:Math.sin(V)*O,z:Math.cos(V)*O,rotY:V+Math.PI,sit:!0});xs(i,[{x:0,y:t,z:-.85,rotY:0,shirt:"gold",pose:"sit"},{x:-.8,y:t,z:.45,rotY:0,shirt:"gold",pose:"sit"},{x:.8,y:t,z:.45,rotY:0,shirt:"gold",pose:"sit"},{x:-1.6,y:t+.37,z:-3.2,rotY:.4,shirt:"blue",pose:"stand",station:P(-1.75)},{x:Math.sin(1.75)*5.6,y:t+.37,z:Math.cos(1.75)*5.6,rotY:1.75+Math.PI,shirt:"red",pose:"sit"},{x:2.2,y:t+.37,z:-3.6,rotY:-.6,shirt:"red",pose:"stand",station:P(2.35)},{x:Math.sin(-1.15)*5.6,y:t+.37,z:Math.cos(-1.15)*5.6,rotY:-1.15+Math.PI,shirt:"blue",pose:"sit"},{x:-.6,y:t+.37,z:-6.3,rotY:0,shirt:"red",pose:"stand",station:P(Math.PI-.55)},{x:.7,y:t+.37,z:-6.3,rotY:0,shirt:"gold",pose:"stand",station:P(Math.PI+.55)}]);for(let V=0;V<8;V++){const O=V/8*Math.PI*2+Math.PI/8,B=new N(new Gt(.5,.22),Vt(16757575,.25));B.position.set(Math.sin(O)*(e-.12),t+3.3,Math.cos(O)*(e-.12)),B.lookAt(0,t+3.3,0),B.userData.kind="alertlight",i.add(B)}const W=new N(new Pe(5.6,.12,8,96),Vt(16773852,1.3));W.rotation.x=Math.PI/2,W.position.y=t+3.9,W.userData.kind="alertring",i.add(W);const q=new N(new ee(.9,24,12,0,Math.PI*2,Math.PI/2,Math.PI/2),Vt(16774886,1.2));return q.position.y=t+4.9,q.userData.kind="glow",i.add(q),i}function Qe(i,t=.04){const e=_e(i);return e.emissiveIntensity=t,e.envMapIntensity=.12,e.roughness=.85,e}function wh(i,t,e,n,s,r,o,a,c){const l=new N(new Gt(s,o),c);l.rotation.x=-Math.PI/2,l.position.set(t,e,n),i.add(l);const u=new N(new Gt(s,o),a);u.rotation.x=Math.PI/2,u.position.set(t,e+r,n),i.add(u);for(const h of[-1,1]){const d=new N(new Gt(o,r),a);d.rotation.y=-h*Math.PI/2,d.position.set(t+h*s/2,e+r/2,n),i.add(d);const f=new N(new Gt(s,r),a);f.rotation.y=h>0?Math.PI:0,f.position.set(t,e+r/2,n+h*o/2),i.add(f)}}function Zx({cx:i=28,floorY:t=1.25,cz:e=-8}={}){const n=new ie;n.name="TransporterRoom";const s=9,r=2.7,o=9,a=Qe(10131345,.04),c=Qe(3816512,.03),l=Qe(9315878,.08),u=Qe(1382427,.02);wh(n,i,t,e,s,r,o,a,c);const h=new N(new Gt(s-1,r-.2),Qe(12081706,.12));h.rotation.y=Math.PI,h.position.set(i,t+r/2,e+o/2-.05),n.add(h);for(let S=0;S<6;S++){const y=new N(new wt(.12,r-.4,.06),u);y.position.set(i-3.2+S*1.28,t+r/2,e+o/2-.12),n.add(y)}const d=e+1.9,f=new N(new Ot(2.6,2.7,.28,48),Qe(2764081,.02));f.position.set(i,t+.14,d),n.add(f);const g=Vt(16773320,1.4),x=[];for(let S=0;S<6;S++){const y=S/6*Math.PI*2+Math.PI/6,P=new N(new Ot(.45,.45,.04,24),g);P.position.set(i+Math.cos(y)*1.6,t+.3,d+Math.sin(y)*1.6),n.add(P),x.push(P)}const m=new N(new Ot(2.5,2.5,.22,48),Qe(2764081,.02));m.position.set(i,t+r-.12,d),n.add(m);const p=new N(new Pi(1.2,2.3,48),Vt(16767400,1.1));p.rotation.x=Math.PI/2,p.position.set(i,t+r-.24,d),n.add(p);const w=new N(new wt(2.6,.14,.7),Qe(2764081,.02));w.position.set(i,t+.07,d-2.9),n.add(w);const M=e-o/2+1.6,_=new N(new wt(2.8,1,.8),u);_.position.set(i,t+.5,M),n.add(_);const T=new N(new Gt(2.6,.6),Vt(4182271,.9));T.rotation.x=-Math.PI/2+.25,T.position.set(i,t+1.02,M+.05),n.add(T);for(let S=-1;S<=1;S++){const y=new N(new wt(.08,.06,.4),l);y.position.set(i+S*.5,t+1.06,M+.1),n.add(y)}const b=new N(new Pe(.03,.03,6,8),l);b.visible=!1,n.add(b);const v=new Tn(16769216,10,14,1.6);v.position.set(i,t+r-.4,e-1),n.add(v);const C=new Tn(16770760,8,8,1.4);return C.position.set(i,t+r-.6,d),n.add(C),xs(n,[{x:i+.3,y:t,z:M-.9,rotY:0,shirt:"red",pose:"stand"},{x:i+Math.cos(Math.PI/6)*1.6,y:t+.3,z:d+Math.sin(Math.PI/6)*1.6,rotY:Math.PI,shirt:"gold",pose:"stand"},{x:i+Math.cos(Math.PI*5/6)*1.6,y:t+.3,z:d+Math.sin(Math.PI*5/6)*1.6,rotY:Math.PI,shirt:"blue",pose:"stand"},{x:i+Math.cos(Math.PI*1.5)*1.6,y:t+.3,z:d+Math.sin(Math.PI*1.5)*1.6,rotY:Math.PI,shirt:"red",pose:"stand"}]),n.userData={pads:x,padMat:g},n}function jx({cx:i=-30,floorY:t=1.25,cz:e=22}={}){const n=new ie;n.name="Sickbay";const s=12,r=2.7,o=9,a=Qe(10462106,.04),c=Qe(4869458,.03),l=Qe(1382427,.02),u=Qe(4098694,.08);wh(n,i,t,e,s,r,o,a,c);for(let p=0;p<3;p++){const w=e-3+p*3,M=i-s/2+1.5,_=new N(new wt(1,.45,2.3),Qe(14605008,.05));_.position.set(M,t+.45,w),n.add(_);const T=new N(new wt(.8,.25,1.6),l);T.position.set(M,t+.12,w),n.add(T);const b=new N(new wt(.15,1,1.9),l);b.position.set(i-s/2+.15,t+1.8,w),n.add(b);const v=new N(new Gt(1.7,.8),Vt([8257434,16757575,4182271][p],1));v.rotation.y=Math.PI/2,v.position.set(i-s/2+.24,t+1.8,w),n.add(v);for(let C=0;C<5;C++){const S=new N(new wt(.02,.1+Math.random()*.5,.12),Vt(16777215,1.6));S.position.set(i-s/2+.26,t+1.55+.1,w-.7+C*.35),n.add(S)}p===1&&xs(n,[{x:M,y:t+.68,z:w-.9,rotY:0,shirt:"red",pose:"lie"}])}const h=new N(new wt(s-.4,.3,.06),u);h.position.set(i,t+r-.3,e+o/2-.08),n.add(h);const d=new N(new wt(2,.8,1),l);d.position.set(i+s/2-1.8,t+.4,e+2.6),n.add(d);const f=new N(new wt(.5,.5,.35),l);f.position.set(i+s/2-1.8,t+1.05,e+2.8),n.add(f);const g=new N(new Gt(.4,.3),Vt(10475775,1.3));g.position.set(i+s/2-1.8,t+1.08,e+2.62),g.rotation.y=Math.PI,n.add(g);const x=new N(new wt(2.6,r-.6,.5),Qe(9080200,.03));x.position.set(i+1.5,t+(r-.6)/2,e-o/2+.3),n.add(x);for(let p=0;p<4;p++){const w=new N(new Ot(.06,.06,.25,8),Vt([8257434,16734810,4182271,16757575][p],.9));w.position.set(i+.6+p*.5,t+1.3,e-o/2+.62),n.add(w)}const m=new Tn(15791359,12,16,1.6);return m.position.set(i,t+r-.4,e),n.add(m),xs(n,[{x:i-s/2+2.6,y:t,z:e,rotY:Math.PI/2,shirt:"blue",pose:"stand"},{x:i+s/2-1.8,y:t,z:e+3.6,rotY:0,shirt:"blue",pose:"sit"},{x:i-1,y:t,z:e-2.4,rotY:-.6,shirt:"gold",pose:"stand"}]),n}const Ce=ro.saucerR,du=Ce+1;function la(i,t,e){const n=new Qs(i.map(([s,r])=>new dt(Math.max(.01,s),r)),t);if(e){const s=n.attributes.position,r=n.attributes.uv;for(let o=0;o<s.count;o++){const a=s.getX(o),c=s.getZ(o),l=(e==="bottom"?a:-a)/(2*du)+.5,u=c/(2*du)+.5;r.setXY(o,l,u)}r.needsUpdate=!0}return n}function $x(i,t,e){const n=new Ci;return n.absarc(0,0,i,Math.PI,Math.PI*2,!1),n.lineTo(e,t*.72),n.quadraticCurveTo(0,t,-e,t*.72),n.lineTo(-i,0),n}function fu(i,t,e,n,s,r){const o=new Ri($x(i,t,e),{depth:s-n,bevelEnabled:!0,bevelThickness:.3,bevelSize:.3,bevelSegments:3,curveSegments:56}),a=new N(o,r);return a.rotation.x=-Math.PI/2,a.position.y=n,a.castShadow=!0,a.receiveShadow=!0,a}function Kx(i,t,e){const n=_n(e),s=new Gt(1.05,.42);for(const[r,o]of[[.9,110],[-.9,90]])for(let a=0;a<o;a++){const c=a/o*Math.PI*2+n()*.01;if(Math.floor(a/5)%3!==0&&n()<.8||n()<.25||Math.cos(c)<-.94)continue;const u=new N(s,t),h=Ce+.5;u.position.set(Math.sin(c)*h,r,Math.cos(c)*h),u.lookAt(0,r,0),u.rotateY(Math.PI),u.userData.kind="window",i.add(u)}}function Jx(i,t,e){const n=_n(e),s=new Gt(1.4,.55),r=[{rad:Ce*.62,y:4.9,tilt:-.5,count:48},{rad:Ce*.56,y:-6,tilt:.7,count:36}];for(const o of r)for(let a=0;a<o.count;a++){if(n()<.62)continue;const c=a/o.count*Math.PI*2;if(Math.cos(c)<-.9&&o.y>0)continue;const l=new N(s,t);l.position.set(Math.sin(c)*o.rad,o.y,Math.cos(c)*o.rad),l.lookAt(0,o.y,0),l.rotateY(Math.PI),l.rotateX(o.tilt),l.userData.kind="window",i.add(l)}}function Qx(){const i=new ie;i.name="Saucer";const t=Ic(),e=un(lu("top")),n=un(lu("bottom")),s=t.clone();s.repeat.set(36,1),s.needsUpdate=!0;const r=un(s),o=un(null),a=en(jn.dark),c=tr(16767114,2.1),l=Mt.saucerRimHalf,u=Mt.saucerTop,h=new N(la([[.01,-6.4],[11,-6.4],[12.2,-6.4],[12.5,-4.3],[19,-4.3],[22,-4.8],[25,-5.6],[30,-6.2],[36,-5.9],[46,-5],[56,-3.9],[Ce,-l]],192,"bottom"),n),d=new N(la([[Ce,-l],[Ce+.4,-l*.55],[Ce+.55,0],[Ce+.4,l*.55],[Ce,l]],192),r),f=new N(la([[Ce,l],[56,3.4],[46,3.9],[36,4.5],[28,5.6],[23,7],[20.2,u],[.01,u]],192,"top"),e);for(const it of[h,d,f])it.castShadow=!0,it.receiveShadow=!0,i.add(it);i.add(fu(20,24,9,u-.05,Mt.bDeckTop,o)),i.add(fu(11.3,18.9,5.6,Mt.bDeckTop-.05,Mt.cDeckTop,o));const g=new N(new Ot(8,8.2,Mt.bridgeBaseTop-Mt.cDeckTop,64,1,!0),o);g.position.y=(Mt.bridgeBaseTop+Mt.cDeckTop)/2,i.add(g),i.add(Yx()),i.add(Zx()),i.add(jx());const x=Mt.bridgeTop-.6-Mt.bridgeBaseTop,m=new N(new ee(7.8,64,32,0,Math.PI*2,0,Math.PI*.5),o);m.scale.set(1,x/7.8,1),m.position.y=Mt.bridgeBaseTop,m.castShadow=!0,i.add(m);const p=new N(new Pe(7.85,.16,8,64),a);p.rotation.x=Math.PI/2,p.position.y=Mt.bridgeBaseTop+.05,i.add(p);const w=new N(new Ot(2.6,2.8,.5,32),o);w.position.y=Mt.bridgeTop-.6,i.add(w);const M=new N(new Ot(.5,.7,.7,16),a);M.position.y=Mt.bridgeTop-.1,i.add(M);const _=new N(new Ot(2.4,2.6,1.1,32),o);_.position.set(0,Mt.cDeckTop+.5,-14.5),i.add(_);for(let it=0;it<26;it++){const st=it/26*Math.PI*2;if(Math.cos(st)<-.55)continue;const L=new N(new Gt(.9,.4),c);L.position.set(Math.sin(st)*8.15,Mt.bridgeBaseTop-1,Math.cos(st)*8.15),L.lookAt(0,Mt.bridgeBaseTop-1,0),L.rotateY(Math.PI),L.userData.kind="window",i.add(L)}const T=new ie,b=11.5,v=new N(new wt(14,1.3,b),o);v.position.set(0,3.45,-Ce+.4+b/2),v.castShadow=!0,T.add(v);const C=12,S=new N(new wt(8,1.1,C),o);S.position.set(0,3.55,-Ce+.4+b+C/2-.6),S.rotation.x=-.04,T.add(S);const y=new N(new Ot(4,4,1.1,32,1,!1,Math.PI*.5,Math.PI),o);y.position.set(0,3.5,-Ce+.4+b+C-.6),y.scale.set(1,1,.6),T.add(y);const P=new N(new wt(14.2,.4,.4),a);P.position.set(0,3.9,-Ce+.4+b*.55),T.add(P);const W=new N(new wt(13.2,1.1,.4),a);W.position.set(0,3.5,-Ce+.15),T.add(W);const q=Vt(16742954,3.6);for(const it of[-4,0,4]){const st=new N(new Gt(3.2,.7),q);st.position.set(it,3.5,-Ce-.08),st.rotation.y=Math.PI,st.userData.kind="glow",T.add(st)}i.add(T);const V=11,O=-6.4-Mt.lowerDomeBottom,B=new N(new ee(V,64,32,0,Math.PI*2,0,Math.PI*.42),o);B.scale.set(1,O/(V*(1-Math.cos(Math.PI*.42))),1),B.rotation.x=Math.PI,B.position.y=-6.4,i.add(B);const Z=new N(new mo(V*Math.sin(Math.PI*.42),48),o);Z.rotation.x=Math.PI/2,Z.position.y=Mt.lowerDomeBottom+.02,i.add(Z);for(const[it,st]of[[10.6,-7.6],[9.2,-11],[7.2,-12.7]]){const L=new N(new Pe(it,.16,8,72),a);L.rotation.x=Math.PI/2,L.position.y=st,i.add(L)}const H=new N(new Pe(12.4,.18,8,96),a);H.rotation.x=Math.PI/2,H.position.y=-5.4,i.add(H);for(let it=0;it<3;it++){const st=it/3*Math.PI*2+Math.PI/6,L=new N(new ee(1.3,24,12,0,Math.PI*2,0,Math.PI*.5),o);L.rotation.x=Math.PI,L.position.set(Math.sin(st)*15.8,-4.3,Math.cos(st)*15.8),i.add(L)}const Y=new N(new Ot(.6,.8,1,16),a);Y.position.y=Mt.lowerDomeBottom-.4,i.add(Y),Kx(i,c,21),Jx(i,c,33);for(const it of[Math.PI*.28,-Math.PI*.28,Math.PI*.72,-Math.PI*.72]){const st=Ce*.66,L=new N(new wt(2.6,.5,2),o);L.position.set(Math.sin(it)*st,3.75,Math.cos(it)*st),L.rotation.y=it,i.add(L);const U=new N(new wt(2.4,.5,1.8),o);U.position.set(Math.sin(it)*st,-5.4,Math.cos(it)*st),U.rotation.y=it,i.add(U)}for(const it of[.3,-.3,Math.PI-.3,Math.PI+.3]){const st=Ce*.45,L=new N(new ee(.9,16,10,0,Math.PI*2,0,Math.PI*.5),o);L.rotation.x=Math.PI,L.position.set(Math.sin(it)*st,-6,Math.cos(it)*st),i.add(L)}const vt=Vt(16722474,6),X=Vt(2817898,6),et=Vt(16777215,6),ft=new N(new ee(.55,12,12),vt);ft.position.set(Ce+.3,.2,0);const Q=new N(new ee(.55,12,12),X);Q.position.set(-Ce-.3,.2,0);const nt=new N(new ee(.45,12,12),et);nt.position.set(0,Mt.bridgeTop+.3,0);const gt=new N(new ee(.45,12,12),et);return gt.position.set(0,Mt.lowerDomeBottom-1.1,0),i.add(ft,Q,nt,gt),i.userData.blinkers=[{mesh:nt,mat:et,phase:0,period:1.6},{mesh:gt,mat:et,phase:.8,period:1.6}],i.position.set(0,Mt.saucerY,Mt.saucerZ),i.userData.home=i.position.clone(),i.userData.explode=new R(0,32,14),i}function bh(){const i=Mt.secFrontZ-Mt.secondaryZ,t=e=>e-Mt.secondaryZ;return[{z:i,rx:9.3,ry:9.3,cy:0},{z:t(37),rx:11.4,ry:11.4,cy:0},{z:t(33),rx:13,ry:13,cy:0},{z:t(27),rx:14,ry:14,cy:0},{z:t(18),rx:Mt.secR,ry:Mt.secR,cy:0},{z:t(8),rx:14,ry:13.9,cy:0},{z:t(-2),rx:13.3,ry:13.2,cy:0},{z:t(-13),rx:12.5,ry:12.3,cy:0},{z:t(-24),rx:11.7,ry:11.5,cy:0},{z:t(-34),rx:11,ry:10.8,cy:0},{z:t(-45),rx:10.1,ry:8,cy:2.2},{z:t(-53),rx:9.5,ry:6.6,cy:3.1},{z:t(-58),rx:8.4,ry:6.2,cy:3.4},{z:t(-61),rx:6.2,ry:5.8,cy:3.4},{z:t(Mt.secSternZ),rx:4.4,ry:4.8,cy:Mt.hangarLift}]}const tv=bh();function Qi(i){const t=tv;if(i>t[0].z||i<t.at(-1).z)return null;for(let e=0;e<t.length-1;e++){const n=t[e],s=t[e+1];if(i<=n.z&&i>=s.z){const r=(n.z-i)/(n.z-s.z||1),o=n.rx+(s.rx-n.rx)*r,a=n.ry+(s.ry-n.ry)*r;return{rx:o,ry:a,r:o,cy:n.cy+(s.cy-n.cy)*r}}}return null}function ev(i,t,e=1){const n=Qi(t);if(!n)return 0;const s=(i-n.cy)/n.ry,r=1-s*s;return r<=0?0:Math.max(0,n.rx*Math.sqrt(r)-e)}function pu(i){const t=document.createElement("canvas");t.width=512,t.height=96;const e=t.getContext("2d");e.clearRect(0,0,512,96),e.fillStyle="#1d201f",e.font='700 44px Michroma, "Arial Black", sans-serif',e.textAlign="center",e.textBaseline="middle",e.fillText(i,256,48);const n=new xn(t);return n.colorSpace=be,n}function mu(i="GALILEO",t="NCC-1701/7"){const e=new ie;e.name=`Shuttle ${i}`;const n=un(null),s=en(2764075),r=tr(16770736,2.4),o=7.3,a=2.3,c=new Ci;c.moveTo(-o/2,0),c.lineTo(-o/2,a),c.lineTo(o/2-1.9,a),c.lineTo(o/2-.3,a-.9),c.lineTo(o/2,.55),c.lineTo(o/2-.4,0),c.closePath();const l=new N(new Ri(c,{depth:2.4,bevelEnabled:!0,bevelThickness:.08,bevelSize:.08,bevelSegments:2}),n);l.rotation.y=-Math.PI/2,l.position.x=1.2+.08,l.castShadow=!0,e.add(l);for(const p of[-.55,.55]){const w=new N(new Gt(.9,.55),r);w.position.set(p,a-.55,o/2-.62),w.rotation.x=-.5,w.userData.kind="window",e.add(w)}for(const p of[-1,1]){for(let M=0;M<3;M++){const _=new N(new Gt(.5,.3),r);_.position.set(p*1.29,a-.7,o/2-2.4-M*1.1),_.rotation.y=p*Math.PI/2,_.userData.kind="window",e.add(_)}const w=new N(new Gt(3.2,.6),new An({map:pu(t),transparent:!0,roughness:.6}));w.position.set(p*1.29,.8,-.6),w.rotation.y=p*Math.PI/2,e.add(w)}const u=new N(new Gt(2.4,.45),new An({map:pu(i),transparent:!0,roughness:.6}));u.position.set(0,a+.01,-.8),u.rotation.x=-Math.PI/2,e.add(u);const h=new N(new wt(1.6,1.6,.08),s);h.position.set(0,.95,-o/2-.02),e.add(h);const d=Vt(16722474,4),f=Vt(2817898,4),g=new N(new ee(.08,8,6),d);g.position.set(1.25,a-.1,.5);const x=new N(new ee(.08,8,6),f);x.position.set(-1.25,a-.1,.5),e.add(g,x);const m=Vt(16742970,2.4);for(const p of[-1,1]){const w=new N(new wt(.7,.22,3.4),n);w.position.set(p*1.45,.25,-.2),w.rotation.z=p*.25,e.add(w);const M=new N(new Ot(.42,.42,5.6,20),n);M.rotation.x=Math.PI/2,M.position.set(p*1.75,.05,-.3),M.castShadow=!0,e.add(M);const _=new N(new ee(.42,16,10),n);_.position.set(p*1.75,.05,2.5),e.add(_);const T=new N(new Ot(.3,.3,.2,16),m);T.rotation.x=Math.PI/2,T.position.set(p*1.75,.05,-3.15),T.userData.kind="glow",e.add(T);const b=new N(new wt(.02,.5,5.2),s);b.position.set(p*(1.75+.42),.05,-.3),e.add(b)}for(const p of[-1,1]){const w=new N(new wt(.22,.16,4.6),s);w.position.set(p*.9,-.08,-.2),e.add(w)}return e.userData.length=o,e}const nv=new Wt(16751184),gu=new re,iv=new R,sv=new R(0,1,0);function rv(i,t){const e=new ie;e.name="Hangar";const n=i.rx-.2,s=i.ry-.2,r=i.z,o=i.cy,a=26,c=r+a,l=7.4,u=o-s+.5,h=o+s-.6,d=_e(12170406);d.emissiveIntensity=.08;const f=_e(9341566);f.emissiveIntensity=.05;const g=en(2764075),x=Vt(16773590,2.6),m=Vt(16766570,.8),p=tr(16770736,1.8),w=new N(new Gt(l*2,a),f);w.rotation.x=-Math.PI/2,w.position.set(0,u,r+a/2),w.receiveShadow=!0,e.add(w);const M=new N(new Gt(l*2,a),d);M.rotation.x=Math.PI/2,M.position.set(0,h,r+a/2),e.add(M);for(const U of[-1,1]){const G=new N(new Gt(a,h-u),d);G.rotation.y=-U*Math.PI/2,G.position.set(U*l,(u+h)/2,r+a/2),e.add(G);for(let k=0;k<6;k++){const j=new N(new Gt(2.2,.9),p);j.rotation.y=-U*Math.PI/2,j.position.set(U*(l-.05),h-1.6,r+5+k*3.6),e.add(j)}for(let k=0;k<=6;k++){const j=new N(new wt(.3,h-u,.4),g);j.position.set(U*(l-.15),(u+h)/2,r+2+k*4),e.add(j)}}const _=new N(new Gt(l*2,h-u),d);_.rotation.y=Math.PI,_.position.set(0,(u+h)/2,c),e.add(_);const T=new N(new wt(5.5,4.2,.2),g);T.position.set(0,u+2.1,c-.15),e.add(T);const b=new N(new Gt(6,1.2),Vt(10475775,1.4));b.rotation.y=Math.PI,b.position.set(0,h-1.5,c-.1),e.add(b);for(const U of[-4.5,0,4.5]){const G=new N(new Gt(.5,a-3),x);G.rotation.x=Math.PI/2,G.position.set(U,h-.05,r+a/2),G.userData.kind="glow",e.add(G)}const v=new N(new Gt(.35,a-2),m);v.rotation.x=-Math.PI/2,v.position.set(0,u+.02,r+a/2),e.add(v);const C=r+9,S=new N(new Pi(4.2,4.6,64),m);S.rotation.x=-Math.PI/2,S.position.set(0,u+.03,C),e.add(S);const y=new N(new Ot(4.2,4.2,.12,64),_e(8157293));y.position.set(0,u+.06,C),e.add(y);for(let U=0;U<8;U++){const G=new N(new ee(.16,8,6),Vt(16751162,2.5));G.position.set(-l+.6+U*2,u+.15,r+1.2),G.userData.kind="glow",e.add(G)}const P=new Tn(16769728,0,40,1.6);P.position.set(0,h-1,r+a*.4),e.add(P);const W=en(3159098,{roughness:.6,metalness:.3}),q=new N(new Pe(1,.32,10,80),t);q.scale.set(n+.25,s+.25,1),q.position.set(0,o,r),e.add(q);const V=[];for(const U of[-1,1]){const G=new N(new ee(1,28,14,U<0?-Math.PI/2:Math.PI/2,Math.PI,0,Math.PI*.5),W);G.rotation.x=-Math.PI/2,G.scale.set(n,s,3.4);const k=new ie;k.add(G),k.position.set(0,o,r),k.userData.side=U,e.add(k),V.push(k);for(let j=-2;j<=2;j++){const D=j*2,mt=n*Math.sqrt(Math.max(0,1-(D/s)**2))*.9,rt=new N(new wt(mt/2,.2,.4),en(4869975));rt.position.set(U*mt/4,D,-3*Math.sqrt(Math.max(.05,1-(D/s)**2))),k.add(rt)}}const O=mu("GALILEO","NCC-1701/7");O.position.set(0,u+.12,C),O.rotation.y=Math.PI,e.add(O);const B=mu("COLUMBUS","NCC-1701/2");B.position.set(-4.3,u+.12,c-6),B.rotation.y=Math.PI*.86,e.add(B),xs(e,[{x:-5.2,y:u+.12,z:C+5,rotY:Math.PI*.75,shirt:"red",pose:"stand",station:{x:-l+.9,z:c-3,rotY:Math.PI/2}},{x:5.6,y:u+.12,z:C-2,rotY:-Math.PI*.6,shirt:"red",pose:"stand",station:{x:l-.9,z:c-3,rotY:-Math.PI/2}}]);const Z=new gs([new R(0,u+.12,C),new R(0,u+1.2,r+3),new R(0,o-.5,r-8),new R(0,o+6,r-40),new R(0,o+22,r-120),new R(0,o+48,r-300)],!1,"centripetal"),H=O.position.clone(),Y=new ie;Y.visible=!1;const vt=new hn({color:16747068,transparent:!0,opacity:0,blending:ve,depthWrite:!1,side:Re}),X=new N(new io(2.4,7.5,24,1,!0),vt);X.rotation.x=-Math.PI/2,X.position.set(0,.9,2.6),Y.add(X);const et=new N(new io(1.6,9.5,20,1,!0),new hn({color:16773572,transparent:!0,opacity:0,blending:ve,depthWrite:!1,side:Re}));et.rotation.x=-Math.PI/2,et.position.set(0,.9,1.8),Y.add(et);const ft=new tn(new je({map:ui("rgba(255,150,70,1)"),blending:ve,depthWrite:!1,transparent:!0,opacity:0}));ft.scale.setScalar(14),ft.position.set(0,.9,4.5),Y.add(ft);const Q=new hn({color:16742960,transparent:!0,opacity:0,blending:ve,depthWrite:!1}),nt=new N(new Ot(.2,1.8,46,12,1,!0),Q);nt.rotation.x=Math.PI/2,nt.position.set(0,.9,-24),Y.add(nt),O.add(Y);const gt=[vt,et.material,ft.material,Q];let it=0;const st={open:0,target:0,launch:-1,launchDur:28,mode:"away",path:null,atmo:null},L=U=>U*U*(3-2*U);return e.userData={doors:V,shuttle:O,bayLight:P,get isOpen(){return st.target>.5},get launching(){return st.launch>=0},setOpen(U){st.target=U?1:0},launch(){st.launch>=0||(st.target=1,st.launch=0,st.mode="away",st.path=Z,st.launchDur=28)},launchTo(U,G,k=46){if(st.launch>=0)return;const j=new R(0,o-.5,r-8),D=new R(0,o+4,r-60),mt=U.clone().sub(D).normalize(),rt=U.clone().addScaledVector(mt,-G*1.28),xt=U.clone().addScaledVector(mt,-G*1.02),ct=new R().crossVectors(mt,new R(0,1,0)).normalize(),Et=D.clone().lerp(rt,.45).addScaledVector(ct,G*.09).add(new R(0,G*.05,0));st.path=new gs([new R(0,u+.12,C),new R(0,u+1.2,r+3),j,D,Et,rt,xt],!1,"centripetal"),st.path.arcLengthDivisions=600;const z=st.path.getLengths(600),A=z[z.length-1];let E=0;const $=st.path.points;for(let ut=0;ut<3;ut++)E+=$[ut].distanceTo($[ut+1]);st.taxiFrac=Math.min(.3,E/A),st.atmo={center:U.clone(),radius:G},st.mode="descent",st.launchDur=k,st.target=1,st.launch=0},get descending(){return st.launch>=0&&st.mode==="descent"},get heat(){return it},get progress(){return st.launch},get pathPoints(){return(st.path||Z).points.map(U=>U.toArray().map(G=>Math.round(G)))},shuttleWorld(U=new R){return O.getWorldPosition(U)},shuttleHeading(U=new R){return O.getWorldDirection(U)},recall(){st.launch=-1,st.mode="away",it=0,Y.visible=!1,O.position.copy(H),O.rotation.set(0,Math.PI,0),O.visible=!0},animate(U){st.open+=(st.target-st.open)*Math.min(1,U*1.4);const G=L(Math.min(1,Math.max(0,st.open)));for(const k of V)k.position.x=k.userData.side*n*.92*G,k.scale.x=1-.86*G,k.position.z=r+1.2*G;if(P.intensity=30*G,st.launch>=0){if(st.open<.85&&st.launch<.02)return;st.launch+=U/st.launchDur;const k=Math.min(1,st.launch),j=st.path||Z;if(O.visible=!0,st.mode==="descent"){const D=st.taxiFrac??.08,mt=k<.22?L(k/.22)*D:D+Math.pow((k-.22)/.78,1.3)*(1-D),rt=j.getPointAt(Math.min(1,mt)),xt=j.getTangentAt(Math.min(.999,mt));O.position.copy(rt),gu.lookAt(xt,iv,sv),O.quaternion.setFromRotationMatrix(gu),O.rotateZ(Math.sin(k*9)*.05*Math.min(1,it*3));const ct=rt.distanceTo(st.atmo.center),Et=st.atmo.radius,z=Math.min(1,Math.max(0,(Et*1.3-ct)/(Et*.24)));it+=(z-it)*Math.min(1,U*2);const A=.82+.18*Math.sin(performance.now()*.031)*Math.sin(performance.now()*.0173);Y.visible=it>.01,vt.opacity=it*.55*A,et.material.opacity=it*it*.5*A,ft.material.opacity=it*.7*A,Q.opacity=it*.4*A,ft.scale.setScalar(14+it*14),nt.scale.y=.4+it*1.6;const E=1-it*.35;O.traverse($=>{$.isMesh&&$.material?.color&&!gt.includes($.material)&&$.userData.kind!=="glow"&&($.userData.baseColor||($.userData.baseColor=$.material.color.clone()),$.material.color.copy($.userData.baseColor).multiplyScalar(E).lerp(nv,it*.45))}),k>=1&&(O.visible=!1,Y.visible=!1,st.launch=-1)}else{const D=k<.35?L(k/.35)*.3:.3+Math.pow((k-.35)/.65,1.6)*.7,mt=j.getPoint(D),rt=j.getTangent(Math.min(.999,D));O.position.copy(mt),O.rotation.set(0,Math.PI,0),O.rotation.x=-Math.atan2(rt.y,Math.abs(rt.z))*.6,k>=1&&(O.visible=!1,st.launch=-1)}}}},e}function ov({centerZ:i=-12,floorY:t=2.2}={}){const e=new ie;e.name="EngineeringInterior";const n=13.5,s=7.4,r=24,o=(O,B=.04)=>{const Z=_e(O);return Z.emissiveIntensity=B,Z.envMapIntensity=.12,Z.roughness=.85,Z},a=o(10328722,.04),c=o(3816512,.03),l=o(9315878,.08),u=o(7106419,.05),h=o(4935509,.04),d=i+r/2,f=i-r/2,g=new N(new Gt(n,r),c);g.rotation.x=-Math.PI/2,g.position.set(0,t,i),e.add(g);const x=new N(new Gt(n,r),a);x.rotation.x=Math.PI/2,x.position.set(0,t+s,i),e.add(x);for(const O of[-1,1]){const B=new N(new Gt(r,s),a);B.rotation.y=-O*Math.PI/2,B.position.set(O*n/2,t+s/2,i),e.add(B);for(let H=0;H<4;H++){const Y=d-3-H*5,vt=new N(new wt(.6,1.1,2.6),o(1711392,.02));vt.position.set(O*(n/2-.35),t+.55,Y),e.add(vt);const X=new N(new Gt(2.4,1.2),Vt([4182271,16757575,8257434,16734810][H],.9));X.rotation.y=-O*Math.PI/2,X.position.set(O*(n/2-.08),t+2.2,Y),e.add(X)}const Z=new N(new wt(.1,.35,r-1),l);Z.position.set(O*(n/2-.06),t+3.6,i),e.add(Z)}const m=new N(new Gt(n,s),a);m.rotation.y=Math.PI,m.position.set(0,t+s/2,d),e.add(m);const p=-3.5,w=[];for(const O of[-1,1]){const B=new N(new wt(1,2.6,.12),l);B.position.set(p+O*.5,t+1.3,d-.1),B.userData.homeX=p+O*.5,B.userData.side=O,e.add(B),w.push(B)}e.userData.setDoor=O=>{for(const B of w)B.position.x=B.userData.homeX+B.userData.side*1*O},e.userData.door={x:p,y:t,z:d},xs(e,[{x:1.6,y:t,z:i+3.6,rotY:Math.PI*.9,shirt:"red",pose:"stand",station:{x:n/2-1.2,z:d-8,rotY:Math.PI/2}},{x:-n/2+1.6,y:t,z:d-8,rotY:-Math.PI/2,shirt:"red",pose:"stand",station:{x:-n/2+1.2,z:d-13,rotY:-Math.PI/2}},{x:3,y:t,z:f+7,rotY:Math.PI,shirt:"gold",pose:"stand",station:{x:.9,z:i+3.4,rotY:Math.PI}}]);for(let O=0;O<4;O++){const B=new N(new Gt(.6,.25),Vt(16757575,.25)),Z=O%2===0?-1:1;B.rotation.y=-Z*Math.PI/2,B.position.set(Z*(n/2-.06),t+s-1,d-5-Math.floor(O/2)*10),B.userData.kind="alertlight",e.add(B)}const M=new ie,_=f+3.2;for(let O=0;O<=12;O++){const B=new N(new wt(.12,s-.4,.12),u);B.position.set(-n/2+.8+O*((n-1.6)/12),t+s/2,_),M.add(B)}for(let O=0;O<=5;O++){const B=new N(new wt(n-1.4,.1,.1),u);B.position.set(0,t+.6+O*((s-1.2)/5),_),M.add(B)}e.add(M);const T=new N(new Gt(n,s),o(2830134,.02));T.position.set(0,t+s/2,f),e.add(T);const b=Vt(16751178,2.6);for(let O=0;O<5;O++){const B=new N(new Ot(.42,.42,s-1.2,16),h);B.position.set(-4.4+O*2.2,t+s/2,f+1.6),e.add(B);const Z=new N(new Pe(.55,.08,8,24),b);Z.rotation.x=Math.PI/2,Z.position.set(-4.4+O*2.2,t+1.8+O%2*2.4,f+1.6),Z.userData.kind="glow",e.add(Z)}const v=new N(new Gt(n-2,s-2),Vt(16742954,.55));v.position.set(0,t+s/2,f+.4),v.userData.kind="glow",e.add(v);for(const O of[-2.2,2.2]){const B=new N(new Ot(.5,.5,r-2,20),h);B.rotation.x=Math.PI/2,B.position.set(O,t+s-.9,i),e.add(B);for(let Z=0;Z<6;Z++){const H=new N(new Pe(.56,.08,8,24),Vt(8050687,1.6));H.rotation.x=0,H.position.set(O,t+s-.9,d-2.5-Z*3.6),H.userData.kind="glow",e.add(H)}}const C=new N(new Ot(1.5,1.7,.9,32),o(1711392,.02));C.position.set(0,t+.45,i+2),e.add(C);const S=new N(new Ot(.7,.7,.5,24),o(2764081,.02));S.position.set(0,t+1.15,i+2),e.add(S);const y=new N(new Ot(0,.42,.8,6),Vt(16734880,2.4));y.position.set(0,t+1.7,i+2),y.userData.kind="glow",e.add(y);const P=new N(new Gt(4.2,1.6),Vt(10475775,1.1));P.rotation.y=Math.PI,P.position.set(3.2,t+3.2,d-.15),P.userData.kind="glow",e.add(P);const W=new N(new wt(n-2,.08,.08),l);W.position.set(0,t+1.05,f+5.2),e.add(W);for(let O=0;O<6;O++){const B=new N(new Ot(.05,.05,1,8),l);B.position.set(-n/2+1.2+O*((n-2.4)/5),t+.55,f+5.2),e.add(B)}const q=new Tn(16766896,18,30,1.6);q.position.set(0,t+s-1.5,i),e.add(q);const V=new Tn(16747066,22,26,1.6);return V.position.set(0,t+s/2,f+2.6),e.add(V),e.userData.floorY=t,e.userData.centerZ=i,e}const av=Mt.secR,cv=bh;function lv(){const i=new ie;i.name="SecondaryHull";const t=Ic();t.repeat.set(6,4);const e=un(t),n=un(null),s=en(jn.dark),r=Vx(),o=tr(16767114,2.8),a=cv(),c=a.length-3,l=a.slice(0,c+1).map(nt=>Mh(new R(0,nt.cy,nt.z),vh,yh,nt.rx,nt.ry,72)),u=new N(Pc(l,{vScale:4}),e);u.castShadow=!0,u.receiveShadow=!0,i.add(u);const h=a[0],d=new N(oo(l[0],new R(0,h.cy,h.z),!1),n);i.add(d);const f=new N(new Pe(h.rx-.3,.35,10,72),s);f.position.set(0,h.cy,h.z+.1),i.add(f);const g=new N(new Ot(1.6,3.2,3,40),r);g.rotation.x=Math.PI/2,g.position.set(0,h.cy,h.z+1.5),i.add(g);const x=new N(new Pe(3.4,.5,12,48),r);x.position.set(0,h.cy,h.z+.4),i.add(x);const m=Mt.dishR,p=3.2,w=[];for(let nt=0;nt<=28;nt++){const gt=nt/28;w.push(new dt(Math.max(.01,m*gt),p*gt*gt))}const M=h.z+3,_=new N(new Qs(w,80),r);_.rotation.x=Math.PI/2,_.position.set(0,h.cy,M),_.castShadow=!0,i.add(_);const T=new N(new Pe(m,.26,10,80),s);T.position.set(0,h.cy,M+p),i.add(T);const b=Mt.dishTipZ-Mt.secondaryZ-M,v=new N(new Ot(.16,.42,b,16),r);v.rotation.x=Math.PI/2,v.position.set(0,h.cy,M+b/2),i.add(v);const C=new N(new ee(.5,16,12),Vt(16761466,4));C.position.set(0,h.cy,M+b),C.userData.kind="glow",i.add(C);const S=new N(new ee(3,24,16),Vt(9098495,2.2));S.scale.set(1,1,.35),S.position.set(0,h.cy,M+.8),S.userData.kind="glow",i.add(S);const y=rv(a[c],n);i.add(y),i.userData.hangar=y;const P=ov({centerZ:Mt.pylon.rootZ-Mt.secondaryZ+14,floorY:2.4});i.add(P),i.userData.engineering=P;const W=Vt(10477823,2),q=a[c];for(const nt of[-1,1]){const gt=new N(new ee(.3,12,8),W);gt.position.set(nt*(q.rx+.3),q.cy-q.ry*.35,q.z-.6),gt.userData.kind="glow",i.add(gt)}const V=_n(51),O=new Gt(.85,.48);for(const nt of[4.6,-2.2])for(let gt=34;gt>-40;gt-=4.1){if(V()<.35)continue;const it=Qi(gt);if(it)for(const st of[-1,1]){const L=1-((nt-it.cy)/it.ry)**2;if(L<=.05)continue;const U=it.rx*Math.sqrt(L)+.06;if(U<3)continue;const G=new N(O,o);G.position.set(st*U,nt,gt),G.lookAt(st*U*2,nt*2-it.cy,gt),G.userData.kind="window",i.add(G)}}const B=.27,Z=20,H=Qi(Z).rx+.1;for(const nt of[-1,1]){const gt=kx(nt>0),it=new Ot(H,H,24,32,1,!0,(nt>0?Math.PI/2:-Math.PI/2)-B,B*2),st=new N(it,Hx(gt));st.rotation.x=Math.PI/2,st.position.set(0,1,Z),st.userData.kind="decal",i.add(st)}const Y=en(10234402,{roughness:.5,metalness:.1}),vt=en(1776924,{roughness:.5,metalness:.1}),X=38,et=Qi(X).rx;for(const nt of[-1,1])for(const[gt,it,st]of[[1.4,vt,.22],[.9,Y,.5],[.4,vt,.22]]){const L=4+gt,U=Math.sqrt(Math.max(0,et*et-L*L))+.05,G=new N(new Gt(10,st),it);G.position.set(nt*U,L,X),G.lookAt(nt*U*2,L*2,X),i.add(G)}const ft=new N(new wt(2.4,.6,50),n);ft.position.set(0,av-.6,6),ft.rotation.x=.03,i.add(ft);const Q=new N(new Pe(Qi(36).rx+.04,.16,8,96),s);Q.position.set(0,0,36),i.add(Q);for(const nt of[-1,1]){const it=Qi(-20),st=new N(new wt(.3,3.2,3.2),s);st.position.set(nt*(it.rx-.05)*Math.cos(.45),-it.ry*Math.sin(.45)+it.cy,-20),st.rotation.z=nt*.45,i.add(st)}return i.position.set(0,Mt.secondaryY,Mt.secondaryZ),i.userData.home=i.position.clone(),i.userData.explode=new R(0,-30,-16),i}function uv(){const i=new ie;i.name="Dorsal";const t=Mt.neck,e=un(null),n=tr(16767114,2.6),s=new Ci;s.moveTo(-46.4,t.topYLead+1.2),s.lineTo(-16.2,t.topYTrail+1.2),s.lineTo(3.1,t.botY),s.lineTo(-24.5,t.botY),s.closePath();const r=new Ri(s,{depth:t.thick,bevelEnabled:!0,bevelThickness:.9,bevelSize:.9,bevelSegments:5}),o=new N(r,e);o.rotation.y=Math.PI/2,o.position.x=-6.2/2,o.castShadow=!0,o.receiveShadow=!0,i.add(o);const a=new R(0,(t.topYLead+t.topYTrail)/2,(t.topZ[0]+t.topZ[1])/2),c=new R(0,t.botY,(t.botZ[0]+t.botZ[1])/2),l=new Gt(1.2,.48),u=_n(77);for(let g=0;g<4;g++){const x=.2+g*.2,m=a.clone().lerp(c,x);for(const p of[-1,1])for(const w of[-7,-3.5,0,3.5,7]){if(u()<.5)continue;const M=new N(l,n);M.position.set(p*(t.thick/2+.95),m.y,m.z+w),M.rotation.y=p*Math.PI/2,M.userData.kind="window",i.add(M)}}const h=en(jn.dark),d=Math.hypot(t.topZ[1]-t.botZ[1],t.topYLead-t.botY)*.8,f=new N(new wt(.6,d,.35),h);return f.position.set(0,(t.topYLead+t.botY)/2,(t.topZ[1]+t.botZ[1])/2+.7),f.rotation.x=-Math.atan2(t.topZ[1]-t.botZ[1],t.topYLead-t.botY),i.add(f),i.userData.home=new R,i.userData.explode=new R(0,2,0),i}function _u(i){const t=new ie;t.name=i>0?"PylonStarboard":"PylonPort";const e=Mt.pylon,n=un(null),s=new R(i*e.rootX,e.rootY,e.rootZ),r=new R(i*e.tipX,e.tipY,e.tipZ),o=r.clone().sub(s),a=new R().crossVectors(Or,o).normalize(),c=[oa(s,Or,a,e.chordRoot,e.thick,e.thick*.48,40),oa(s.clone().lerp(r,.5),Or,a,(e.chordRoot+e.chordTip)/2,e.thick,e.thick*.48,40),oa(r,Or,a,e.chordTip,e.thick*.9,e.thick*.44,40)],l=new N(Pc(c),n);l.castShadow=!0,l.receiveShadow=!0,t.add(l),t.add(new N(oo(c[0],s),n)),t.add(new N(oo(c[2],r,!0),n));const u=new N(new wt(e.thick*1.6,3.2,e.chordTip+8),n);u.position.set(i*(e.tipX+2.2),e.tipY-1.2,e.tipZ+3.5),u.rotation.z=i*.55,t.add(u);const h=new N(new wt(e.thick*1.8,2.6,e.chordRoot+3),n);return h.position.set(i*(e.rootX+.6),e.rootY+1.8,e.rootZ),h.rotation.z=i*.5,t.add(h),t.userData.home=new R,t.userData.explode=new R(i*14,8,0),t}const Ee=Mt.nacelleR,Us=Mt.nacelleRY;function hv(){const i=Mt.nacelleL*.5,t=-i;return[{z:i-7.6,r:Ee*.94},{z:i-9.6,r:Ee},{z:i-17,r:Ee*1.01},{z:-30,r:Ee*1.01},{z:t+28,r:Ee*.99},{z:t+16,r:Ee*.96},{z:t+9,r:Ee*.9},{z:t+4,r:Ee*.78},{z:t+1.5,r:Ee*.62}]}function xu(i,t){const e=new ie;e.name=i>0?"NacelleStarboard":"NacellePort";const n=en(jn.dark),s=un(null),r=hv(),o=-154.5*.5,a=r.map(O=>Mh(new R(0,0,O.z),vh,yh,O.r,O.r*Us,64)),c=new N(Pc(a,{vScale:6}),t);c.castShadow=!0,c.receiveShadow=!0,e.add(c);const l=r.at(-1),u=new N(oo(a.at(-1),new R(0,0,l.z),!1),n);e.add(u);const h=Vt(16751162,2.6),d=Vt(16761466,3),f=new N(new Pe(Ee*.7,.34,10,48),s);f.position.z=l.z-.2,e.add(f);const g=new N(new Pe(Ee*.5,.22,10,48),h);g.position.z=l.z-.6,g.userData.kind="glow",e.add(g);const x=new N(new ee(Ee*.38,32,20),d);x.position.z=l.z+.6,x.userData.kind="glow",e.add(x);const m=new N(new mo(Ee*.6,48),n);m.position.z=l.z+.05,m.rotation.y=Math.PI,e.add(m);for(let O=0;O<8;O++){const B=O/8*Math.PI*2,Z=new N(new wt(.3,2.2,1.2),s);Z.position.set(Math.cos(B)*Ee*.6,Math.sin(B)*Ee*.6,l.z-.6),Z.rotation.z=B+Math.PI/2,e.add(Z)}const p=r[0],w=Ee*.975,M=new N(new Pe(w-.15,.55,12,64),n);M.position.z=p.z+.1,M.scale.y=Us,e.add(M);const _=new N(new ee(w,64,40,0,Math.PI*2,0,Math.PI*.5),zx());_.rotation.x=Math.PI/2,_.scale.set(1,1,Us),_.position.z=p.z+.2,_.userData.kind="bussard",e.add(_);const T=new ie;T.position.z=p.z+2.6;const b=[16765562,16742954,16757575,16731418,16769162];for(let O=0;O<5;O++){const B=new N(new Gt(1.5,5.4),Vt(b[O],3.4));B.position.y=3.2;const Z=new ie;Z.rotation.z=O/5*Math.PI*2,Z.add(B),T.add(Z)}const v=new N(new ee(2.3,24,16),Vt(16771520,5.5));v.userData.kind="glow",T.add(v),T.userData.kind="fan",e.add(T),e.userData.fan=T,e.userData.fanDir=i;const C=new N(new wt(2.4,.8,118),s);C.position.set(0,Ee*Us-.1,2),C.castShadow=!0,e.add(C);const S=o+24,y=en(3817020,{roughness:.6}),P=Vt(8373247,.9);for(const O of[-1,1]){const B=new N(new wt(.5,4.6,28),n);B.position.set(O*(Ee-.05),.5,S),e.add(B);for(let Z=0;Z<16;Z++){const H=new N(new wt(.7,4.2,.36),y);if(H.position.set(O*(Ee+.05),.5,S-13.5+Z*1.8),e.add(H),Z%2===0){const Y=new N(new Gt(.1,3.9),P);Y.position.set(O*(Ee+.42),.5,S-13.5+Z*1.8+.9),Y.rotation.y=O*Math.PI/2,Y.userData.kind="glow",e.add(Y)}}}for(const O of[-1,1]){const B=new N(new wt(.4,1.6,9),n);B.position.set(O*(Ee-.05),2.6,p.z-16),e.add(B)}const W=en(10234402,{roughness:.5,metalness:.1}),q=en(1776924,{roughness:.5,metalness:.1});for(const[O,B,Z]of[[-3.2,q,.35],[-4.6,W,.6],[-6.2,q,.35]]){const H=new N(new Pe(Ee*1.005,Z*.5,6,96),B);H.position.z=p.z+O,H.scale.y=Us,e.add(H)}const V=Vt(7321855,.35);for(const O of[-1,1]){const B=new N(new Gt(.16,96),V);B.position.set(O*(Ee*1.005),-2.4,4),B.rotation.y=O*Math.PI/2,B.rotation.z=Math.PI/2,B.userData.kind="warpstrip",e.add(B)}return e.userData.warpStrip=V,e.position.set(i*Mt.nacelleX,Mt.nacelleY,Mt.nacelleZ),e.userData.home=e.position.clone(),e.userData.explode=new R(i*34,16,-8),e}function dv(){const i=new ie;i.name="Nacelles";const t=Ic();t.repeat.set(4,6);const e=un(t);return i.add(xu(-1,e)),i.add(xu(1,e)),i}const ts=14275263,fv=15394524;function ua(i,t){const e=document.createElement("canvas");e.width=512,e.height=128;const n=e.getContext("2d");n.fillStyle="rgba(6,8,12,0.6)",n.fillRect(8,24,496,80),n.strokeStyle=t,n.lineWidth=2,n.strokeRect(8,24,496,80),n.fillStyle="#e8eef4",n.font="30px 'Share Tech Mono', monospace",n.textBaseline="middle",n.fillText(i,24,64);const s=new xn(e),r=new tn(new je({map:s,transparent:!0,depthTest:!1}));return r.scale.set(20,5,1),r.userData.kind="label",r}class pv{constructor(t=fv){this.items=[],this.mat=_e(t),this.mat.emissiveIntensity=.1}add(t,e,n,s,r,o,a=0){this.items.push({cx:t,cy:e,cz:n,sx:s,sy:r,sz:o,rotY:a})}build(){const t=new wt(1,1,1),e=new zg(t,this.mat,this.items.length),n=new De,s=new re;return this.items.forEach((r,o)=>{n.position.set(r.cx,r.cy,r.cz),n.rotation.set(0,r.rotY,0),n.scale.set(r.sx,r.sy,r.sz),n.updateMatrix(),s.copy(n.matrix),e.setMatrixAt(o,s)}),e.instanceMatrix.needsUpdate=!0,e}}const mv=[{y:13.9,r:7.3},{y:11.4,r:10.5},{y:9.2,r:19},{y:7.2,r:23},{y:5.4,r:31},{y:3.6,r:52},{y:1.8,r:62},{y:0,r:62},{y:-1.8,r:61},{y:-3.6,r:50},{y:-5.3,r:36,inner:26}];function Xs(i,t){const e=new Wt(i);return e.offsetHSL(0,0,t),e.getHex()}function Ns(i,t,e,n,s,r){const o=new N(new Pi(t,e,128),_e(r));o.rotation.x=-Math.PI/2,o.position.set(0,n,s),i.add(o)}function gv(i,t,e,n,s){const r=Mt.saucerZ,o=_n(n),a=Vs[t.role],c=1.5,l=e.y-.55;if(e.inner){const M=new N(new Pi(e.inner,e.r,128),_e(Xs(a,-.08)));M.rotation.x=-Math.PI/2,M.position.set(0,l-.1,r),i.add(M)}else{const M=new N(new Ot(e.r,e.r,.18,128),_e(Xs(a,-.08)));M.position.set(0,l-.1,r),i.add(M)}if(e.r<20){if(t.id===1){Ns(i,3,5.2,l+.05,r,ts);for(let b=0;b<10;b++){const v=b/10*Math.PI*2+.63;if(b===5)continue;const C=new N(new wt(1.4,.9,.7),Vt(7000575,.9));C.position.set(Math.sin(v)*5.3,l+.55,r+Math.cos(v)*5.3),C.lookAt(0,l+.55,r),i.add(C)}const M=new N(new wt(.9,.9,.9),_e(13214247));M.position.set(0,l+.55,r-.6),i.add(M);const _=new N(new wt(2.8,.8,.9),Vt(10475775,1.2));_.position.set(0,l+.5,r+1.6),i.add(_);const T=new N(new wt(3.8,1.8,.2),Vt(10475775,1.8));T.position.set(0,l+1.3,r+5.6),i.add(T),s.add(0,l+c/2,r-5.9,2.6,c,.2)}else{const M=t.id===2?6:8;for(let T=0;T<M;T++){const b=T/M*Math.PI*2+.2;s.add(Math.sin(b)*e.r*.6,l+c/2,r+Math.cos(b)*e.r*.6,.18,c,e.r*.7,b)}Ns(i,e.r*.25,e.r*.35,l+.05,r,ts);const _=new N(new Ot(1.3,1.3,c,16),_e(8945772));_.position.set(0,l+c/2,r-6.5),i.add(_)}return}const u=e.r,h=e.inner?e.inner+.6:u*.4,d=[h,h+2.4],f=[u*.85,u*.85+2.2];Ns(i,d[0],d[1],l+.05,r,ts),Ns(i,f[0],f[1],l+.05,r,ts);for(let M=0;M<8;M++){const _=M/8*Math.PI*2,T=f[0]-d[1],b=(f[0]+d[1])/2,v=new N(new wt(2.2,.08,T),_e(ts));v.position.set(Math.sin(_)*b,l+.05,r+Math.cos(_)*b),v.rotation.y=_,i.add(v)}const g=(M,_,T)=>{for(let b=0;b<_;b++){if(b%T===0)continue;const v=b/_*Math.PI*2,C=(b+1)/_*Math.PI*2,S=(v+C)/2,y=M*(C-v)*.92;s.add(Math.sin(S)*M,l+c/2,r+Math.cos(S)*M,y,c,.16,S)}};e.inner||g(d[0]-.1,Math.round(u*.5),5),g(d[1]+.1,Math.round(u*.55),4),g(f[0]-.1,Math.round(u),6),g(f[1]+.1,Math.round(u*1.1),5);const x=[d[1]+.2,f[0]-.2],m=[f[1]+.2,u*.985],p=(M,_)=>{for(let T=0;T<_;T++){const b=T/_*Math.PI*2+.07,v=(M[0]+M[1])/2,C=M[1]-M[0];if(s.add(Math.sin(b)*v,l+c/2,r+Math.cos(b)*v,.16,c,C,b),o()<.35){const S=M[0]+C*(.35+o()*.3),y=b+Math.PI*2/_/2;s.add(Math.sin(y)*S,l+c/2,r+Math.cos(y)*S,S*Math.PI*2/_*.9,c,.14,y)}}};p(x,Math.max(12,Math.round(u*.32))),p(m,Math.max(16,Math.round(u*.6)));const w=Math.round(u*.3);for(let M=0;M<w;M++){if(o()<.4)continue;const _=M/w*Math.PI*2+.07+Math.PI*2/w/2,T=o()<.6?x:m,b=(T[0]+T[1])/2,v=T[1]-T[0],C=b*Math.PI*2/(T===x?Math.max(12,Math.round(u*.32)):Math.max(16,Math.round(u*.6)))*.9,S=new N(new wt(C,.06,v*.92),_e(Xs(a,o()*.16-.04)));S.position.set(Math.sin(_)*b,l+.06,r+Math.cos(_)*b),S.rotation.y=_,i.add(S)}if(t.id===3)for(const M of[-4.2,4.2]){const _=new N(new Ot(.9,.9,14,16),Vt(16738874,1.2));_.rotation.x=Math.PI/2,_.position.set(M,l+.9,r+u*.8),i.add(_)}if(t.id===6)for(const M of[-8,8]){const _=new N(new wt(6,1.4,12),Vt(16747066,1.2));_.position.set(M,l+.7,r-u*.86),i.add(_)}if(t.id===7&&Ns(i,2.2,4.6,l+.08,r-4,13214247),t.id===8){const M=new N(new Ot(3.4,3.4,3,32),Vt(7000575,1.1));M.position.set(0,l+1.5,r-10),i.add(M);const _=new N(new wt(16,.1,10),_e(5937738));_.position.set(24,l+.08,r+26),i.add(_)}if(t.id===11)for(const[M,_]of[[-18,26],[18,26],[-18,-26],[18,-26]]){const T=new N(new Ot(1.6,1.6,1.2,20),Vt(16734810,1));T.position.set(M,l+.6,r+_),i.add(T)}}const ri=[];function _v(){const i=new ie;i.name="Interiors",i.visible=!1;const t=new pv;ri.length=0,ra.filter(S=>S.hull==="saucer").forEach((S,y)=>{const P=mv[y];gv(i,S,P,100+y,t);const W=ua(`DECK ${S.id}  ${S.name}`,"#d4b45a");W.position.set(-P.r*.35-12,P.y+2.2,Mt.saucerZ+P.r*.3),W.userData.deck=S.id,i.add(W),ri.push({id:S.id,name:S.name,y:P.y,z:Mt.saucerZ,r:P.r})});const n=Mt.neck,s=new R(0,(n.topYLead+n.topYTrail)/2,(n.topZ[0]+n.topZ[1])/2),r=new R(0,n.botY,(n.botZ[0]+n.botZ[1])/2);ra.filter(S=>S.hull==="dorsal").forEach((S,y)=>{const P=.25+y*.25,W=s.clone().lerp(r,P),q=_e(Vs[S.role]),V=new N(new wt(n.thick-1,.2,24),q);V.position.copy(W),i.add(V);for(const B of[-8,-3,3,8])t.add(0,W.y+.8,W.z+B,n.thick-1.2,1.5,.14);const O=ua(`DECK ${S.id}  ${S.name}`,"#d4b45a");O.position.set(-14,W.y+1.5,W.z),O.userData.deck=S.id,i.add(O),ri.push({id:S.id,name:S.name,y:W.y,z:W.z,r:20})});const a=_e(8945772),c=new N(new Ot(1.2,1.2,19,16),a);c.position.set(0,.2,Mt.saucerZ-7),i.add(c);const l=s.distanceTo(r),u=new N(new Ot(1.1,1.1,l,16),a);u.position.copy(s).lerp(r,.5),u.rotation.x=-Math.atan2(r.z-s.z,r.y-s.y),i.add(u);for(const S of[-8,8]){const y=new N(new Ot(.5,.5,l*.8,10),Vt(16756838,.9));y.position.copy(u.position).add(new R(0,0,S)),y.rotation.x=u.rotation.x,i.add(y)}const h=Mt.secondaryY,d=Mt.secSternZ+26,f=ra.filter(S=>S.hull==="secondary"),g=Mt.secondaryZ;f.forEach((S,y)=>{const P=h+12.6-y*2.9,W=P-h,q=y>=1&&y<=3,V=Vs[S.role],O=_e(Xs(V,-.08)),B=_n(300+y),Z=3;let H=null,Y=null;for(let et=Mt.secFrontZ-2;et>Mt.secSternZ+2&&!(q&&et<d);et-=Z){const ft=ev(W-.55,et-g,1.1);if(ft<1.6)continue;H===null&&(H=et+Z/2),Y=et-Z/2;const Q=new N(new wt(ft*2,.18,Z),O);if(Q.position.set(0,P-.55,et),i.add(Q),Math.round((Mt.secFrontZ-et)/Z)%2===0)for(const nt of[-1,1])B()<.2||t.add(nt*(1.3+(ft-1.3)/2),P+.3,et-Z/2,ft-1.3,1.5,.14);if(B()<.35){const nt=B()<.5?-1:1,gt=new N(new wt(ft-1.6,.05,Z*.9),_e(Xs(V,B()*.14-.03)));gt.position.set(nt*(1.3+(ft-1.3)/2),P-.44,et),i.add(gt)}}if(H===null)return;const vt=new N(new wt(2.4,.06,H-Y-1),_e(ts));vt.position.set(0,P-.42,(H+Y)/2),i.add(vt);for(const et of[-1,1])t.add(et*1.3,P+.3,(H+Y)/2,.14,1.5,H-Y-1);const X=ua(`DECK ${S.id}  ${S.name}`,"#d4b45a");X.position.set(-18,P+1.1,H-14-y%3*12),X.userData.deck=S.id,i.add(X),ri.push({id:S.id,name:S.name,y:P,z:(H+Y)/2,r:55})});const x=h+Mt.hangarLift,m=new ie,p=new N(new wt(2.6,2.1,7.2),_e(14474452));m.add(p);for(const S of[-1.9,1.9]){const y=new N(new Ot(.55,.55,6.4,16),_e(13225156));y.rotation.x=Math.PI/2,y.position.set(S,-.6,.2),m.add(y)}m.position.set(-2.4,x-9,d+2),m.rotation.y=Math.PI,i.add(m);const w=Mt.pylon.rootZ+6,M=new N(new Ot(1.8,1.8,20,24),Vt(8050687,3));M.position.set(0,h-1,w),i.add(M);for(let S=0;S<5;S++){const y=new N(new Pe(3,.3,10,32),Vt(16747050,2));y.rotation.x=Math.PI/2,y.position.set(0,h-8+S*3.4,w),i.add(y)}const _=Mt.secFrontZ-8-w,T=new N(new Ot(1,1,_,20),Vt(16756838,1.6));T.rotation.x=Math.PI/2,T.position.set(0,h+3.5,w+_/2),i.add(T);const b=new N(new wt(3.2,1.2,3.2),Vt(16734880,1.6));b.position.set(0,h+4.8,w+8),i.add(b);const v=new N(new Ot(3.6,5.6,9,32),_e(Vs.engineering));v.rotation.x=Math.PI/2,v.position.set(0,h-.3,Mt.secFrontZ-6),i.add(v);for(let S=0;S<6;S++){const y=new N(new ee(1.4,20,14),_e(9067162));y.position.set(-4.2+S%3*4.2,h-10.2,8-Math.floor(S/3)*5),i.add(y)}const C=new N(new Ot(3.2,5.4,6.5,24),_e(Vs.science));return C.position.set(0,-10.2,Mt.saucerZ),i.add(C),i.add(t.build()),i.userData.setLabels=(S,y=null)=>{i.traverse(P=>{P.userData.kind==="label"&&(P.visible=S&&(y===null||P.userData.deck===y))})},i.userData.setLabels(!1),ri.sort((S,y)=>S.id-y.id),i}function xv(){const i=new ie;i.name="Effects";const t=Mt.saucerZ,e=[new R(18,-5.6,t+26),new R(-18,-5.6,t+26)],n=new R(0,4.6,t+62.5),s=new R(0,-30,760),r=oc(9427199,1.6),o=new hn({color:16777215,blending:ve,transparent:!0,opacity:.9,depthWrite:!1}),a=ui("rgba(160,220,255,1)"),c=ui("rgba(255,120,60,1)"),l=[];function u(w,M,_,T){const b=w.distanceTo(M),v=new N(new Ot(_,_*.6,b,12,1,!0),T);return v.position.copy(w).lerp(M,.5),v.lookAt(M),v.rotateX(Math.PI/2),v}function h(w=s){i.userData.onImpact?.(w,"phaser");const M=new ie;for(const T of e){M.add(u(T,w,.55,r)),M.add(u(T,w,.18,o));const b=new tn(new je({map:a,blending:ve,depthWrite:!1,transparent:!0}));b.position.copy(T),b.scale.setScalar(6),M.add(b)}const _=new tn(new je({map:a,blending:ve,depthWrite:!1,transparent:!0}));_.position.copy(w),_.scale.setScalar(26),M.add(_),i.add(M),l.push({kind:"phaser",group:M,t:0,dur:1.7})}function d(w=s){const M=new ie,_=new N(new ee(1.4,16,12),new hn({color:16765088,blending:ve,transparent:!0,depthWrite:!1})),T=new tn(new je({map:c,blending:ve,depthWrite:!1,transparent:!0}));T.scale.setScalar(14),_.add(T);const b=new tn(new je({map:c,blending:ve,depthWrite:!1,transparent:!0,opacity:.5}));b.scale.set(6,6,1),M.add(_,b);const v=new tn(new je({map:c,blending:ve,depthWrite:!1,transparent:!0}));v.position.copy(n),v.scale.setScalar(10),M.add(v),i.add(M),l.push({kind:"torpedo",group:M,ball:_,tail:b,muzzle:v,from:n.clone(),to:w.clone(),t:0,dur:3.2,speed:1,hit:!1})}function f(w){for(let M=l.length-1;M>=0;M--){const _=l[M];_.t+=w;const T=_.t/_.dur;if(_.kind==="phaser"){const b=.75+Math.random()*.5,v=T<.15?T/.15:T>.75?1-(T-.75)/.25:1;_.group.traverse(C=>{C.isSprite?C.material.opacity=v*b:C.isMesh&&C.scale.set(b*v,1,b*v)})}else{const b=Math.min(1,T*T*.4+T*.6);if(_.ball.position.lerpVectors(_.from,_.to,b),_.tail.position.copy(_.ball.position).lerp(_.from,.06),_.tail.material.opacity=.5*(1-T),_.muzzle.material.opacity=Math.max(0,1-T*6),_.muzzle.scale.setScalar(10+T*40),T>.92){_.hit||(_.hit=!0,i.userData.onImpact?.(_.to,"torpedo"));const v=1+(T-.92)*40;_.ball.children[0].scale.setScalar(14*v),_.ball.children[0].material.opacity=1-(T-.92)/.08}}T>=1&&(i.remove(_.group),_.group.traverse(b=>{b.geometry&&b.geometry.dispose(),b.material&&b.material!==r&&b.material!==o&&b.material.dispose()}),l.splice(M,1))}}const g=new N(new ee(1,40,24),oc(10473727,0));g.scale.set(140,62,165),g.position.set(0,-14,0),g.material.transparent=!0,g.material.depthWrite=!1,i.add(g);let x=0;const m=f;function p(w){m(w),x=Math.max(0,x-w*1.6),g.material.uniforms.uIntensity.value=x*x*.9}return i.userData={firePhasers:h,fireTorpedo:d,animate:p,shieldHit(){x=1},onImpact:null,get busy(){return l.length>0}},i}function vv({bridgeDoor:i,engineeringDoor:t}){const e=new ie;e.name="Turbolift";const n=(C,S=.04)=>{const y=_e(C);return y.emissiveIntensity=S,y.envMapIntensity=.1,y.roughness=.85,y},s=n(9407622,.05),r=n(9315878,.08),o=n(1382427,.02),a=2.4,c=2.6,l=2.4,u=new ie;u.name="TurboliftCar";const h=new N(new Gt(a,l),n(3816512,.03));h.rotation.x=-Math.PI/2,u.add(h);const d=new N(new Gt(a,l),s);d.rotation.x=Math.PI/2,d.position.y=c,u.add(d);const f=new N(new Gt(a-.6,l-.6),Vt(16773596,1.6));f.rotation.x=Math.PI/2,f.position.y=c-.02,f.userData.kind="glow",u.add(f);for(const C of[-1,1]){const S=new N(new Gt(l,c),s);S.rotation.y=-C*Math.PI/2,S.position.set(C*a/2,c/2,0),u.add(S);const y=new N(new Ot(.05,.05,.36,10),o);y.position.set(C*(a/2-.12),1.35,.5),u.add(y);const P=new N(new wt(.04,.25,l-.2),r);P.position.set(C*(a/2-.03),1.75,0),u.add(P)}const g=new N(new Gt(.6,.18),Vt(8257434,1.2));g.rotation.y=-Math.PI/2,g.position.set(a/2-.04,2.15,-.6),g.userData.kind="glow",u.add(g);const x=new Tn(16771536,4,6,1.6);x.position.set(0,c-.3,0),u.add(x);const m={front:[],back:[]};for(const[C,S,y]of[[1,l/2,"front"],[-1,-l/2,"back"]]){for(const W of[-1,1]){const q=new N(new wt(a/2,c,.08),r);q.position.set(W*a/4,c/2,S),q.userData.homeX=W*a/4,q.userData.side=W,u.add(q),m[y].push(q)}const P=new N(new wt(a+.3,.2,.2),o);P.position.set(0,c+.05,S),u.add(P)}e.add(u);const p=new R(0,Mt.cDeckTop+.1,Mt.saucerZ-7.7-l/2-.4),w=new R(t.x,t.y,t.z+l/2+.5),M=new gs([p,new R(0,4,Mt.saucerZ-8.6),new R(0,-3,Mt.saucerZ-9),new R(0,-6.5,50),new R(0,-14.5,36),new R(0,-22.5,22),new R(0,-27.5,8),new R(t.x*.5,-30.5,w.z+6),w],!1,"centripetal");let _=0,T=0;const b=C=>C*C*(3-2*C);function v(){const C=M.getPoint(_);u.position.copy(C);const S=_<.02,y=_>.98,P=b(Math.min(1,Math.max(0,T)));for(const W of m.front)W.position.x=W.userData.homeX+W.userData.side*(a/2)*(S?P:0);for(const W of m.back)W.position.x=W.userData.homeX+W.userData.side*(a/2)*(y?P:0);i?.(S?P:0),t.set?.(y?P:0),g.material.emissiveIntensity=.6+Math.sin(_*Math.PI*24)*.5}return v(),e.userData={car:u,path:M,setProgress(C){_=Math.min(1,Math.max(0,C)),v()},setDoors(C){T=C,v()},cameraAt(C){return M.getPoint(Math.min(1,Math.max(0,C))).add(new R(0,1.55,0))},lookAt(C){const S=Math.min(1,Math.max(0,C)),y=M.getPoint(S),P=Math.PI*Math.min(1,Math.max(0,(S-.1)/.8));return y.add(new R(Math.sin(P)*6,1.5,Math.cos(P)*6))}},e}function yv(i){const t=document.createElement("canvas");t.width=512,t.height=96;const e=t.getContext("2d");e.fillStyle="rgba(6,8,12,0.55)",e.fillRect(6,18,500,60),e.strokeStyle="#d4b45a",e.lineWidth=2,e.strokeRect(6,18,500,60),e.fillStyle="#e8eef4",e.font="26px Michroma, 'Share Tech Mono', monospace",e.textAlign="center",e.textBaseline="middle",e.fillText(i,256,48);const n=new xn(t),s=new tn(new je({map:n,transparent:!0,depthTest:!1}));return s.scale.set(34,6.4,1),s.visible=!1,s.userData.kind="partlabel",s}function Mv(){const i=new ie;i.name="USSEnterprise";const t=Qx(),e=lv(),n=uv(),s=_u(-1),r=_u(1),o=dv(),a=_v(),c=xv(),l=t.getObjectByName("BridgeInterior"),u=e.userData.engineering,h=u.userData.door,d=new R(h.x,h.y,h.z).add(e.position),f=vv({bridgeDoor:X=>l?.userData.setDoor?.(X),engineeringDoor:{x:d.x,y:d.y,z:d.z,set:X=>u.userData.setDoor?.(X)}});i.add(t,e,n,s,r,o,a,c,f);const g=[t,e,n,s,r,...o.children],x=[[t,"Primary hull · 11 decks",new R(0,30,0)],[e,"Engineering hull · decks 15–23",new R(0,-24,0)],[n,"Interconnecting dorsal",new R(0,-14,36)],[s,"Port pylon",new R(-24,-6,-33)],[r,"Starboard pylon",new R(24,-6,-33)],[o.children[0],"Port warp nacelle",new R(0,16,0)],[o.children[1],"Starboard warp nacelle",new R(0,16,0)]].map(([X,et,ft])=>{const Q=yv(et);return Q.position.copy(ft),X.add(Q),Q}),m=new Rn(new R(-1,0,0),0),p=new Rn(new R(0,-1,0),0),w=new Set;a.traverse(X=>{(X.isMesh||X.isInstancedMesh)&&X.material&&!X.isSprite&&w.add(X.material)});const M=new Set;i.traverse(X=>{if(!X.isMesh||X.isSprite)return;let et=!1,ft=X.parent;for(;ft;)(ft===a||ft===c||ft===f)&&(et=!0),ft=ft.parent;et||M.add(X.material)});const _=[],T=[],b=[],v=[];i.traverse(X=>{X.userData.blinkers&&_.push(...X.userData.blinkers),X.userData.fan&&T.push({fan:X.userData.fan,dir:X.userData.fanDir}),X.userData.warpStrip&&b.push(X.userData.warpStrip),X.userData.kind==="bussard"&&v.push(X.material)});let C=0,S=0;const y=new Set,P=[],W=[];i.traverse(X=>{X.userData.kind==="window"&&X.material&&y.add(X.material),X.userData.kind==="alertlight"&&P.push(X),X.userData.kind==="alertring"&&W.push(X)});const q=new Map([...y].map(X=>[X,{color:X.emissive.getHex(),intensity:X.emissiveIntensity}]));let V=0,O=0;const B=new Wt(16724e3),Z=new po({color:13939802,transparent:!0,opacity:.85}),H=[],Y=[];i.traverse(X=>{if(!X.isMesh||X.isSprite||X.isInstancedMesh)return;let et=X.parent,ft=!1;for(;et;)(et===a||et===c||et===f)&&(ft=!0),et=et.parent;if(ft)return;if(X.userData.kind==="window"||X.userData.kind==="glow"||X.userData.kind==="decal"||X.userData.kind==="warpstrip"||X.userData.kind==="partlabel"){Y.push(X);return}if((X.geometry.attributes.position?.count||0)<400)return;const nt=new e_(X.geometry,18),gt=new Mc(nt,Z);gt.position.copy(X.position),gt.rotation.copy(X.rotation),gt.scale.copy(X.scale),gt.visible=!1,gt.userData.kind="edges",X.parent.add(gt),H.push(gt)});const vt=new Map;return i.userData={interiors:a,parts:g,saucer:t,secondary:e,nacelles:o,clipPlane:m,cutaway:!1,setExplode(X){const et=Math.min(1,Math.max(0,X));for(const ft of g){const Q=ft.userData.home,nt=ft.userData.explode;!Q||!nt||ft.position.set(Q.x+nt.x*et,Q.y+nt.y*et,Q.z+nt.z*et)}for(const ft of x)ft.visible=et>.3},setCutaway(X,et=.5){i.userData.cutaway=X,a.visible=X||a.visible,m.constant=-75+150*et;for(const ft of M)ft.clippingPlanes=X?[m]:null,ft.clipShadows=X,ft.needsUpdate=!0;Z.clippingPlanes=X?[m]:null,Z.needsUpdate=!0,X||(a.visible=!1)},setClip(X){m.constant=-75+150*X},setDeckCut(X,et=0,ft=null){i.userData.deckCut=X,p.constant=et;for(const Q of M)Q.clippingPlanes=X?[p]:i.userData.cutaway?[m]:null,Q.clipShadows=X||i.userData.cutaway,Q.needsUpdate=!0;for(const Q of w)Q.clippingPlanes=X?[p]:null,Q.needsUpdate=!0;Z.clippingPlanes=X?[p]:i.userData.cutaway?[m]:null,Z.needsUpdate=!0,a.visible=X||i.userData.cutaway,a.userData.setLabels(X,ft)},setWarp(X){S=X?1:0},setAlert(X){O=X?1:0},get alert(){return O>.5},hangar:e.userData.hangar.userData,effects:c.userData,turbolift:f.userData,setHangar(X){e.userData.hangar.userData.setOpen(X)},launchShuttle(){e.userData.hangar.userData.launch()},launchShuttleTo(X,et,ft){const Q=e.userData.hangar;Q.updateWorldMatrix(!0,!1);const nt=Q.worldToLocal(X.clone());Q.userData.launchTo(nt,et,ft)},recallShuttle(){e.userData.hangar.userData.recall()},setBlueprint(X){for(const et of H)et.visible=X;for(const et of Y)et.visible=!X&&!(i.userData.cutaway&&(et.userData.kind==="window"||et.userData.kind==="decal"));for(const et of M){if(X)vt.has(et)||vt.set(et,{color:et.color.getHex(),transparent:et.transparent,opacity:et.opacity,map:et.map,roughness:et.roughness,metalness:et.metalness,emissive:et.emissive?et.emissive.getHex():null,emissiveIntensity:et.emissiveIntensity,depthWrite:et.depthWrite}),et.color.set(2375774),et.map=null,et.transparent=!0,et.opacity=.32,et.roughness=1,et.metalness=0,et.depthWrite=!1,et.emissive&&(et.emissive.set(793132),et.emissiveIntensity=1);else if(vt.has(et)){const ft=vt.get(et);et.color.set(ft.color),et.map=ft.map,et.transparent=ft.transparent,et.opacity=ft.opacity,et.roughness=ft.roughness,et.metalness=ft.metalness,et.depthWrite=ft.depthWrite,et.emissive&&ft.emissive!==null&&(et.emissive.set(ft.emissive),et.emissiveIntensity=ft.emissiveIntensity)}et.needsUpdate=!0}},animate(X,et){e.userData.hangar.userData.animate(et),c.userData.animate(et),C+=(S-C)*Math.min(1,et*1.8);for(const ft of T)ft.fan.rotation.z+=et*(2.2+C*9)*ft.dir;for(const ft of b)ft.emissiveIntensity=.35+C*4.2;for(const ft of v)ft.emissiveIntensity=.9+C*2.6;if(V+=(O-V)*Math.min(1,et*2.5),V>.002||O>0){const ft=.5+.5*Math.sin(X*7);for(const Q of P)Q.material.emissive.setHex(V>.3?16719904:16757575),Q.material.emissiveIntensity=.25+V*(1.2+ft*3.2);for(const Q of W)Q.material.emissive.setRGB(1,1-V*.8,1-V*.85),Q.material.emissiveIntensity=1.3-V*.5+V*ft*.8;for(const[Q,nt]of q)Q.emissive.setHex(nt.color).lerp(B,V*.85),Q.emissiveIntensity=nt.intensity*(1-V*.35)+V*ft*1.6}Xx(i,V,et);for(const ft of _){const Q=(X/ft.period+ft.phase)%1,nt=Q<.08||Q>.16&&Q<.22;ft.mesh.scale.setScalar(nt?1.8:.6),ft.mat.emissiveIntensity=nt?9:.6}}},i.userData.setCutaway(!1),i}function Sv(){const t=document.createElement("canvas");t.width=1024,t.height=1024/2;const e=t.getContext("2d"),n=_n(404);e.fillStyle="#123a6b",e.fillRect(0,0,1024,1024/2);for(let o=0;o<90;o++){const a=n()*1024,c=n()*(1024/2),l=20+n()*110,u=e.createRadialGradient(a,c,0,a,c,l),h=n()<.6;u.addColorStop(0,h?"rgba(86,120,62,0.95)":"rgba(160,120,70,0.9)"),u.addColorStop(.7,h?"rgba(70,100,52,0.6)":"rgba(130,100,60,0.5)"),u.addColorStop(1,"rgba(0,0,0,0)"),e.fillStyle=u,e.fillRect(a-l,c-l,l*2,l*2)}for(let o=0;o<120;o++){const a=n()*1024,c=n()*(1024/2),l=40+n()*200,u=6+n()*22;e.fillStyle=`rgba(255,255,255,${.08+n()*.2})`,e.beginPath(),e.ellipse(a,c,l,u,n()*.6-.3,0,Math.PI*2),e.fill()}const s=e.createLinearGradient(0,0,0,1024/2);s.addColorStop(0,"rgba(255,255,255,0.85)"),s.addColorStop(.12,"rgba(255,255,255,0)"),s.addColorStop(.88,"rgba(255,255,255,0)"),s.addColorStop(1,"rgba(255,255,255,0.85)"),e.fillStyle=s,e.fillRect(0,0,1024,1024/2);const r=new xn(t);return r.colorSpace=be,r}function wv(){const i=new ie;i.name="Space";const t=7e3,e=new Float32Array(t*3),n=new Float32Array(t*3),s=new Wt,r=_n(9);for(let v=0;v<t;v++){const C=1400+r()*3200,S=r()*Math.PI*2,y=Math.acos(2*r()-1);e[v*3]=C*Math.sin(y)*Math.cos(S),e[v*3+1]=C*Math.sin(y)*Math.sin(S),e[v*3+2]=C*Math.cos(y);const P=r();s.setHSL(.55+P*.12,.2,.7+r()*.3),n[v*3]=s.r,n[v*3+1]=s.g,n[v*3+2]=s.b}const o=new Se;o.setAttribute("position",new $t(e,3)),o.setAttribute("color",new $t(n,3));const a=new Hg(o,new oh({size:2.2,vertexColors:!0,transparent:!0,opacity:.9,depthWrite:!1,blending:ve,sizeAttenuation:!0}));a.name="Stars",i.add(a);const c=new tn(new je({map:ui("rgba(70,110,160,0.5)"),blending:ve,depthWrite:!1,opacity:.28}));c.scale.set(2400,1100,1),c.position.set(-900,300,-2400),i.add(c);const l=new tn(new je({map:ui("rgba(150,80,120,0.4)"),blending:ve,depthWrite:!1,opacity:.18}));l.scale.set(1800,900,1),l.position.set(1600,-500,-2e3),i.add(l);const u=new R(2500,-1e3,-3300),h=new R(4700,4400,-1800),d=h.clone().sub(u).normalize(),f=900,g=new Oe({uniforms:{map:{value:Sv()},sunDir:{value:d},atmoColor:{value:new Wt(5939455)}},vertexShader:`
      varying vec3 vN;
      varying vec3 vW;
      varying vec2 vUv;
      void main() {
    ...
    `}),x=new N(new ee(f,96,64),g);x.position.copy(u),x.rotation.z=.35,x.name="Planet",i.add(x);const m=new N(new ee(f*1.028,96,64),new Oe({uniforms:{sunDir:{value:d},atmoColor:{value:new Wt(6992127)}},transparent:!0,depthWrite:!1,blending:ve,vertexShader:`
      ...
      `}));m.position.copy(u),i.add(m);const p=new tn(new je({map:ui("rgba(255,240,215,1)"),blending:ve,depthWrite:!1,opacity:.95}));p.scale.set(520,520,1),p.position.copy(h),i.add(p);const w=900,M=new Float32Array(w*6),_=_n(1701);for(let v=0;v<w;v++){const C=_()*Math.PI*2,S=120+_()*700,y=Math.cos(C)*S,P=Math.sin(C)*S*.7,W=-1600+_()*3200,q=40+_()*220;M.set([y,P,W,y,P,W-q],v*6)}const T=new Se;T.setAttribute("position",new $t(M,3));const b=new Mc(T,new po({color:12573183,transparent:!0,opacity:0,blending:ve,depthWrite:!1}));return b.name="WarpField",b.visible=!1,i.add(b),i.userData={stars:a,warp:b,planet:x,atmo:m,sun:p,nebula:[c,l],setWarp(v){b.visible=v,i.userData.warpOn=v},animate(v){x.rotation.y+=v*.004;const C=i.userData.warpOn?.85:0;b.material.opacity+=(C-b.material.opacity)*Math.min(1,v*2.5);const S=i.userData.warpOn?.25:.9;if(a.material.opacity+=(S-a.material.opacity)*Math.min(1,v*2.5),b.visible){const y=b.geometry.attributes.position,P=2400*v;for(let W=0;W<y.count;W+=2){let q=y.getZ(W)-P,V=y.getZ(W+1)-P;if(q<-1600){const O=q-V;q+=3200,V=q-O}y.setZ(W,q),y.setZ(W+1,V)}y.needsUpdate=!0}!b.visible&&b.material.opacity<.01&&(b.visible=!1)}},i.userData.warpOn=!1,i}const zr=Mt.saucerZ,ha=Mt.secondaryY,bv=[{id:"bridge",name:"Main Bridge · Deck 1",pos:[0,Mt.bridgeTop-1.5,zr],view:{dir:[.5,.55,.7],dist:60},facts:["Command well with helm/navigation console","Rotated 36° from centerline on the studio set","Turbolift alcove aft, viewer forward","Use the Bridge interior camera to step inside"],body:"The bridge dome tops the stepped B/C deck superstructure. Cushman's cutaway keeps the set's 36° rotation and solves the turbolift by running the shaft down the aft housing. This reconstruction faces the set forward, as Botaitis argues the dome geometry allows."},{id:"impulse",name:"Impulse Engines · Decks 6–7",pos:[0,4.4,zr-56],view:{dir:[.4,.5,-.8],dist:70},facts:["Fusion reactors forward of the housing","Twin exhaust vents aft","Independent saucer propulsion"],body:"The low shelf at the saucer's aft edge is the only external sign of the impulse drive; the reactors and power units sit two decks deep behind it."},{id:"sensor",name:"Lower Sensor Dome · Deck 11",pos:[0,Mt.lowerDomeBottom-.6,zr],view:{dir:[.4,-.85,.5],dist:60},facts:["Planetary sensor array","Auxiliary fire control above","Forward phaser banks flank it"],body:"The dome and its three pods are the ship's primary planetary scanners. Fire control for the saucer phasers shares the deck above."},{id:"deflector",name:"Navigational Deflector",pos:[0,ha,Mt.secFrontZ+6],view:{dir:[.75,-.3,.75],dist:70},facts:["Copper parabolic dish on a central emitter spike","Sweeps debris ahead at warp","Machinery spans decks 15–20 behind it"],body:"The dish was recolored copper for the production model. Its machinery fills the truncated forward face of the engineering hull."},{id:"engineering",name:"Main Engineering · Deck 16",pos:[0,ha+4,Mt.pylon.rootZ+6],view:{dir:[.9,.2,.3],dist:80},facts:["Matter/antimatter reactor core","Intermix conduit runs forward to the dish","Dilithium crystal converter assembly","Use the Engineering interior camera to step inside"],body:"The engine room set's grille-covered 'cathedral' is read here as the vertical reactor with the horizontal intermix trunk feeding the warp plasma system."},{id:"hangar",name:"Hangar Deck · Decks 17–19",pos:[0,ha+Mt.hangarLift,Mt.secSternZ-1.5],view:{dir:[.55,.25,-.8],dist:80},facts:["Clamshell doors on the fantail","Observation gallery over the flight deck","Turntable elevator to the lower hangar"],body:"The flight deck is one of the largest open volumes on the ship. Shuttles are stored on the deck below and raised through the turntable."},{id:"bussard",name:"Bussard Collectors",pos:[Mt.nacelleX,Mt.nacelleY,Mt.nacelleZ+Mt.nacelleL*.5-4],view:{dir:[.7,.4,.6],dist:55},facts:["Spinning fan-blade light effect on the 11-footer","Added for the second pilot","Interstellar hydrogen intake"],body:"The domes were lit with rotating color wheels and mirror fans, which is why they shimmer. This model spins the blades inside a translucent shell."},{id:"nacelle",name:"Warp Nacelles",pos:[-41.5,Mt.nacelleY,Mt.nacelleZ-40],view:{dir:[-.8,.45,-.4],dist:70},facts:["154 m long, 15 m diameter","Aft grilles and ball-and-ring end caps","Pylons meet them at the forward third, unswept"],body:"Warp coils run the length of each nacelle. The vertical grilles near the aft end are the plasma vents; the end cap houses the field coil terminus."},{id:"torpedo",name:"Photon Torpedo Bay · Deck 3",pos:[0,5.8,zr+30],view:{dir:[.4,.6,.7],dist:60},facts:["Forward-firing launchers","Magazine on the deck above","Fires from the saucer's leading edge"],body:"Photon torpedoes launch from tubes just under the saucer's upper skin. The bay shares Deck 3 with the physics and botany labs."}];function Ev(){const t=document.createElement("canvas");t.width=t.height=128;const e=t.getContext("2d");e.strokeStyle="rgba(212,180,90,0.95)",e.lineWidth=6,e.beginPath(),e.arc(128/2,128/2,44,0,Math.PI*2),e.stroke(),e.fillStyle="rgba(212,180,90,0.9)",e.beginPath(),e.arc(128/2,128/2,10,0,Math.PI*2),e.fill();const n=new xn(t);return n.colorSpace=be,n}function Tv(i,t){const e=new ie;e.name="Hotspots";const n=Ev(),s=new ee(6,12,8),r=new hn({visible:!1}),o=[];for(const d of bv){const f=new N(s,r);f.position.set(...d.pos),f.userData.system=d,e.add(f);const g=new tn(new je({map:n,transparent:!0,depthTest:!1,opacity:.85}));g.position.copy(f.position),g.scale.set(5,5,1),g.userData.kind="marker",e.add(g),o.push({sys:d,hit:f,sprite:g})}const a=new F_,c=new dt,l=new dt;let u=0;const h={group:e,onSelect:null,selected:null,visible:!0,setVisible(d){h.visible=d;for(const f of o)f.sprite.visible=d},animate(d,f){const g=1+Math.sin(d*3)*.12;for(const x of o){const m=f.isOrthographicCamera?1e3/f.zoom:f.position.distanceTo(x.hit.position),p=Math.max(2.5,m*.012)*g*(h.selected===x.sys?1.6:1);x.sprite.scale.set(p,p,1),x.sprite.material.opacity=h.selected===x.sys?1:.7}},pick(d,f){const g=t.getBoundingClientRect();c.set((d-g.left)/g.width*2-1,-((f-g.top)/g.height)*2+1),a.setFromCamera(c,i());const x=a.intersectObjects(o.map(m=>m.hit),!1);return x.length?x[0].object.userData.system:null}};return t.addEventListener("pointerdown",d=>{l.set(d.clientX,d.clientY),u=performance.now()}),t.addEventListener("pointerup",d=>{if(!h.visible||Math.hypot(d.clientX-l.x,d.clientY-l.y)>5||performance.now()-u>400)return;const g=h.pick(d.clientX,d.clientY);g&&(h.selected=g,h.onSelect?.(g))}),t.addEventListener("pointermove",d=>{if(!h.visible)return;const f=h.pick(d.clientX,d.clientY);t.style.cursor=f?"pointer":""}),h}function Av(i,t){const e=new ie;e.name="Reference";const n=new hn({transparent:!0,opacity:.55,side:Re,depthWrite:!1,toneMapped:!1}),s=new N(new Gt(1,1),n);s.visible=!1,s.renderOrder=-1,e.add(s);const r={width:300,aspect:1,dx:0,dy:0,has:!1,rot:0};function o(){if(!r.has)return;const u=i().position.clone().sub(t.target).normalize(),h=Math.abs(u.x),d=Math.abs(u.y),f=Math.abs(u.z),g=r.width,x=g/r.aspect;s.scale.set(g,x,1);const m={x:0,y:0,z:0};h>=d&&h>=f?(s.rotation.set(0,Math.sign(u.x)*Math.PI/2,0),s.position.set(-Math.sign(u.x)*120,m.y+r.dy,m.z+r.dx*-Math.sign(u.x))):d>=h&&d>=f?(s.rotation.set(-Math.sign(u.y)*Math.PI/2,0,0),s.position.set(m.x+r.dx,-Math.sign(u.y)*120,m.z+r.dy*Math.sign(u.y))):(s.rotation.set(0,u.z>0?0:Math.PI,0),s.position.set(m.x+r.dx*Math.sign(u.z),m.y+r.dy,-Math.sign(u.z)*260)),r.rot&&s.rotateZ(r.rot)}function a(l){const u=new Ve(l);u.colorSpace=be,u.needsUpdate=!0,n.map&&n.map.dispose(),n.map=u,n.needsUpdate=!0,r.aspect=l.width/l.height,r.has=!0,s.visible=!0,o()}addEventListener("dragover",l=>{l.preventDefault()}),addEventListener("drop",l=>{l.preventDefault();const u=l.dataTransfer?.files?.[0];if(!u||!u.type.startsWith("image/"))return;const h=URL.createObjectURL(u),d=new Image;d.onload=()=>{a(d),URL.revokeObjectURL(h),c.onLoad?.(u.name)},d.src=h});const c={group:e,onLoad:null,loadFromURL(l,u="reference"){return new Promise((h,d)=>{const f=new Image;f.crossOrigin="anonymous",f.onload=()=>{a(f),c.onLoad?.(u),h(f)},f.onerror=d,f.src=l})},setOpacity(l){n.opacity=l},setWidth(l){r.width=l,o()},setOffset(l,u){r.dx=l,r.dy=u,o()},rotate(){r.rot=(r.rot+Math.PI/2)%(Math.PI*2),o()},setFlip(l,u){n.map&&(n.map.repeat.set(l?-1:1,u?-1:1),n.map.offset.set(l?1:0,u?1:0),n.map.needsUpdate=!0)},clear(){r.has=!1,s.visible=!1},update:o,get active(){return r.has}};return c}const Cv={BASE_URL:"/enterprise/",DEV:!1,MODE:"production",PROD:!0,SSR:!1,VITE_BASE:"/enterprise/"};function Rv(){let i=null,t=null,e=null,n=null,s=!1,r=null,o=!0;const a=Cv&&"/enterprise/"||"/",c=new Map;let l=null,u=null,h=!1;function d(){return u||(u=(async()=>{try{const L=await fetch(`${a}audio/manifest.json`);if(!L.ok)return;l=await L.json();const U=Object.entries(l.sounds||{});await Promise.all(U.map(async([G,k])=>{try{const j=await fetch(`${a}audio/${k.file}`);if(!j.ok)return;const D=await j.arrayBuffer();c.set(G,await i.decodeAudioData(D))}catch{}})),h=c.size>0,h&&s&&(x(),B&&gt(B.mood))}catch{}})(),u)}const f=L=>o&&c.has(L);function g(L,{gain:U=1,rate:G=1,loop:k=!1,fadeIn:j=0,offset:D=0,when:mt=0,dest:rt=null}={}){const xt=c.get(L);if(!xt)return null;const ct=i.createBufferSource();ct.buffer=xt,ct.loop=k,ct.playbackRate.value=G;const Et=i.createGain(),z=i.currentTime+mt;return j>0?(Et.gain.setValueAtTime(1e-4,z),Et.gain.exponentialRampToValueAtTime(Math.max(1e-4,U),z+j)):Et.gain.value=U,ct.connect(Et),Et.connect(rt||t),ct.start(z,D),{src:ct,g:Et,stop(A=.05){const E=i.currentTime;Et.gain.cancelScheduledValues(E),Et.gain.setValueAtTime(Math.max(1e-4,Et.gain.value),E),Et.gain.exponentialRampToValueAtTime(1e-4,E+A);try{ct.stop(E+A+.05)}catch{}}}}function x(){!e||e.sample||!f("engineLow")||(e.sample=g("engineLow",{gain:.42,loop:!0,fadeIn:2}),e.g.gain.linearRampToValueAtTime(.07,i.currentTime+2))}function m(){if(i)return i;i=new(window.AudioContext||window.webkitAudioContext),t=i.createGain(),t.gain.value=0;const L=i.createDynamicsCompressor();return L.threshold.value=-18,L.ratio.value=4,t.connect(L),L.connect(i.destination),n=i.createMediaStreamDestination(),L.connect(n),i}function p(L=2){const U=i.createBuffer(1,i.sampleRate*L,i.sampleRate),G=U.getChannelData(0);for(let k=0;k<G.length;k++)G[k]=Math.random()*2-1;return U}function w(){if(e)return;const L=i.createGain();L.gain.value=.16;const U=i.createBiquadFilter();U.type="lowpass",U.frequency.value=180,U.Q.value=.7;const G=[[55,"sine",1],[82.5,"triangle",.35],[110.5,"sine",.18]].map(([D,mt,rt])=>{const xt=i.createOscillator();xt.type=mt,xt.frequency.value=D;const ct=i.createGain();return ct.gain.value=rt,xt.connect(ct),ct.connect(U),xt.start(),xt}),k=i.createOscillator();k.frequency.value=.18;const j=i.createGain();j.gain.value=.05,k.connect(j),j.connect(L.gain),k.start(),U.connect(L),L.connect(t),e={oscs:G,g:L,lp:U}}function M(L){if(s=L,!L){t&&t.gain.linearRampToValueAtTime(0,i.currentTime+.4),W&&q(!1),B&&Y(.5),Q(.5);return}m(),i.state==="suspended"&&i.resume(),w(),d(),h&&x(),t.gain.cancelScheduledValues(i.currentTime),t.gain.linearRampToValueAtTime(.8,i.currentTime+.6)}function _(L,U,G,k,j,D=i.currentTime){L.gain.cancelScheduledValues(D),L.gain.setValueAtTime(1e-4,D),L.gain.exponentialRampToValueAtTime(U,D+G),L.gain.setValueAtTime(U,D+G+k),L.gain.exponentialRampToValueAtTime(1e-4,D+G+k+j)}function T(){if(s){if(f("laserLarge")){g("laserLarge",{gain:.55,rate:.72}),g("laserLarge",{gain:.45,rate:.68,when:.14}),g("laserRetro",{gain:.2,rate:.85,when:.05});return}b()}}function b(){const L=i.currentTime,U=i.createGain();_(U,.35,.03,1.1,.45,L);const G=i.createOscillator();G.type="sawtooth",G.frequency.setValueAtTime(760,L),G.frequency.linearRampToValueAtTime(880,L+1.4);const k=i.createOscillator();k.frequency.value=28;const j=i.createGain();j.gain.value=60,k.connect(j),j.connect(G.frequency);const D=i.createBiquadFilter();D.type="bandpass",D.frequency.value=1400,D.Q.value=1.5,G.connect(D),D.connect(U),U.connect(t),G.start(L),k.start(L),G.stop(L+1.7),k.stop(L+1.7)}function v(){if(s){if(f("laserLarge2")){g("explosionLow",{gain:.5,rate:.9}),g("laserLarge2",{gain:.6,rate:.5,when:.04});return}C()}}function C(){const L=i.currentTime,U=i.createGain();_(U,.55,.02,.25,1.6,L);const G=i.createOscillator();G.type="sine",G.frequency.setValueAtTime(220,L),G.frequency.exponentialRampToValueAtTime(48,L+1.8),G.connect(U);const k=i.createBufferSource();k.buffer=p(2);const j=i.createGain();_(j,.25,.01,.1,.9,L);const D=i.createBiquadFilter();D.type="lowpass",D.frequency.setValueAtTime(3e3,L),D.frequency.exponentialRampToValueAtTime(200,L+1),k.connect(D),D.connect(j),j.connect(t),U.connect(t),G.start(L),G.stop(L+2),k.start(L),k.stop(L+1.2)}function S(L){if(!s)return;const U=i.currentTime;if(L){const G=i.createGain();_(G,.5,.9,.3,1.6,U);const k=i.createOscillator();k.type="sine",k.frequency.setValueAtTime(90,U),k.frequency.exponentialRampToValueAtTime(1400,U+1.3),k.frequency.exponentialRampToValueAtTime(420,U+2.8),k.connect(G),G.connect(t),k.start(U),k.stop(U+3);const j=i.createBufferSource();j.buffer=p(3);const D=i.createBiquadFilter();D.type="highpass",D.frequency.setValueAtTime(200,U),D.frequency.exponentialRampToValueAtTime(4e3,U+1.4);const mt=i.createGain();if(_(mt,.3,.6,.4,1.4,U),j.connect(D),D.connect(mt),mt.connect(t),j.start(U),j.stop(U+3),!r){const rt=i.createGain();rt.gain.value=0;const xt=i.createOscillator();xt.type="triangle",xt.frequency.value=164;const ct=i.createBiquadFilter();ct.type="lowpass",ct.frequency.value=420,xt.connect(ct),ct.connect(rt),rt.connect(t),xt.start(),r={bg:rt,bo:xt}}r.bg.gain.cancelScheduledValues(U),r.bg.gain.linearRampToValueAtTime(.08,U+2.5),e&&e.lp.frequency.linearRampToValueAtTime(320,U+2.5),f("engineCircular")&&(g("engineCircular",{gain:.6,rate:1.1}),r.sample||(r.sample=g("engineLarge",{gain:.32,loop:!0,fadeIn:2.5,when:.8})))}else{r&&r.bg.gain.linearRampToValueAtTime(0,U+1.2),e&&e.lp.frequency.linearRampToValueAtTime(180,U+1.2),r?.sample&&(r.sample.stop(1.5),r.sample=null),f("engineCircular")&&g("engineCircular",{gain:.35,rate:.7});const G=i.createGain();_(G,.3,.05,.2,1.2,U);const k=i.createOscillator();k.type="sine",k.frequency.setValueAtTime(900,U),k.frequency.exponentialRampToValueAtTime(70,U+1.4),k.connect(G),G.connect(t),k.start(U),k.stop(U+1.5)}}function y(L){if(!s)return;const U=i.currentTime,G=i.createGain();_(G,.18,.2,2,.6,U);const k=i.createOscillator();k.type="triangle",k.frequency.setValueAtTime(L?120:200,U),k.frequency.linearRampToValueAtTime(L?200:120,U+2.4);const j=i.createBiquadFilter();if(j.type="lowpass",j.frequency.value=900,k.connect(j),j.connect(G),G.connect(t),k.start(U),k.stop(U+2.9),f("doorClose")){g(L?"doorOpen":"doorClose",{gain:.55,rate:.55,when:2.4});return}const D=i.createBufferSource();D.buffer=p(.3);const mt=i.createGain();_(mt,.2,.005,.03,.25,U+2.5),D.connect(mt),mt.connect(t),D.start(U+2.5)}function P(){if(!s)return;if(f("thruster")){const j=g("thruster",{gain:.38,rate:.9,loop:!0,fadeIn:1.5});j.src.playbackRate.linearRampToValueAtTime(1.25,i.currentTime+9),setTimeout(()=>j.stop(4),8e3);return}const L=i.currentTime,U=i.createGain();_(U,.22,1.5,4,6,L);const G=i.createOscillator();G.type="sawtooth",G.frequency.setValueAtTime(70,L),G.frequency.linearRampToValueAtTime(240,L+8);const k=i.createBiquadFilter();k.type="lowpass",k.frequency.value=500,G.connect(k),k.connect(U),U.connect(t),G.start(L),G.stop(L+12)}let W=null;function q(L){if(!L){W&&(clearInterval(W.timer),W.g.gain.linearRampToValueAtTime(0,i.currentTime+.3),W=null);return}if(!s||W)return;const U=i.createGain();U.gain.value=.22;const G=i.createBiquadFilter();G.type="lowpass",G.frequency.value=2400,G.connect(U),U.connect(t);const k=()=>{const j=i.currentTime,D=i.createOscillator();D.type="sawtooth",D.frequency.setValueAtTime(330,j),D.frequency.exponentialRampToValueAtTime(760,j+.55);const mt=i.createGain();_(mt,.9,.04,.42,.25,j);const rt=i.createOscillator();rt.type="sine",rt.frequency.setValueAtTime(660,j),rt.frequency.exponentialRampToValueAtTime(1520,j+.55);const xt=i.createGain();_(xt,.35,.04,.42,.25,j),D.connect(mt),rt.connect(xt),mt.connect(G),xt.connect(G),D.start(j),rt.start(j),D.stop(j+.8),rt.stop(j+.8)};k(),W={g:U,timer:setInterval(k,1e3)}}function V(L){if(!s)return;f("forceField2")&&g("forceField2",{gain:.5,rate:L?.32:.4});const U=i.currentTime,G=i.createGain();_(G,.3,.4,1.6,1.4,U);const k=i.createOscillator();k.type="sine",k.frequency.setValueAtTime(L?620:180,U),k.frequency.exponentialRampToValueAtTime(L?140:900,U+2.6);const j=i.createOscillator();j.frequency.value=9;const D=i.createGain();D.gain.value=40,j.connect(D),D.connect(k.frequency),k.connect(G),G.connect(t),k.start(U),j.start(U),k.stop(U+3.5),j.stop(U+3.5)}function O(){if(!s)return;if(f("explosionLow")){g("explosionLow",{gain:.7,rate:.45}),g("forceField",{gain:.35,rate:.5,when:.1});return}const L=i.currentTime,U=i.createGain();_(U,.4,.1,1.6,2.2,L);const G=i.createOscillator();G.type="sawtooth",G.frequency.setValueAtTime(70,L),G.frequency.linearRampToValueAtTime(48,L+3.5);const k=i.createBiquadFilter();k.type="lowpass",k.frequency.setValueAtTime(600,L),k.frequency.linearRampToValueAtTime(180,L+3.5),G.connect(k),k.connect(U),U.connect(t),G.start(L),G.stop(L+4)}let B=null;const Z={calm:[[48,55,60,67],[44,51,56,63],[41,48,53,60],[43,50,55,62]],wonder:[[45,52,57,64],[41,48,55,60],[43,50,55,62],[46,53,58,65]],tense:[[48,51,55,58],[49,53,56,61],[48,51,55,58],[46,50,53,58]],swell:[[48,52,55,60,64,67],[53,57,60,65,69,72],[48,52,55,60,64,67]]},H=L=>440*Math.pow(2,(L-69)/12);function Y(L=3){if(!B)return;const U=B;B=null,clearInterval(U.timer),U.pulse&&clearInterval(U.pulse);const G=i.currentTime;U.g.gain.cancelScheduledValues(G),U.g.gain.setValueAtTime(U.g.gain.value,G),U.g.gain.linearRampToValueAtTime(0,G+L);for(const k of U.voices)k.oscs.forEach(j=>j.stop(G+L+.2))}const vt={calm:"musicAphelion",wonder:"musicStarfire",swell:"musicStarfire",tense:"musicLegionnaire"},X={calm:.3,wonder:.38,swell:.52,tense:.4};let et=null;const ft=new Map;function Q(L=3){if(!et)return;const U=et;et=null;const G=c.get(U.name);G&&ft.set(U.name,(U.offset+(i.currentTime-U.startedAt))%G.duration),U.handle.stop(L)}function nt(L){const U=vt[L];if(!U||!f(U))return!1;if(et&&et.name===U){const D=i.currentTime;return et.handle.g.gain.cancelScheduledValues(D),et.handle.g.gain.setValueAtTime(Math.max(1e-4,et.handle.g.gain.value),D),et.handle.g.gain.linearRampToValueAtTime(X[L],D+3),!0}et&&Q(3);const G=c.get(U);let k=ft.get(U)||0;k>G.duration-30&&(k=0);const j=g(U,{gain:X[L],loop:!0,fadeIn:3,offset:k});return et={name:U,handle:j,startedAt:i.currentTime,offset:k},!0}function gt(L){if(!L||L==="off"){Y(),Q();return}if(!s)return;if(nt(L)){B&&Y(2);return}if(B&&B.mood===L)return;if(!B){const D=i.createGain();D.gain.value=0;const mt=i.createBiquadFilter();mt.type="lowpass",mt.frequency.value=1100,mt.Q.value=.5,mt.connect(D),D.connect(t),B={g:D,lp:mt,timer:null,pulse:null,mood:L,step:0,voices:[]}}const U=B;U.mood=L,U.step=0,clearInterval(U.timer),U.pulse&&(clearInterval(U.pulse),U.pulse=null);const G=L==="tense"?4:L==="swell"?10:8,k=()=>{const D=Z[L]||Z.calm,mt=D[U.step%D.length];U.step++;const rt=i.currentTime,xt=G*.3;for(const E of U.voices)E.g.gain.cancelScheduledValues(rt),E.g.gain.setValueAtTime(E.g.gain.value,rt),E.g.gain.linearRampToValueAtTime(0,rt+xt),E.oscs.forEach($=>$.stop(rt+xt+.1));U.voices=[];const ct=i.createGain();ct.gain.setValueAtTime(0,rt),ct.gain.linearRampToValueAtTime(1,rt+xt),ct.connect(U.lp);const Et=[];mt.forEach((E,$)=>{for(const ut of[-6,6]){const pt=i.createOscillator();pt.type=$===0?"triangle":"sawtooth",pt.frequency.value=H(E),pt.detune.value=ut;const ht=i.createGain();ht.gain.value=($===0?.9:.42)/mt.length,pt.connect(ht),ht.connect(ct),pt.start(rt),Et.push(pt)}});const z=i.createOscillator();z.type="sine",z.frequency.value=H(mt[0]-12);const A=i.createGain();A.gain.value=.3,z.connect(A),A.connect(ct),z.start(rt),Et.push(z),U.voices.push({g:ct,oscs:Et})};if(k(),U.timer=setInterval(k,G*1e3),L==="tense"){const D=()=>{const mt=i.currentTime,rt=i.createOscillator();rt.type="sine",rt.frequency.setValueAtTime(72,mt),rt.frequency.exponentialRampToValueAtTime(36,mt+.35);const xt=i.createGain();_(xt,.45,.005,.04,.42,mt),rt.connect(xt),xt.connect(t),rt.start(mt),rt.stop(mt+.6)};D(),U.pulse=setInterval(D,1500)}const j=L==="swell"?.26:L==="tense"?.13:.16;U.g.gain.cancelScheduledValues(i.currentTime),U.g.gain.setValueAtTime(U.g.gain.value,i.currentTime),U.g.gain.linearRampToValueAtTime(j,i.currentTime+2.5)}function it(){if(!s)return;if(f("laserSmall")){g("laserSmall",{gain:.5,rate:.7}),g("laserSmall",{gain:.4,rate:.66,when:.12});return}const L=i.currentTime,U=i.createGain();_(U,.3,.02,.5,.5,L);const G=i.createOscillator();G.type="square",G.frequency.setValueAtTime(320,L),G.frequency.exponentialRampToValueAtTime(140,L+1);const k=i.createBiquadFilter();k.type="lowpass",k.frequency.value=900,G.connect(k),k.connect(U),U.connect(t),G.start(L),G.stop(L+1.1)}function st(L){if(!s)return;if(f("forceField")){g("forceField",{gain:.6,rate:L==="plasma"?.7:.9}),g("impactMetal",{gain:.35,rate:.8,when:.08}),L==="plasma"&&g("explosionCrunch",{gain:.45,rate:.7,when:.05});return}const U=i.currentTime,G=i.createBufferSource();G.buffer=p(1);const k=i.createGain();_(k,.35,.01,.08,.7,U);const j=i.createBiquadFilter();j.type="lowpass",j.frequency.setValueAtTime(1800,U),j.frequency.exponentialRampToValueAtTime(120,U+.8),G.connect(j),j.connect(k),k.connect(t),G.start(U),G.stop(U+.9)}return{get enabled(){return s},setEnabled:M,phasers:T,torpedo:v,warp:S,servo:y,shuttle:P,disruptor:it,impact:st,alert:q,cloak:V,plasma:O,score:gt,get samplesReady(){return h},get running(){return!!i&&i.state==="running"},whenReady(){return u||Promise.resolve()},get useSamples(){return o},setUseSamples(L){o=L,L?s&&x():(Q(1),e?.sample&&(e.sample.stop(1),e.sample=null,e.g.gain.linearRampToValueAtTime(.16,i.currentTime+1)))},credits(){return l?.credits||[]},recordingTrack(){return!s||!n?null:n.stream.getAudioTracks()[0]||null}}}function Pv(){const i=new ie;i.name="KlingonD7";const t=un(null,{color:7175018,roughness:.6,metalness:.15}),e=en(2896684,{roughness:.6}),n=un(null,{color:5990234,roughness:.65,metalness:.1}),s=new N(new ee(13,40,24),t);s.scale.set(1.35,.62,1.55),s.position.set(0,0,96),s.castShadow=!0,i.add(s);const r=new N(new ee(5,24,14),n);r.scale.set(1.1,.55,1.3),r.position.set(0,7.2,100),i.add(r);const o=new N(new Ot(3.2,6,10,24),e);o.rotation.x=Math.PI/2,o.position.set(0,-1,114),i.add(o);const a=new N(new Ot(1.6,1.6,2,16),Vt(16730666,1.6));a.rotation.x=Math.PI/2,a.position.set(0,-1,119.5),a.userData.kind="glow",i.add(a);const c=new N(new Ot(3.2,4.4,84,20),t);c.rotation.x=Math.PI/2,c.position.set(0,1.5,44),c.castShadow=!0,i.add(c);for(let w=0;w<6;w++){const M=new N(new Ot(4.2,4.2,1.2,20),e);M.rotation.x=Math.PI/2,M.position.set(0,1.5,14+w*12),i.add(M)}const l=new Ci;l.moveTo(0,14),l.lineTo(22,4),l.lineTo(36,-22),l.lineTo(30,-62),l.lineTo(0,-70),l.lineTo(-30,-62),l.lineTo(-36,-22),l.lineTo(-22,4),l.closePath();const u=new N(new Ri(l,{depth:11,bevelEnabled:!0,bevelThickness:2.5,bevelSize:3,bevelSegments:4}),t);u.rotation.x=Math.PI/2,u.position.set(0,5.5,0),u.castShadow=!0,u.receiveShadow=!0,i.add(u);const h=new N(new wt(14,9,34),n);h.position.set(0,9.5,-34),i.add(h);const d=new N(new wt(10,5,2),Vt(16738874,2.4));d.position.set(0,9.5,-52),d.userData.kind="glow",i.add(d);const f=new N(new wt(2.2,12,26),t);f.position.set(0,16,-40),i.add(f);for(const w of[-1,1]){const M=new N(new wt(2.8,9,46),t),_=new R(w*24,1,-26),T=new R(w*70,-22,-74);M.position.copy(_).lerp(T,.5),M.lookAt(T),M.scale.z=_.distanceTo(T)/46,M.castShadow=!0,i.add(M);const b=new N(new Ot(5.5,6.5,62,24),t);b.rotation.x=Math.PI/2,b.position.set(w*72,-23,-78),b.castShadow=!0,i.add(b);const v=new N(new ee(5.5,20,12),n);v.position.set(w*72,-23,-47),i.add(v);const C=new N(new Ot(4.6,4.6,1.2,24),Vt(16734762,2.6));C.rotation.x=Math.PI/2,C.position.set(w*72,-23,-109.5),C.userData.kind="glow",i.add(C);const S=new N(new Ot(.8,1.2,6,12),e);S.rotation.x=Math.PI/2,S.position.set(w*72,-19,-44),i.add(S);for(let y=0;y<3;y++){const P=new N(new wt(.4,3,20),e);P.position.set(w*(72+5.6),-23,-70+y*0),P.rotation.z=w*.3,P.position.z=-90+y*14,i.add(P)}}const g=new N(new ee(1,32,20),oc(8257418,0));g.scale.set(95,50,135),g.position.set(0,-4,10),g.material.transparent=!0,g.material.blending=ve,g.material.depthWrite=!1,i.add(g);const x=ui("rgba(120,255,120,1)"),m=[];let p=0;return i.userData={aimPoint(){return s.getWorldPosition(new R)},hit(){p=1},fire(w){const M=m.length%2===0?-1:1,_=new R(M*72,-19,-41);i.localToWorld(_);const T=new N(new ee(1.2,12,8),new hn({color:12582832,blending:ve,transparent:!0,depthWrite:!1})),b=new tn(new je({map:x,blending:ve,depthWrite:!1,transparent:!0}));b.scale.setScalar(12),T.add(b),T.position.copy(_),i.parent?.add(T),m.push({mesh:T,from:_,to:w.clone(),t:0,dur:1.1})},animate(w){p=Math.max(0,p-w*1.8),g.material.uniforms.uIntensity.value=p*p*1.1;for(let M=m.length-1;M>=0;M--){const _=m[M];_.t+=w;const T=Math.min(1,_.t/_.dur);_.mesh.position.lerpVectors(_.from,_.to,T),T>=1&&(_.mesh.parent?.remove(_.mesh),m.splice(M,1),i.userData.onBoltHit?.(_.to))}},onBoltHit:null},i}function Dv(){const e=document.createElement("canvas");e.width=1024,e.height=1024;const n=e.getContext("2d");n.fillStyle="#59636a",n.fillRect(0,0,1024,1024),n.strokeStyle="rgba(20,25,30,0.18)",n.lineWidth=3;for(let a=0;a<1024;a+=96)n.beginPath(),n.moveTo(a,0),n.lineTo(a,1024),n.stroke();const s=1024/2,r=a=>{const c=[["#f0a030",1],["#d8502a",.82],["#9a2f6a",.64],["#5a2a8a",.46]];for(const[l,u]of c)n.fillStyle=l,n.beginPath(),n.moveTo(s,380),n.bezierCurveTo(s+a*120*u,300-40*u,s+a*420*u,260,s+a*480*u,420+60*(1-u)),n.bezierCurveTo(s+a*400*u,520,s+a*240*u,640-40*u,s,700),n.closePath(),n.fill();n.fillStyle="#f6d060";for(let l=0;l<6;l++){const u=l/5,h=s+a*(300+u*180),d=300+u*200;n.beginPath(),n.moveTo(h,d),n.lineTo(h+a*60,d-30+u*20),n.lineTo(h+a*20,d+40),n.closePath(),n.fill()}};r(1),r(-1),n.fillStyle="#e0602c",n.beginPath(),n.ellipse(s,480,70,210,0,0,Math.PI*2),n.fill(),n.fillStyle="#f0a030",n.beginPath(),n.moveTo(s-90,660),n.lineTo(s,900),n.lineTo(s+90,660),n.closePath(),n.fill(),n.fillStyle="#e0602c",n.beginPath(),n.moveTo(s-60,300),n.bezierCurveTo(s-80,200,s-20,130,s+30,120),n.bezierCurveTo(s+90,110,s+110,170,s+70,200),n.lineTo(s+40,190),n.bezierCurveTo(s+70,240,s+60,290,s+40,320),n.closePath(),n.fill(),n.fillStyle="#f6d060",n.beginPath(),n.moveTo(s+70,200),n.lineTo(s+130,235),n.lineTo(s+40,190),n.closePath(),n.fill(),n.fillStyle="#1a1c22",n.beginPath(),n.arc(s+18,170,11,0,Math.PI*2),n.fill();const o=new xn(e);return o.colorSpace=be,o.anisotropy=8,o}function da(i,t){const e=new _o({...i,transparent:!0,side:2});return e.onBeforeCompile=n=>{n.uniforms.uCloak=t.uCloak,n.uniforms.uTime=t.uTime,n.vertexShader=n.vertexShader.replace("#include <common>",`#include <common>
...
varying vec3 vRomPos;`).replace("#include <opaque_fragment>",`#include <opaque_fragment>
        ...
        }`)},e.customProgramCacheKey=()=>"romulan-cloak-v1",e}function Iv(){const i=new ie;i.name="BirdOfPrey";const t={uCloak:{value:0},uTime:{value:0}},e=da({color:6976634,roughness:.55,metalness:.2,envMapIntensity:.4},t),n=da({color:2896440,roughness:.6,metalness:.2},t),s=da({map:Dv(),roughness:.6,metalness:.1},t),r=new Ci;r.moveTo(0,62),r.lineTo(18,40),r.lineTo(64,-10),r.lineTo(66,-32),r.lineTo(30,-24),r.lineTo(0,-34),r.lineTo(-30,-24),r.lineTo(-66,-32),r.lineTo(-64,-10),r.lineTo(-18,40),r.closePath();const o=new N(new Ri(r,{depth:4.5,bevelEnabled:!0,bevelThickness:1.2,bevelSize:1.6,bevelSegments:3}),e);o.rotation.x=Math.PI/2,o.rotation.z=Math.PI,o.position.set(0,2.2,0),o.castShadow=!0,i.add(o);const a=new Ec(r,8),c=a.attributes.uv;for(let _=0;_<c.count;_++)c.setXY(_,(c.getX(_)+66)/132,1-(c.getY(_)+34)/96);const l=new N(a,s);l.rotation.x=Math.PI/2,l.rotation.z=Math.PI,l.position.set(0,-3.75,0),i.add(l);const u=new N(new ee(13,40,24),e);u.scale.set(1,.55,1.15),u.position.set(0,4,22),u.castShadow=!0,i.add(u);const h=new N(new ee(4.2,24,14),n);h.scale.set(1,.6,1.2),h.position.set(0,10.2,24),i.add(h);const d=new N(new Ot(2.2,3,8,20),n);d.rotation.x=Math.PI/2,d.position.set(0,-1.5,38),i.add(d);const f=new N(new Ot(1.4,1.4,1.2,16),Vt(16734762,1.4));f.rotation.x=Math.PI/2,f.position.set(0,-1.5,42.3),f.userData.kind="glow",i.add(f);for(const _ of[-1,1]){const T=new N(new Ot(3.2,3.6,46,20),e);T.rotation.x=Math.PI/2,T.position.set(_*62,3.5,-8),T.castShadow=!0,i.add(T);const b=new N(new ee(3.2,18,12),n);b.position.set(_*62,3.5,15),i.add(b);const v=new N(new Ot(2.6,2.6,.8,18),Vt(16742970,2.2));v.rotation.x=Math.PI/2,v.position.set(_*62,3.5,-31.5),v.userData.kind="glow",i.add(v);const C=new N(new wt(6,1.4,10),n);C.position.set(_*60,4.4,-8),i.add(C)}const g=new N(new wt(3,2.2,58),n);g.position.set(0,5.6,-4),i.add(g);const x=[];i.traverse(_=>{_.userData.kind==="glow"&&x.push(_.material)});const m=ui("rgba(255,120,60,1)"),p=[];let w=0,M=0;return i.userData={aimPoint(){return u.getWorldPosition(new R)},get cloak(){return w},get cloakTarget(){return M},setCloak(_){M=_?1:0},setCloakLevel(_){w=M=Math.min(1,Math.max(0,_))},fire(_){const T=f.getWorldPosition(new R),b=new N(new ee(3.2,20,14),new hn({color:16769200,blending:ve,transparent:!0,depthWrite:!1})),v=new tn(new je({map:m,blending:ve,depthWrite:!1,transparent:!0,opacity:.9}));v.scale.setScalar(30),b.add(v),b.position.copy(T),i.parent?.add(b),p.push({mesh:b,halo:v,from:T,to:_.clone(),t:0,dur:4.2})},onBoltHit:null,animate(_,T){w+=(M-w)*Math.min(1,_*.9),Math.abs(M-w)<.002&&(w=M),t.uCloak.value=w,t.uTime.value=T;const b=w<.5;for(const v of[e,n,s])v.depthWrite=b;for(const v of x)v.opacity=1-w;i.traverse(v=>{v.isMesh&&v.userData.kind==="glow"&&(v.material.transparent=!0,v.visible=w<.98)}),o.visible=u.visible=l.visible=w<.995;for(let v=p.length-1;v>=0;v--){const C=p[v];C.t+=_;const S=Math.min(1,C.t/C.dur);C.mesh.position.lerpVectors(C.from,C.to,S*S*.3+S*.7),C.halo.scale.setScalar(30+S*40),S>=1&&(C.mesh.parent?.remove(C.mesh),p.splice(v,1),i.userData.onBoltHit?.(C.to))}}},i}const Fs={beauty:{pos:[330,80,290],target:[0,-8,-5]},bow:{pos:[12,10,470],target:[0,-10,20]},bridge:{pos:[30,46,176],target:[0,10,78]},bridgeIn:{pos:[1.6,13,71],target:[0,12.5,84],fov:64},engineeringIn:{pos:[2.5,-31.2,-8],target:[0,-31,-30],fov:62},transporterIn:{pos:[28.4,2.9,66],target:[28,1.9,73.5],fov:60},sickbayIn:{pos:[-25.5,2.7,96.5],target:[-33.5,1.7,101.5],fov:62},saucer:{pos:[.5,300,78],target:[0,0,78]},deflector:{pos:[66,-22,140],target:[0,-35,42]},hangar:{pos:[14,-26,-150],target:[0,-33,-50]},nacelle:{pos:[126,36,62],target:[42,10,-10]},stern:{pos:[70,24,-420],target:[0,-12,-40]},profile:{pos:[500,-8,-8],target:[0,-10,-8]},plan:{pos:[.5,720,-6],target:[0,0,-6]},belly:{pos:[40,-320,10],target:[0,-10,10]}};function Lv(i){const t=new Fg({canvas:i,antialias:!0,alpha:!1,preserveDrawingBuffer:!0,powerPreference:"high-performance"});t.setPixelRatio(Math.min(devicePixelRatio,2)),t.setSize(innerWidth,innerHeight),t.shadowMap.enabled=!0,t.shadowMap.type=wu,t.toneMapping=cc,t.toneMappingExposure=1.12,t.localClippingEnabled=!0;const e=new Qr;e.background=new Wt(329483);const n=new an(40,innerWidth/innerHeight,.8,9e3);n.position.set(...Fs.beauty.pos);const s=1e3,r=new ho(-s*innerWidth/innerHeight/2,s*innerWidth/innerHeight/2,s/2,-s/2,-4e3,9e3);let o=n;const a=new z_(o,i);a.enableDamping=!0,a.dampingFactor=.06,a.target.set(...Fs.beauty.target),a.maxDistance=1800,a.minDistance=1.2;const c=new sx(t),l=new rx(e,o);c.addPass(l);const u=new ux(e,o,{focus:300,aperture:2e-5,maxblur:.012});u.enabled=!1,c.addPass(u);const h=new _s(new dt(innerWidth,innerHeight),.34,.55,.8);c.addPass(h),c.addPass(new cx),c.setSize(innerWidth,innerHeight);const d={enabled:!1,aperture:.35,focus:0,auto:!0};function f(){if(u.enabled=d.enabled,!d.enabled)return;const F=d.auto||d.focus<=0?o.position.distanceTo(a.target):d.focus;u.uniforms.focus.value=F,u.uniforms.aperture.value=(4e-6+d.aperture*9e-5)*Math.min(1,120/Math.max(20,F)),u.uniforms.maxblur.value=.006+d.aperture*.012}const g=new Ja(t);e.environment=g.fromScene(new hx,.04).texture,e.environmentIntensity=.5;const x=new w_(12044509,1315344,.5),m=new ea(16773596,2.3);m.position.set(260,300,220),m.castShadow=!0,m.shadow.mapSize.set(4096,4096),m.shadow.camera.near=50,m.shadow.camera.far=1200,m.shadow.camera.left=-200,m.shadow.camera.right=200,m.shadow.camera.top=200,m.shadow.camera.bottom=-200,m.shadow.bias=-4e-4,m.shadow.normalBias=.6;const p=new ea(9418751,.5);p.position.set(-260,40,-120);const w=new ea(16767392,.4);w.position.set(60,-120,-300);const M=new Tn(16734736,60,90,1.6),_=new Tn(16734736,60,90,1.6),T=new Tn(7001343,45,90,1.8);e.add(x,m,p,w,M,_,T);const b=wv();e.add(b);const v=Mv();e.add(v);const C=Tv(()=>o,i);v.add(C.group);const S=Av(()=>o,a);e.add(S.group);const y=Rv(),P=Pv();P.rotation.y=Math.PI,P.position.set(90,-40,820),P.visible=!1,e.add(P);const W=P.position.clone();let q=0;P.userData.onBoltHit=()=>{v.userData.effects.shieldHit(),y.impact?.("disruptor")};const V=Iv();V.position.set(-360,24,540),V.rotation.y=Math.PI+.55,V.visible=!1,V.userData.setCloakLevel(1),e.add(V);const O=V.position.clone();let B=0;V.userData.onBoltHit=()=>{v.userData.effects.shieldHit(),y.impact?.("plasma")};function Z(){const F=V.visible&&V.userData.cloak<.6;if(P.visible&&(!F||P.position.distanceTo(v.position)<V.position.distanceTo(v.position)))return v.worldToLocal(P.userData.aimPoint());if(F)return v.worldToLocal(V.userData.aimPoint())}v.userData.effects.onImpact=(F,bt)=>{const Nt=v.localToWorld(F.clone());P.visible&&Nt.distanceTo(P.userData.aimPoint())<160&&(P.userData.hit(),y.impact?.(bt)),V.visible&&Nt.distanceTo(V.userData.aimPoint())<120&&y.impact?.(bt)};const H=new O_(700,70,2765632,1448738);H.position.y=-75,H.visible=!1,e.add(H);const Y={mode:"exterior",light:"studio",cam:"beauty",autoOrbit:!1,explode:0,clip:.5,labels:!1,warp:!1,tour:!1,ortho:!1,grid:!1,playback:!1,markers:!0,quality:"high",deck:7,alert:!1},vt=["beauty","bow","bridge","bridgeIn","transporterIn","sickbayIn","saucer","deflector","engineeringIn","nacelle","stern","hangar","belly","profile"],X={index:0,t:0,from:{pos:new R,target:new R},to:{pos:new R,target:new R},travel:6.5,hold:2.5},et=F=>F*F*(3-2*F);function ft(){X.index=(X.index+1)%vt.length,X.t=0,X.from.pos.copy(o.position),X.from.target.copy(a.target);const F=vt[X.index],bt=Fs[F];X.to.pos.set(...bt.pos),X.to.target.set(...bt.target),X.fovFrom=n.fov,X.fovTo=bt.fov||40,Y.cam=F,F==="profile"&&Y.mode==="exterior"?(X.openedCut=!0,G("cutaway")):X.openedCut&&F!=="profile"&&(X.openedCut=!1,G("exterior")),F==="hangar"?(Ae.setHangar(!0),setTimeout(()=>Y.tour&&Ae.launchShuttle(),3500)):F==="belly"&&Ae.setHangar(!1),Q?.(F)}let Q=null;function nt(F){X.t+=F;const bt=et(Math.min(1,X.t/X.travel));o.position.lerpVectors(X.from.pos,X.to.pos,bt),a.target.lerpVectors(X.from.target,X.to.target,bt),X.fovTo&&(n.fov=X.fovFrom+(X.fovTo-X.fovFrom)*bt,n.updateProjectionMatrix()),X.t>=X.travel&&o.position.sub(a.target).applyAxisAngle(new R(0,1,0),F*.05).add(a.target),X.t>=X.travel+X.hold&&ft()}function gt(){return Y.mode==="blueprint"||Y.light==="studio"?1.12:Y.light==="space"?.95:.8}function it(F){Y.light=F,F==="studio"?(e.background.set(329483),m.color.set(16773596),m.intensity=2.3,p.intensity=.5,x.intensity=.5,e.environmentIntensity=.5,h.strength=.34,t.toneMappingExposure=1.12):F==="space"?(e.background.set(131848),m.color.set(14543103),m.intensity=1.4,p.intensity=.18,x.intensity=.16,e.environmentIntensity=.22,h.strength=.6,t.toneMappingExposure=.95):(e.background.set(65796),m.intensity=.12,p.intensity=.04,x.intensity=.06,e.environmentIntensity=.06,h.strength=1.1,t.toneMappingExposure=.8)}function st(F){return ri.find(bt=>bt.id===F)||ri[0]}function L(F,bt=!0){Y.deck=F;const Nt=st(F);Nt&&(v.userData.setDeckCut(!0,Nt.y+1.25,Nt.id),bt&&!Y.playback&&Et(new R(.5,Nt.y+Math.max(120,Nt.r*2.6),Nt.z),new R(0,Nt.y,Nt.z),1),U?.(Nt))}let U=null;function G(F){const bt=Y.mode==="decks";Y.mode=F,C.setVisible(Y.markers&&F!=="explode"&&F!=="decks"&&F!=="blueprint");const Nt=F==="cutaway";if(bt&&F!=="decks"&&v.userData.setDeckCut(!1),v.userData.setCutaway(Nt,Y.clip),v.userData.interiors.visible=Nt||Y.labels,F==="explode"?v.userData.setExplode(Math.max(Y.explode,.75)):v.userData.setExplode(Y.explode),v.userData.setBlueprint(F==="blueprint"),b.visible=F!=="blueprint"&&F!=="decks",F==="decks"){L(Y.deck||7),v.userData.interiors.userData.setLabels(!0,Y.deck||7),e.background.set(793132),m.intensity=1.2,x.intensity=1,e.environmentIntensity=.6,h.strength=.12,H.visible=!0;return}else Nt||v.userData.interiors.userData.setLabels(Y.labels);F==="blueprint"?(e.background.set(925235),m.intensity=.3,x.intensity=1.2,e.environmentIntensity=.9,h.strength=.08,H.visible=!0):(H.visible=Y.grid,it(Y.light))}function k(F){if(F===Y.ortho)return;const bt=o,Nt=F?r:n;if(Nt.position.copy(bt.position),Nt.quaternion.copy(bt.quaternion),F){const qe=2*bt.position.distanceTo(a.target)*Math.tan(n.fov*Math.PI/360);r.zoom=s/qe,r.updateProjectionMatrix()}o=Nt,Y.ortho=F,a.object=o,l.camera=o,u.camera=o,a.update()}function j(F,bt=!0){const Nt=Fs[F];Nt&&(Y.cam=F,n.fov=Nt.fov||40,n.updateProjectionMatrix(),bt?Et(new R(...Nt.pos),new R(...Nt.target),1.4):(o.position.set(...Nt.pos),a.target.set(...Nt.target),a.update()))}function D(){if(Ie)return;n.aspect=innerWidth/innerHeight,n.updateProjectionMatrix();const F=innerWidth/innerHeight;r.left=-s*F/2,r.right=s*F/2,r.updateProjectionMatrix(),t.setSize(innerWidth,innerHeight),c.setSize(innerWidth,innerHeight)}addEventListener("resize",D);const mt=v.userData.nacelles.children[0],rt=v.userData.nacelles.children[1],xt=new R(0,0,Mt.half+Mt.nacelleZ+2),ct={active:!1,t:0,dur:1.6,from:{pos:new R,target:new R},to:{pos:new R,target:new R}};function Et(F,bt,Nt=1.6){ct.active=!0,ct.t=0,ct.dur=Nt,ct.from.pos.copy(o.position),ct.from.target.copy(a.target),ct.to.pos.copy(F),ct.to.target.copy(bt)}C.onSelect=F=>{const bt=new R(...F.view.dir).normalize(),Nt=new R(...F.pos).addScaledVector(bt,F.view.dist);Et(Nt,new R(...F.pos)),z?.(F)};let z=null;const A=new Set;let E=0,$=performance.now();function ut(F){const bt=Math.min(.05,(F-$)/1e3);$=F;for(const Nt of A)Nt(bt,F/1e3);if(Y.playback)Ft?.(bt),o.lookAt(a.target);else{if(ct.active){ct.t+=bt;const Nt=et(Math.min(1,ct.t/ct.dur));o.position.lerpVectors(ct.from.pos,ct.to.pos,Nt),a.target.lerpVectors(ct.from.target,ct.to.target,Nt),ct.t>=ct.dur&&(ct.active=!1)}else Y.tour?nt(bt):Y.autoOrbit&&Y.mode!=="blueprint"&&o.position.sub(a.target).applyAxisAngle(new R(0,1,0),bt*.07).add(a.target);a.update()}if(v.userData.animate(F/1e3,bt),b.userData.animate(bt),P.visible&&(q+=bt,P.position.set(W.x+Math.sin(q*.18)*25,W.y+Math.sin(q*.11)*8,W.z),P.rotation.z=Math.sin(q*.14)*.08,P.userData.animate(bt)),V.visible&&(B+=bt,V.position.set(O.x+Math.sin(B*.15)*18,O.y+Math.sin(B*.1)*6,O.z+Math.cos(B*.12)*12),V.rotation.z=Math.sin(B*.17)*.06,V.userData.animate(bt,F/1e3)),C.animate(F/1e3,o),lt>0&&(lt=Math.max(0,lt-bt*1.6),t.toneMappingExposure=gt()+lt*lt*2.6),d.enabled&&f(),S.active&&S.update(),++E===3){ht=!0;for(const Nt of pt)Nt();pt.clear()}mt.getWorldPosition(M.position).add(xt.clone().applyQuaternion(v.quaternion)),rt.getWorldPosition(_.position).add(xt.clone().applyQuaternion(v.quaternion)),v.userData.secondary.getWorldPosition(T.position).add(new R(0,-.5,62).applyQuaternion(v.quaternion)),c.render(),requestAnimationFrame(ut)}requestAnimationFrame(ut);const pt=new Set;let ht=!1,Ft=null,Tt=null,Dt=null,te=null,yt=null,Lt=null,Xt=null,qt=null,Ut=null;function se(){return{pos:o.position.toArray(),target:a.target.toArray(),state:{mode:Y.mode,light:Y.light,warp:Y.warp,labels:Y.labels,markers:Y.markers,hangar:v.userData.hangar.isOpen,shuttle:v.userData.hangar.launching&&!v.userData.hangar.descending,descent:v.userData.hangar.descending,klingon:P.visible,alert:Y.alert,romulan:V.visible,cloak:V.userData.cloakTarget,clip:Y.clip,explode:Y.explode,fov:n.fov,shipX:v.position.x,shipY:v.position.y,shipZ:v.position.z,shipYaw:v.rotation.y,shipPitch:v.rotation.x,shipRoll:v.rotation.z,lift:Zt.progress,liftDoors:Zt.doors,liftCam:0,chase:0,dof:d.enabled?d.aperture:0,focus:d.auto?0:d.focus,caption:"",score:"off",fade:0}}}const Zt={progress:0,doors:0};function de({x:F,y:bt,z:Nt,yaw:He,pitch:qe,roll:dn}){typeof F=="number"&&(v.position.x=F),typeof bt=="number"&&(v.position.y=bt),typeof Nt=="number"&&(v.position.z=Nt),typeof He=="number"&&(v.rotation.y=He),typeof qe=="number"&&(v.rotation.x=qe),typeof dn=="number"&&(v.rotation.z=dn)}function K(F,bt){o.position.copy(F),a.target.copy(bt)}function Ct(F){F.mode&&F.mode!==Y.mode&&G(F.mode),F.light&&F.light!==Y.light&&Y.mode!=="blueprint"&&it(F.light),typeof F.warp=="boolean"&&F.warp!==Y.warp&&Ae.setWarp(F.warp),typeof F.labels=="boolean"&&F.labels!==Y.labels&&Ae.setLabels(F.labels),typeof F.markers=="boolean"&&F.markers!==Y.markers&&Ae.setHotspots(F.markers),typeof F.hangar=="boolean"&&F.hangar!==v.userData.hangar.isOpen&&Ae.setHangar(F.hangar),F.shuttle===!0?Ae.launchShuttle():F.shuttle===!1&&v.userData.hangar.launching&&!v.userData.hangar.descending&&Ae.recallShuttle(),F.descent===!0?Ae.launchDescent():F.descent===!1&&v.userData.hangar.descending&&Ae.recallShuttle(),typeof F.klingon=="boolean"&&F.klingon!==P.visible&&Ae.setKlingon(F.klingon),typeof F.alert=="boolean"&&F.alert!==Y.alert&&Ae.setAlert(F.alert),typeof F.romulan=="boolean"&&F.romulan!==V.visible&&Ae.setRomulan(F.romulan),F.plasma===!0&&Ae.romulanFire(),typeof F.caption=="string"&&qt?.(F.caption),typeof F.score=="string"&&y.score?.(F.score),F.phasers===!0&&Ae.firePhasers(),F.torpedo===!0&&Ae.fireTorpedo(),F.disruptor===!0&&Ae.klingonFire(),Rt?.(F)}let lt=0;function _t(){lt=1}let Rt=null;function Pt(F){if(typeof F.clip=="number"&&Math.abs(F.clip-Y.clip)>1e-4&&(Y.clip=F.clip,v.userData.setClip(F.clip)),typeof F.explode=="number"&&Math.abs(F.explode-Y.explode)>1e-4&&(Y.explode=F.explode,v.userData.setExplode(Y.mode==="explode"?Math.max(F.explode,.75):F.explode)),typeof F.fov=="number"&&Math.abs(F.fov-n.fov)>.001&&(n.fov=F.fov,n.updateProjectionMatrix()),de({x:F.shipX,y:F.shipY,z:F.shipZ,yaw:F.shipYaw,pitch:F.shipPitch,roll:F.shipRoll}),typeof F.lift=="number"&&(Zt.progress=F.lift,v.userData.turbolift.setProgress(F.lift)),typeof F.liftDoors=="number"&&(Zt.doors=F.liftDoors,v.userData.turbolift.setDoors(F.liftDoors)),typeof F.cloak=="number"&&V.userData.setCloak(F.cloak>.5),typeof F.fade=="number"&&Ut?.(F.fade),typeof F.dof=="number"&&(d.enabled=F.dof>.005,d.aperture=F.dof,typeof F.focus=="number"&&(d.auto=F.focus<=0,d.focus=F.focus),f(),yt?.()),typeof F.liftCam=="number"&&F.liftCam>.001){const bt=v.userData.turbolift,Nt=v.localToWorld(bt.cameraAt(Zt.progress)),He=v.localToWorld(bt.lookAt(Zt.progress));o.position.lerp(Nt,Math.min(1,F.liftCam)),a.target.lerp(He,Math.min(1,F.liftCam))}if(typeof F.chase=="number"&&F.chase>.001&&v.userData.hangar.launching){const bt=v.userData.hangar,Nt=bt.shuttleWorld(Yt.pos),He=bt.shuttleHeading(Yt.dir),qe=Yt.up.set(0,1,0),dn=Yt.side.crossVectors(He,qe).normalize(),$n=Yt.cam.copy(Nt).addScaledVector(He,-24).addScaledVector(qe,6).addScaledVector(dn,9),On=Yt.look.copy(Nt).addScaledVector(He,18);o.position.lerp($n,Math.min(1,F.chase)),a.target.lerp(On,Math.min(1,F.chase))}}const Yt={pos:new R,dir:new R,up:new R,side:new R,cam:new R,look:new R};function we(F){Y.playback=F,a.enabled=!F,F&&(Y.tour=!1,ct.active=!1)}let Ie=null;function ae(F,bt){if(F&&bt){Ie=[F,bt],t.setPixelRatio(1),t.setSize(F,bt,!1),c.setSize(F,bt),n.aspect=F/bt,n.updateProjectionMatrix();const Nt=F/bt;r.left=-s*Nt/2,r.right=s*Nt/2,r.updateProjectionMatrix(),i.style.width="100%",i.style.height="100%",i.style.objectFit="contain"}else Ie=null,t.setPixelRatio(Math.min(devicePixelRatio,2)),i.style.objectFit="",D()}async function nn({interiors:F=!1}={}){const bt=new so,Nt=v.userData.interiors.visible,He=v.userData.cutaway,qe=Y.mode==="blueprint";qe&&v.userData.setBlueprint(!1),v.userData.setCutaway(!1),v.userData.interiors.visible=F,F&&v.userData.interiors.userData.setLabels(!1),v.userData.setExplode(0),v.traverse(dn=>{dn.userData.kind==="edges"&&(dn.visible=!1)});try{const dn=await bt.parseAsync(v,{binary:!0,onlyVisible:!0}),$n=new Blob([dn],{type:"model/gltf-binary"}),On=document.createElement("a");On.href=URL.createObjectURL($n),On.download=F?"uss-enterprise-ncc-1701-cutaway.glb":"uss-enterprise-ncc-1701.glb",On.click(),setTimeout(()=>URL.revokeObjectURL(On.href),5e3)}finally{F&&v.userData.interiors.userData.setLabels(Y.labels),v.userData.interiors.visible=Nt,qe&&v.userData.setBlueprint(!0),v.userData.setCutaway(He,Y.clip),Y.mode==="explode"?v.userData.setExplode(Math.max(Y.explode,.75)):v.userData.setExplode(Y.explode)}}function vn(){ae(0,0)}function er(F="uss-enterprise"){c.render(),t.domElement.toBlob(bt=>{if(!bt)return;const Nt=document.createElement("a");Nt.href=URL.createObjectURL(bt),Nt.download=`${F}.png`,Nt.click(),setTimeout(()=>URL.revokeObjectURL(Nt.href),5e3)},"image/png")}const Ae={scene:e,get camera(){return o},controls:a,ship:v,state:Y,grid:H,renderer:t,composer:c,canvas:i,cameras:Fs,setOrtho:k,savePNG:er,setRenderSize:ae,restoreRenderSize:vn,captureState:se,setShipPose:de,getShipPose(){return{x:v.position.x,y:v.position.y,z:v.position.z,yaw:v.rotation.y,pitch:v.rotation.x,roll:v.rotation.z}},setCameraDirect:K,applyDiscrete:Ct,applyContinuous:Pt,setPlayback:we,onPlaybackTick(F){Ft=F},onDiscreteApplied(F){Rt=F},setFov(F){n.fov=F,n.updateProjectionMatrix()},onFrame(F){return A.add(F),()=>A.delete(F)},cancelFlight(){ct.active=!1},renderOnce(){c.render()},setGrid(F){Y.grid=F,H.visible=F||Y.mode==="blueprint"},setDeck(F,bt=!0){Y.mode!=="decks"&&G("decks"),L(F,bt)},onDeckChanged(F){U=F},deckLevels:ri,dof:d,setDof({enabled:F,aperture:bt,focus:Nt,auto:He}={}){typeof F=="boolean"&&(d.enabled=F),typeof bt=="number"&&(d.aperture=bt),typeof Nt=="number"&&(d.focus=Nt),typeof He=="boolean"&&(d.auto=He),f()},setQuality(F){Y.quality=F;const bt=F==="high";t.setPixelRatio(bt?Math.min(devicePixelRatio,2):1),t.shadowMap.enabled=bt,m.castShadow=bt,h.enabled=F!=="low",e.traverse(Nt=>{Nt.material&&Nt.material.needsUpdate!==void 0&&(Nt.material.needsUpdate=!0)}),D()},applyLight:it,applyMode:G,goCamera:j,exportGLB:nn,hotspots:C,reference:S,flyTo:Et,onReady(F){ht?F():pt.add(F)},onHotspot(F){z=F},setHotspots(F){Y.markers=F,C.setVisible(F&&!["explode","decks","blueprint"].includes(Y.mode))},audio:y,setWarp(F){F&&!Y.warp&&_t(),F!==Y.warp&&y.warp(F),Y.warp=F,b.userData.setWarp(F),v.userData.setWarp(F),h.strength=F?Math.max(h.strength,.55):h.strength,Tt?.(F)},firePhasers(){v.userData.effects.firePhasers(Z()),y.phasers()},fireTorpedo(){v.userData.effects.fireTorpedo(Z()),y.torpedo()},setAlert(F){F!==Y.alert&&(Y.alert=F,v.userData.setAlert(F),y.alert(F),F&&!Y.warp&&(h.strength=Math.max(h.strength,.45)),Lt?.(F))},onAlertChanged(F){Lt=F},romulan:V,setRomulan(F){F?(V.visible=!0,V.userData.setCloak(!1),y.cloak?.(!1)):(V.userData.setCloak(!0),y.cloak?.(!0),setTimeout(()=>{V.userData.cloakTarget===1&&(V.visible=!1)},4500)),Xt?.(F)},setCloak(F){V.visible&&(V.userData.setCloak(F),y.cloak?.(F))},onRomulanChanged(F){Xt=F},onCaption(F){qt=F},onFade(F){Ut=F},romulanFire(){if(!V.visible||V.userData.cloak>.6)return;const F=v.localToWorld(new R(0,0,Mt.saucerZ));V.userData.fire(F),y.plasma?.()},klingon:P,setKlingon(F){P.visible=F,te?.(F)},onKlingonChanged(F){te=F},onDofApplied(F){yt=F},klingonFire(){if(!P.visible)return;const F=v.localToWorld(new R(0,0,Mt.saucerZ));P.userData.fire(F),y.disruptor?.()},onWarpChanged(F){Tt=F},setHangar(F){F!==v.userData.hangar.isOpen&&y.servo(F),v.userData.setHangar(F),Dt?.(F)},onHangarChanged(F){Dt=F},launchShuttle(){v.userData.hangar.isOpen||y.servo(!0),v.userData.launchShuttle(),y.shuttle(),Dt?.(!0)},launchDescent(){if(v.userData.hangar.launching)return;v.userData.hangar.isOpen||y.servo(!0);const F=b.userData.planet;v.userData.launchShuttleTo(F.getWorldPosition(new R),F.geometry.parameters.radius,46),y.shuttle(),Dt?.(!0)},recallShuttle(){v.userData.recallShuttle()},setTour(F,bt){Y.tour=F,Q=bt||null,a.enabled=!F,F&&(X.index=-1,ft())},setExplode(F){Y.explode=F,v.userData.setExplode(Y.mode==="explode"?Math.max(F,.75):F)},setClip(F){Y.clip=F,v.userData.setClip(F)},setLabels(F){Y.labels=F,v.userData.interiors.userData.setLabels(F),v.userData.interiors.visible=F||Y.mode==="cutaway"}};return Ae}function Uv(i,t,e={}){const n=e.lift,s=[],r=["phasers","torpedo","disruptor","plasma"];let o={...t,light:"space",mode:"exterior",score:"calm",fade:0,caption:"",dof:.25};const a=(T,b,v,C={},S="smooth")=>{o={...o,...C},s.push({t:T,pos:[...b],target:[...v],state:{...o},ease:S});for(const y of r)o[y]=!1;return s[s.length-1]},c=()=>s[s.length-1],l=(T,b,v,C={})=>{const S=c();a(T-.45,S.pos,S.target,{fade:0},"linear"),a(T,S.pos,S.target,{fade:1},"linear"),a(T+.01,b,v,{fade:1,...C},"linear"),a(T+.6,b,v,{fade:0},"linear")},u=T=>i[T],h=T=>u(T).pos,d=T=>u(T).target,f=[60,26,980],g=[14,12,540],x=[0,-10,20],m=T=>f.map((b,v)=>b+(g[v]-b)*T);if(a(0,f,x,{fov:30,fade:1,dof:.25},"linear"),a(1.2,m(.075),x,{fade:.6,caption:"U.S.S. ENTERPRISE|NCC-1701 · Constitution class · 288.6 m"},"linear"),a(3,m(.19),x,{fade:0},"linear"),a(8,m(.5),x,{caption:""},"linear"),a(9.5,m(.59),x,{caption:"A reconstruction from the Smithsonian 11-foot studio model|and Alan Sinclair's orthographics"},"linear"),a(15.5,m(.97),x,{caption:""},"linear"),a(17,h("bow"),d("bow"),{fov:36,caption:"I · THE SHIP|Primary hull · dorsal · engineering hull · warp nacelles"}),a(22,[180,40,420],[0,-8,20],{caption:""}),a(26,h("beauty"),d("beauty"),{fov:40}),a(33,[12,168,0],[0,8,78],{fov:40,caption:"Saucer registry|Arched name and straight registry, as painted on the studio model"}),a(38,[34,150,-14],[0,8,78],{caption:""}),a(41,h("nacelle"),d("nacelle"),{fov:44}),a(47,[62,18,34],[41.5,10.5,12],{fov:40,dof:.6,caption:"Bussard collectors|Spinning fan blades behind the domes"}),a(52,[58,16,40],[41.5,10.5,12],{caption:"",dof:.3}),a(54,h("deflector"),d("deflector"),{fov:40,caption:"Main deflector|Copper dish forward of the engineering hull"}),a(59,[50,-30,150],[0,-35,42],{caption:""}),a(61,h("stern"),d("stern"),{fov:40}),a(63.5,[180,30,-380],[0,-12,-40],{light:"night",caption:"Running lights|Deep-space lighting scheme"}),a(69,[300,-30,-200],[0,-10,-8],{caption:""}),l(70,h("profile"),d("profile"),{mode:"cutaway",clip:.36,light:"space",fov:36,score:"wonder",caption:"II · INSIDE|Longitudinal section · 23 decks fitted to the hull"}),a(72,h("profile"),d("profile"),{clip:.38},"linear"),a(77,[470,0,-8],d("profile"),{clip:.47,caption:""},"linear"),a(82,[430,12,-8],d("profile"),{clip:.55},"linear"),a(83.5,[300,160,260],[0,-8,-5],{mode:"exterior",explode:0,fov:42,caption:"Exploded assembly|Primary hull · dorsal · engineering hull · pylons · warp nacelles"}),a(89.5,[260,180,300],[0,-8,-5],{explode:1}),a(92,[240,170,320],[0,-8,-5],{explode:1,caption:""}),a(95,[300,160,260],[0,-8,-5],{explode:0}),l(96,[430,-8,-8],[0,-10,-8],{mode:"blueprint",fov:36,caption:"Blueprint|Gold edge lines on a drafting-blue field"}),a(100,[300,300,0],[0,-4,0],{fov:38}),a(104,[.5,470,10],[0,0,10],{fov:40,caption:""}),l(105,[.5,380,60],[0,0,60],{mode:"decks",caption:"Deck plans|Deck 7 · main deck · horizontal section"}),a(112,[.5,360,75],[0,0,72],{caption:""},"linear"),l(113,[2.4,13.9,70.5],[0,12.3,84],{mode:"exterior",light:"studio",fov:64,caption:"The bridge|Command well · helm and navigation · perimeter stations"}),a(121,[1.2,13.7,74],[0,12.3,84],{caption:""}),a(124,[.4,13.2,75.5],[0,12.3,69],{fov:66}),a(126.5,[.2,12.8,72.6],[0,12.3,68],{fov:68,liftDoors:1}),n){const T=(b,v,C,S={},y="smooth")=>a(v,n.cameraAt(b).toArray(),n.lookAt(b).toArray(),{fov:70,lift:b,liftDoors:C,liftCam:1,...S},y);T(0,126.55,1,{},"linear"),T(0,128.3,1,{},"linear"),T(0,129.3,0,{caption:"Turbolift|Bridge to main engineering, down the saucer trunk and along the dorsal"},"linear"),T(.12,131.3,0,{},"in"),T(.5,135.3,0,{},"linear"),T(.88,139.3,0,{caption:""},"linear"),T(1,141.3,0,{},"out"),T(1,142.8,1,{},"smooth")}a(146,h("engineeringIn"),d("engineeringIn"),{fov:62,lift:1,liftDoors:1,liftCam:0,caption:"Main engineering|Reactor grille · intermix conduits · dilithium table"}),a(152,[1.6,-31.1,-14.5],[0,-31.3,-30],{fov:60},"linear"),a(157,[-1.5,-31,-19],[0,-31.5,-30],{liftDoors:0,caption:""}),l(158,h("transporterIn"),d("transporterIn"),{fov:60,lift:0,caption:"Transporter room|Six pads under the overhead disc · operator's console"}),a(165,[28.2,2.8,67.8],[28,1.9,73.5],{caption:""}),l(166,h("sickbayIn"),d("sickbayIn"),{fov:62,caption:"Sickbay|Three diagnostic beds with readouts · doctor's office"}),a(173,[-27,2.6,97.5],[-33.5,1.7,101.5],{caption:""}),l(174,h("stern"),d("stern"),{light:"space",fov:40,score:"calm",caption:"III · FLIGHT DECK|Clamshell doors · two Class F shuttlecraft"}),a(179,h("hangar"),d("hangar"),{fov:44,hangar:!0}),a(181,[16,-25,-148],[0,-33,-50],{caption:""}),a(183,[14,-26,-150],[0,-33,-50],{shuttle:!0}),a(191,[36,-24,-135],[0,-33,-72],{fov:46}),a(193,[36,-24,-135],[0,-33,-72],{chase:1},"in"),a(195,[36,-24,-135],[0,-33,-72],{chase:1,caption:"Shuttlecraft Galileo|Taxi out over the fantail, then climb away"},"linear"),a(201,[36,-24,-135],[0,-33,-72],{chase:1,fov:50,caption:""},"linear"),a(203,[36,-24,-135],[0,-33,-72],{chase:1,fov:50},"linear"),a(206.5,[-60,20,-330],[0,-10,-200],{chase:0,fov:40}),l(208,[2.4,13.9,70.5],[0,12.3,84],{light:"studio",fov:64,alert:!0,score:"tense",shuttle:!1,hangar:!1,caption:"IV · RED ALERT|All hands to battle stations"}),a(214,[3,13.8,73],[-1,12.3,84],{fov:60,caption:""}),l(215,[-130,30,520],[90,-40,820],{light:"space",klingon:!0,fov:40,caption:"Klingon D7|Battle cruiser off the starboard bow"}),a(219,[-40,20,610],[90,-40,820],{fov:38,disruptor:!0}),a(219.5,[-30,18,620],[90,-40,820],{caption:""}),a(222,[60,-20,200],[60,-30,700],{fov:42,phasers:!0}),a(225,[-30,20,180],[80,-40,800],{fov:40,torpedo:!0,disruptor:!0}),a(229,[220,60,620],[60,-30,780],{fov:36,phasers:!0},"linear"),a(233,[420,40,160],[0,-10,0],{fov:40,torpedo:!0}),a(236,[-90,34,300],[-360,24,540],{fov:36,cloak:1,romulan:!0}),a(237,[-90,34,300],[-360,24,540],{cloak:0,caption:"Romulan Bird-of-Prey|Decloaking off the port bow"},"linear"),a(241,[-300,-120,400],[-360,20,540],{fov:40,caption:""}),a(243,[-320,-110,430],[-360,20,540],{fov:40,plasma:!0,caption:"Plasma torpedo|Balance of Terror"}),a(245,[-330,-100,440],[-360,20,540],{caption:""}),a(247,[120,40,160],[-200,20,400],{fov:44}),a(249,[120,40,160],[-200,20,400],{phasers:!0}),a(252,[-250,60,480],[-360,24,540],{fov:38,torpedo:!0}),a(255,[320,70,320],[0,-10,240],{fov:52,caption:"All weapons|Phasers · photon torpedoes · disruptor and plasma return fire"}),a(256,[320,70,320],[0,-10,240],{phasers:!0,torpedo:!0}),a(257,[310,68,330],[0,-10,240],{disruptor:!0,plasma:!0}),a(258.5,[300,66,340],[0,-10,240],{phasers:!0}),a(259.5,[290,64,350],[0,-10,240],{torpedo:!0}),a(261,[280,62,360],[0,-10,240],{caption:""}),a(263.5,[-250,60,480],[-360,24,540],{fov:38,cloak:1}),a(266,h("stern"),d("stern"),{fov:40,klingon:!1,alert:!1,caption:"Warp factor 6|Bound for a Class-M planet"}),a(268,[80,26,-440],[0,-12,-40],{warp:!0},"in"),a(273,[10,30,-900],[0,-12,-300],{fov:48,caption:""});const p={shipX:1550,shipY:-450,shipZ:-2150,shipYaw:-.69,shipPitch:.04,shipRoll:.08},w=[p.shipX,p.shipY,p.shipZ],M=[1595,-485,-2204],_=[1882,-642,-2552];return l(274,[1290,-300,-1860],w,{warp:!1,romulan:!1,...p,fov:42,dof:.25,score:"wonder",caption:"V · ORBIT|Standard orbit · shuttlecraft descent"}),a(282,[1380,-380,-1960],[1580,-470,-2190],{fov:40,hangar:!0,caption:""}),a(283,[1660,-462,-2262],M,{fov:46,descent:!0,dof:.35}),a(291,[1650,-455,-2240],M,{fov:48}),a(294,[1650,-455,-2240],M,{chase:1,dof:.2},"in"),a(318,[1650,-455,-2240],M,{chase:1,fov:54},"linear"),a(320,[1650,-455,-2240],M,{chase:1,caption:"Atmospheric entry|Galileo · plasma sheath and ion trail"},"linear"),a(326,[1650,-455,-2240],M,{chase:1,fov:62},"linear"),a(326.05,[1755,-420,-2162],_,{chase:0,fov:30,dof:.3},"linear"),a(330,[1750,-417,-2158],_,{caption:""},"linear"),a(334,[1740,-410,-2150],_,{fov:26},"out"),l(335,h("stern"),d("stern"),{shipX:0,shipY:0,shipZ:0,shipYaw:0,shipPitch:0,shipRoll:0,hangar:!1,descent:!1,fov:40,score:"swell",dof:.2,caption:"U.S.S. ENTERPRISE|Built in Three.js · every part parametric · no imported models"}),a(340,[110,40,-470],[0,-12,-40],{warp:!0},"in"),a(342.5,[90,37,-530],[0,-12,-100],{caption:""}),a(343.5,[80,36,-560],[0,-12,-120],{caption:"Music: Scott Buckley — Starfire · Aphelion · Legionnaire|CC-BY 4.0 · www.scottbuckley.com.au · Effects: Kenney (CC0)"}),a(348,[40,39,-800],[0,-12,-240],{caption:""}),a(349,[30,40,-880],[0,-12,-280],{caption:"Boldly go.|"}),a(353,[20,40,-950],[0,-12,-300],{fov:46,fade:0},"linear"),a(355.5,[16,40,-990],[0,-12,-320],{fade:1,caption:""},"linear"),a(356,[16,40,-990],[0,-12,-320],{fade:1,score:"off"},"linear"),{name:"Showcase film",path:"curve",keys:s}}const Vr={linear:i=>i,smooth:i=>i*i*(3-2*i),in:i=>i*i*i,out:i=>1-Math.pow(1-i,3),inout:i=>i<.5?4*i*i*i:1-Math.pow(-2*i+2,3)/2},Nv=["mode","light","warp","labels","markers","hangar","shuttle","descent","phasers","torpedo","klingon","disruptor","alert","romulan","plasma","caption","score"],vu=["clip","explode","fov","shipX","shipY","shipZ","shipYaw","shipPitch","shipRoll","lift","liftDoors","liftCam","chase","dof","focus","cloak","fade"];function fa(i,t){return{t:i,pos:[...t.pos],target:[...t.target],state:{...t.state},ease:"smooth"}}function Fv(i){const t={name:"Untitled clip",keys:[],path:"curve",time:0,playing:!1,loop:!1,rate:1,listeners:new Set,lastDiscrete:null,_posCurve:null,_tgtCurve:null,_dirty:!0},e=(_,T)=>t.listeners.forEach(b=>b(_,T));function n(){return t.keys.length?t.keys[t.keys.length-1].t:0}function s(){t.keys.sort((_,T)=>_.t-T.t),t._dirty=!0}function r(){if(t._dirty)if(t._dirty=!1,t.keys.length>=2){const _=t.keys.map(b=>new R(...b.pos)),T=t.keys.map(b=>new R(...b.target));t._posCurve=new gs(_,!1,"centripetal",.5),t._tgtCurve=new gs(T,!1,"centripetal",.5)}else t._posCurve=t._tgtCurve=null}function o(_){const T=i.captureState(),b=t.keys.find(C=>Math.abs(C.t-_)<.05);if(b)return Object.assign(b,fa(b.t,T),{ease:b.ease}),t._dirty=!0,e("change"),b;const v=fa(_,T);return t.keys.push(v),s(),e("change"),v}function a(_){const T=i.captureState();Object.assign(_,fa(_.t,T),{ease:_.ease}),t._dirty=!0,e("change")}function c(_){t.keys=t.keys.filter(T=>T!==_),t._dirty=!0,e("change")}function l(_,T){_.t=Math.max(0,T),s(),e("change")}function u(_){r();const T=t.keys;if(!T.length)return null;if(T.length===1||_<=T[0].t){const B=T[0];return{pos:new R(...B.pos),target:new R(...B.target),state:{...B.state},index:0}}const b=T[T.length-1];if(_>=b.t)return{pos:new R(...b.pos),target:new R(...b.target),state:{...b.state},index:T.length-1};let v=0;for(;v<T.length-2&&_>=T[v+1].t;)v++;const C=T[v],S=T[v+1],y=Math.max(1e-4,S.t-C.t),P=(_-C.t)/y,W=(Vr[S.ease]||Vr.smooth)(Math.min(1,Math.max(0,P)));let q,V;if(t.path==="curve"&&T.length>=3){const B=T.length-1;q=t._posCurve.getPoint((v+W)/B),V=t._tgtCurve.getPoint((v+W)/B)}else q=new R(...C.pos).lerp(new R(...S.pos),W),V=new R(...C.target).lerp(new R(...S.target),W);const O={...C.state};for(const B of vu)typeof C.state[B]=="number"&&typeof S.state[B]=="number"&&(O[B]=C.state[B]+(S.state[B]-C.state[B])*W);return{pos:q,target:V,state:O,index:v}}function h(_){if(!_)return;i.setCameraDirect(_.pos,_.target);const T={};for(const C of Nv)T[C]=_.state[C];const b=JSON.stringify(T);b!==t.lastDiscrete&&(t.lastDiscrete=b,i.applyDiscrete(T));const v={};for(const C of vu)typeof _.state[C]=="number"&&(v[C]=_.state[C]);i.applyContinuous(v)}function d(_){t.time=Math.min(Math.max(0,_),n()),h(u(t.time)),e("time",t.time)}function f(){t.keys.length<2||(t.time>=n()-.001&&(t.time=0),t.playing=!0,t.lastDiscrete=null,i.setPlayback(!0),e("play"))}function g(){t.playing=!1,i.setPlayback(!1),e("pause")}function x(){g(),t.time=0,e("time",t.time)}function m(_){if(!t.playing)return;t.time+=_*t.rate;const T=n();if(t.time>=T)if(t.loop)t.time=t.time%Math.max(T,.001),t.lastDiscrete=null;else{t.time=T,h(u(t.time)),e("time",t.time),g(),e("ended");return}h(u(t.time)),e("time",t.time)}function p(){return{version:1,name:t.name,path:t.path,keys:t.keys}}function w(_){if(!_||!Array.isArray(_.keys))throw new Error("Not a clip file");t.name=_.name||"Untitled clip",t.path=_.path==="linear"?"linear":"curve",t.keys=_.keys.map(T=>({t:Number(T.t)||0,pos:T.pos.map(Number),target:T.target.map(Number),state:{...T.state||{}},ease:Vr[T.ease]?T.ease:"smooth"})),s(),t.time=0,e("change"),e("time",0)}function M(_){t.path=_,t._dirty=!0,e("change")}return{seq:t,duration:n,addKeyAt:o,updateKey:a,removeKey:c,setKeyTime:l,sample:u,seek:d,play:f,pause:g,stop:x,tick:m,toJSON:p,fromJSON:w,setPath:M,on(_){return t.listeners.add(_),()=>t.listeners.delete(_)},EASES:Object.keys(Vr)}}function yu(i,t,e,n={}){if(e={...e,...{shipX:0,shipY:0,shipZ:0,shipYaw:0,shipPitch:0,shipRoll:0,markers:!1,labels:!1,hangar:!1,shuttle:!1,phasers:!1,torpedo:!1,klingon:!1,disruptor:!1,alert:!1,romulan:!1,plasma:!1,cloak:1,descent:!1,chase:0,lift:0,liftDoors:0,liftCam:0,caption:"",score:"off",fade:0}},i==="film")return Uv(t,e,n);const r=(o,a,c={},l="smooth")=>({t:o,pos:[...t[a].pos],target:[...t[a].target],state:{...e,...c},ease:l});switch(i){case"flyby":return{name:"Fly-by",path:"curve",keys:[r(0,"bow",{fov:34}),r(6,"beauty",{fov:40}),r(11,"nacelle",{fov:44}),r(16,"stern",{fov:40}),r(22,"profile",{fov:36},"out")]};case"reveal":return{name:"Cutaway reveal",path:"curve",keys:[r(0,"beauty",{mode:"exterior"}),r(5,"profile",{mode:"exterior"}),r(6,"profile",{mode:"cutaway",clip:.5}),r(14,"profile",{mode:"cutaway",clip:.8},"linear"),r(20,"deflector",{mode:"cutaway",clip:.5}),r(26,"hangar",{mode:"cutaway",clip:.5}),r(32,"beauty",{mode:"exterior"},"out")]};case"warp":return{name:"Warp jump",path:"curve",keys:[r(0,"stern",{light:"space",warp:!1,fov:40}),r(5,"nacelle",{light:"space",warp:!1,fov:40}),r(7,"nacelle",{light:"space",warp:!0,fov:48},"in"),r(13,"bow",{light:"space",warp:!0,fov:60}),r(19,"beauty",{light:"space",warp:!0,fov:40},"out")]};case"battle":{const o={light:"space",klingon:!0,alert:!0},a={pos:[-140,30,330],target:[40,-30,500]},c=(l,u,h,d={},f="smooth")=>({t:l,pos:[...u],target:[...h],state:{...e,...o,...d},ease:f});return{name:"Battle stations",path:"curve",keys:[{t:0,pos:[...t.bridgeIn.pos],target:[...t.bridgeIn.target],state:{...e,light:"space",klingon:!0,alert:!0,fov:64},ease:"smooth"},{t:3.5,pos:[2.4,13.1,74],target:[-1,12.4,84],state:{...e,light:"space",klingon:!0,alert:!0,fov:60},ease:"smooth"},c(3.6,[-260,40,260],[0,-10,300],{fov:44},"linear"),c(7.5,a.pos,a.target,{fov:40,disruptor:!0}),c(7.9,a.pos,a.target,{fov:40,disruptor:!1}),c(10.5,[60,-20,200],[60,-30,700],{fov:42,phasers:!0}),c(10.9,[60,-20,200],[60,-30,700],{fov:42,phasers:!1}),c(13.5,[-30,20,180],[80,-40,800],{fov:40,torpedo:!0,disruptor:!0}),c(13.9,[-30,20,180],[80,-40,800],{fov:40,torpedo:!1,disruptor:!1}),c(17.5,[220,60,620],[60,-30,780],{fov:36,phasers:!0},"linear"),c(17.9,[220,60,620],[60,-30,780],{fov:36,phasers:!1},"linear"),c(22.5,[420,40,160],[0,-10,0],{fov:40,torpedo:!0}),c(22.9,[420,40,160],[0,-10,0],{fov:40,torpedo:!1}),c(28.5,[70,24,-420],[0,-12,-40],{fov:40,warp:!0},"in"),c(34.5,[10,30,-900],[0,-12,-300],{fov:48,warp:!0,alert:!1},"out")]}}case"orbit":{const o={shipX:1550,shipY:-450,shipZ:-2150,shipYaw:-.69,shipPitch:.04,shipRoll:.08},a={light:"space",hangar:!0,...o},c=(d,f,g,x={},m="smooth")=>({t:d,pos:[...f],target:[...g],state:{...e,...a,...x},ease:m}),l=[o.shipX,o.shipY,o.shipZ],u=[1595,-485,-2204],h=[1882,-642,-2552];return{name:"Orbit insertion",path:"curve",keys:[c(0,[1290,-300,-1860],l,{fov:42,hangar:!1,dof:.25}),c(8,[1380,-380,-1960],[1580,-470,-2190],{fov:40,hangar:!0,dof:.25}),c(9,[1660,-462,-2262],u,{fov:46,hangar:!0,descent:!0,dof:.35}),c(17,[1650,-455,-2240],u,{fov:48,hangar:!0,descent:!0,dof:.35}),c(20,[1650,-455,-2240],u,{fov:50,descent:!0,chase:1,dof:.2},"in"),c(44,[1650,-455,-2240],u,{fov:54,descent:!0,chase:1,dof:.2},"linear"),c(52,[1650,-455,-2240],u,{fov:62,descent:!0,chase:1,dof:.2},"linear"),c(52.05,[1755,-420,-2162],h,{fov:30,descent:!0,chase:0,dof:.3},"linear"),c(60,[1740,-410,-2150],h,{fov:26,descent:!0,dof:.3,hangar:!1},"out")]}}case"neutralzone":{const o={light:"space",romulan:!0},a=(c,l,u,h={},d="smooth")=>({t:c,pos:[...l],target:[...u],state:{...e,...o,...h},ease:d});return{name:"Neutral Zone",path:"curve",keys:[a(0,[-60,30,250],[-360,24,540],{fov:40,cloak:1,dof:.3}),a(4,[-90,34,300],[-360,24,540],{fov:36,cloak:1,dof:.3}),a(4.5,[-90,34,300],[-360,24,540],{fov:36,cloak:0,alert:!0},"linear"),a(10,[-200,40,420],[-360,24,540],{fov:34,cloak:0,alert:!0}),a(12,[-200,40,420],[-360,24,540],{fov:34,cloak:0,alert:!0,plasma:!0}),a(12.4,[-200,40,420],[-360,24,540],{fov:34,cloak:0,alert:!0,plasma:!1}),a(16,[120,40,160],[-200,20,400],{fov:44,cloak:0,alert:!0}),a(18.5,[120,40,160],[-200,20,400],{fov:44,cloak:0,alert:!0,phasers:!0}),a(18.9,[120,40,160],[-200,20,400],{fov:44,cloak:0,alert:!0,phasers:!1}),a(22,[-250,60,480],[-360,24,540],{fov:38,cloak:0,alert:!0,torpedo:!0}),a(22.4,[-250,60,480],[-360,24,540],{fov:38,cloak:0,alert:!0,torpedo:!1}),a(26,[-250,60,480],[-360,24,540],{fov:38,cloak:0,alert:!0}),a(26.5,[-250,60,480],[-360,24,540],{fov:38,cloak:1,alert:!0},"linear"),a(33,[-120,40,330],[-360,24,540],{fov:42,cloak:1,alert:!1},"out")]}}case"turbolift":{const o=n.lift;if(!o)return null;const a=t.bridgeIn,c=t.engineeringIn,l=(h,d,f,g={},x="smooth")=>({t:d,pos:o.cameraAt(h).toArray(),target:o.lookAt(h).toArray(),state:{...e,fov:70,lift:h,liftDoors:f,liftCam:1,...g},ease:x});return{name:"Turbolift ride",path:"linear",keys:[{t:0,pos:[...a.pos],target:[...a.target],state:{...e,fov:64,lift:0,liftDoors:0,liftCam:0},ease:"smooth"},{t:4,pos:[.4,12.9,75.5],target:[0,12.3,69],state:{...e,fov:66,lift:0,liftDoors:0,liftCam:0},ease:"smooth"},{t:6.5,pos:[.2,12.8,72.6],target:[0,12.3,68],state:{...e,fov:68,lift:0,liftDoors:1,liftCam:0},ease:"smooth"},l(0,6.55,1,{},"linear"),l(0,8.5,1,{},"linear"),l(0,10,0,{},"linear"),l(.12,13.5,0,{},"in"),l(.5,20,0,{},"linear"),l(.88,26.5,0,{},"linear"),l(1,30,0,{},"out"),l(1,31.5,1,{},"smooth"),{t:35,pos:[...c.pos],target:[...c.target],state:{...e,fov:62,lift:1,liftDoors:1,liftCam:0},ease:"smooth"},{t:39,pos:[-1.5,-31,-19],target:[0,-31.5,-30],state:{...e,fov:62,lift:1,liftDoors:0,liftCam:0},ease:"out"}]}}case"launch":return{name:"Shuttle launch",path:"curve",keys:[r(0,"stern",{light:"space",fov:40}),r(4,"hangar",{light:"space",hangar:!0,fov:44}),r(9,"hangar",{light:"space",hangar:!0,shuttle:!0,fov:44},"linear"),r(18,"stern",{light:"space",hangar:!0,shuttle:!0,fov:38}),r(26,"beauty",{light:"space",hangar:!1,shuttle:!1,fov:40},"out")]};case"flypast":{const o={pos:[0,30,520],target:[0,-10,0]},a=(c,l,u,h,d,f,g={},x="linear")=>({t:c,pos:[...o.pos],target:[...o.target],state:{...e,fov:46,shipX:l,shipY:u,shipZ:h,shipYaw:d,shipPitch:0,shipRoll:f,...g},ease:x});return{name:"Fly-past",path:"linear",keys:[a(0,-700,-80,-400,.9,0,{light:"space"}),a(6,-120,-20,60,.7,-.25,{light:"space"}),a(12,380,40,260,.35,-.45,{light:"space"}),a(18,1100,120,520,.1,-.1,{light:"space",warp:!0},"in")]}}case"circle":{const o=[],a=t.beauty.target,c=380;for(let l=0;l<=8;l++){const u=l/8*Math.PI*2+Math.PI/4;o.push({t:l*4,pos:[a[0]+Math.cos(u)*c,70+Math.sin(u*2)*40,a[2]+Math.sin(u)*c],target:[...a],state:{...e},ease:"linear"})}return{name:"Circle",path:"curve",keys:o}}default:return null}}async function Ov({canvas:i,duration:t,fps:e,step:n,onProgress:s,shouldCancel:r}){if(typeof window.showDirectoryPicker!="function")throw new Error("Folder access is not available in this browser; use WebM recording instead.");const o=await window.showDirectoryPicker({mode:"readwrite"}),a=Math.max(1,Math.round(t*e)),c=()=>new Promise(l=>i.toBlob(l,"image/png"));for(let l=0;l<=a;l++){if(r?.())return l;n(l/e);const u=await c(),d=await(await o.getFileHandle(`frame_${String(l).padStart(5,"0")}.png`,{create:!0})).createWritable();await d.write(u),await d.close(),s?.(l,a),await new Promise(f=>setTimeout(f,0))}return a+1}function Bv(i){let t=null,e=[];return{get active(){return!!t&&t.state==="recording"},start({fps:n=60,bitrate:s=24e6,audioTrack:r=null}={}){const o=i.captureStream(n);r&&o.addTrack(r);const a=["video/webm;codecs=vp9","video/webm;codecs=vp8","video/webm"].find(c=>MediaRecorder.isTypeSupported(c));return t=new MediaRecorder(o,{mimeType:a,videoBitsPerSecond:s}),e=[],t.ondataavailable=c=>{c.data.size&&e.push(c.data)},t.start(250),a},stop(){return new Promise(n=>{if(!t)return n(null);t.onstop=()=>{const s=new Blob(e,{type:t.mimeType});t=null,n(s)},t.stop()})}}}const Mu="enterprise.clip.v1";function kv(i,{status:t,setUIHidden:e}){const n=Fv(i);i.sequencer=n;const s=Bv(i.canvas),r=L=>document.getElementById(L),o=r("editor"),a=r("ed-list"),c=r("ed-track"),l=r("ed-timeline"),u=r("ed-playhead"),h=r("ed-time"),d=r("ed-play"),f=r("ed-key-time"),g=r("ed-ease"),x=r("ed-path"),m=r("ed-fov"),p=r("ed-fov-val"),w=r("ed-name"),M=r("letterbox");let _=null,T=!1,b=null;i.onPlaybackTick(L=>n.tick(L));const v=L=>L.toFixed(2);function C(){return Math.max(n.duration(),1)}function S(){c.innerHTML="";const L=C(),U=Math.min(60,Math.ceil(L));for(let G=0;G<=U;G++){const k=document.createElement("i");k.className="ed-tick"+(G%5===0?" major":""),k.style.left=`${G/L*100}%`,c.appendChild(k)}n.seq.keys.forEach((G,k)=>{const j=document.createElement("button");j.className="ed-key"+(G===_?" selected":""),j.style.left=`${G.t/L*100}%`,j.title=`Keyframe ${k+1} · ${v(G.t)} s · ${G.state.mode}`,j.dataset.index=String(k),j.addEventListener("pointerdown",D=>B(D,G)),c.appendChild(j)}),y(),P()}function y(){a.innerHTML="",n.seq.keys.forEach((L,U)=>{const G=document.createElement("li");G.className=L===_?"selected":"";const k=[L.state.mode,L.state.light,L.state.warp?"warp":null,L.state.hangar?"doors":null,L.state.shuttle?"launch":null,L.state.phasers?"phasers":null,L.state.torpedo?"torpedo":null,L.state.klingon?"D7":null,L.state.disruptor?"disruptor":null,L.state.romulan?L.state.cloak>.5?"BoP cloaked":"BoP":null,L.state.plasma?"plasma":null,L.state.descent?"descent":null,L.state.chase>0?"chase cam":null,L.state.alert?"red alert":null,`fov ${Math.round(L.state.fov||40)}°`].filter(Boolean).join(" · ");G.innerHTML=`<span class="ed-mono">${String(U+1).padStart(2,"0")}</span><span class="ed-mono">${v(L.t)}s</span><span>${k}</span><span class="ed-mono dim">${L.ease}</span>`,G.addEventListener("click",()=>{W(L),n.seek(L.t)}),a.appendChild(G)})}function P(){const L=C();u.style.left=`${n.seq.time/L*100}%`,h.textContent=`${v(n.seq.time)} / ${v(n.duration())} s`,d.textContent=n.seq.playing?"⏸":"▶"}function W(L){_=L,f.value=L?v(L.t):"",g.value=L?L.ease:"smooth",r("ed-fx-phasers").checked=!!L?.state.phasers,r("ed-fx-torpedo").checked=!!L?.state.torpedo,r("ed-fx-disruptor").checked=!!L?.state.disruptor,r("ed-fx-plasma").checked=!!L?.state.plasma,L&&typeof L.state.fov=="number"&&(m.value=String(Math.round(L.state.fov)),p.textContent=`${Math.round(L.state.fov)}°`),S()}n.on(L=>{L==="change"?(_&&!n.seq.keys.includes(_)&&(_=null),S(),b||it()):L==="time"?(P(),X()):L==="play"||L==="pause"?(P(),Z.checked&&!T&&(e(n.seq.playing,"playback"),M.hidden=!n.seq.playing)):L==="ended"&&(T?Q():b&&V())});async function q(){if(b)return;const L=i.captureState().state,U=yu("film",i.cameras,L,{lift:i.ship.userData.turbolift});U&&(b={saved:n.toJSON(),soundWas:i.audio.enabled,cinemaWas:Z.checked},i.audio.enabled||i.audio.setEnabled(!0),i.onSoundChanged?.(!0),n.pause(),n.fromJSON(U),w.textContent=U.name,x.value=n.seq.path,n.seq.loop=!1,n.seq.rate=1,e(!0,"film"),M.hidden=!1,i.setFade?.(1),n.seek(0),t.textContent="Loading sound library…",await Promise.race([i.audio.whenReady(),new Promise(G=>setTimeout(G,6e3))]),b&&(n.play(),t.textContent=`${U.name} · ${Math.round(n.duration())} s · Esc to stop`))}function V(){if(!b)return;const L=b;b=null,n.pause(),i.audio.score?.("off"),i.setCaption?.(""),i.setFade?.(0),e(!1,"film"),M.hidden=!(Z.checked&&n.seq.playing),i.applyDiscrete({warp:!1,alert:!1,klingon:!1,romulan:!1,hangar:!1,shuttle:!1,descent:!1,mode:"exterior",light:"space"}),i.applyContinuous({shipX:0,shipY:0,shipZ:0,shipYaw:0,shipPitch:0,shipRoll:0,dof:0,explode:0,lift:0,liftDoors:0}),i.recallShuttle(),L.soundWas||(i.audio.setEnabled(!1),i.onSoundChanged?.(!1));const U=L.saved&&L.saved.name!=="Showcase film"?L.saved:{name:"Untitled clip",path:"curve",keys:[]};n.fromJSON(U),w.textContent=n.seq.name,x.value=n.seq.path,n.seq.keys.length&&n.seek(0),i.setCaption?.(""),i.setFade?.(0),i.goCamera("beauty",!1),t.textContent="Showcase film ended · manual control"}i.playFilm=q,i.stopFilm=V,Object.defineProperty(i,"filmPlaying",{get:()=>!!b}),addEventListener("keydown",L=>{L.key==="Escape"&&b&&V()});function O(L){const U=l.getBoundingClientRect();return Math.min(1,Math.max(0,(L-U.left)/U.width))*C()}l.addEventListener("pointerdown",L=>{if(L.target.classList.contains("ed-key"))return;const U=O(L.clientX);if(L.shiftKey){W(n.addKeyAt(Math.round(U*10)/10));return}n.pause(),n.seek(U);const G=j=>n.seek(O(j.clientX)),k=()=>{removeEventListener("pointermove",G),removeEventListener("pointerup",k)};addEventListener("pointermove",G),addEventListener("pointerup",k)});function B(L,U){L.stopPropagation(),L.preventDefault(),W(U);const G=L.clientX,k=U.t;let j=!1;const D=rt=>{const xt=l.getBoundingClientRect(),ct=(rt.clientX-G)/xt.width*C();Math.abs(rt.clientX-G)>2&&(j=!0),U.t=Math.max(0,Math.round((k+ct)*20)/20),f.value=v(U.t),n.seq._dirty=!0,S()},mt=()=>{removeEventListener("pointermove",D),removeEventListener("pointerup",mt),n.setKeyTime(U,U.t),j||n.seek(U.t)};addEventListener("pointermove",D),addEventListener("pointerup",mt)}r("ed-add").addEventListener("click",()=>{const L=n.seq.keys.length?Math.max(n.seq.time,0):0,U=Math.round(L*10)/10,G=n.addKeyAt(U);W(G),t.textContent=`Keyframe ${n.seq.keys.indexOf(G)+1} captured at ${v(G.t)} s`}),r("ed-update").addEventListener("click",()=>{_&&(n.updateKey(_),t.textContent="Keyframe updated from the current view")}),r("ed-delete").addEventListener("click",()=>{_&&(n.removeKey(_),_=null,S())}),f.addEventListener("change",()=>{_&&(n.setKeyTime(_,Number(f.value)||0),W(_))}),g.addEventListener("change",()=>{_&&(_.ease=g.value,n.seq._dirty=!0,S(),it())}),x.addEventListener("change",()=>n.setPath(x.value));for(const[L,U]of[["ed-fx-phasers","phasers"],["ed-fx-torpedo","torpedo"],["ed-fx-disruptor","disruptor"],["ed-fx-plasma","plasma"]])r(L).addEventListener("change",G=>{_&&(_.state[U]=G.target.checked,S(),it())});m.addEventListener("input",()=>{i.setFov(Number(m.value)),p.textContent=`${m.value}°`}),w.addEventListener("input",()=>{n.seq.name=w.textContent.trim()||"Untitled clip",it()}),d.addEventListener("click",()=>n.seq.playing?n.pause():n.play()),r("ed-first").addEventListener("click",()=>{n.pause(),n.seek(0)}),r("ed-last").addEventListener("click",()=>{n.pause(),n.seek(n.duration())}),r("ed-loop").addEventListener("change",L=>n.seq.loop=L.target.checked),r("ed-rate").addEventListener("change",L=>n.seq.rate=Number(L.target.value)||1);const Z=r("ed-cinema"),H={x:"pose-x",y:"pose-y",z:"pose-z",yaw:"pose-yaw",pitch:"pose-pitch",roll:"pose-roll"},Y=Math.PI/180;function vt(){return{x:Number(r(H.x).value),y:Number(r(H.y).value),z:Number(r(H.z).value),yaw:Number(r(H.yaw).value)*Y,pitch:Number(r(H.pitch).value)*Y,roll:Number(r(H.roll).value)*Y}}function X(){const L=i.getShipPose();r(H.x).value=String(Math.round(L.x)),r(H.y).value=String(Math.round(L.y)),r(H.z).value=String(Math.round(L.z)),r(H.yaw).value=String(Math.round(L.yaw/Y)),r(H.pitch).value=String(Math.round(L.pitch/Y)),r(H.roll).value=String(Math.round(L.roll/Y))}for(const L of Object.values(H))r(L).addEventListener("input",()=>i.setShipPose(vt()));r("pose-reset").addEventListener("click",()=>{i.setShipPose({x:0,y:0,z:0,yaw:0,pitch:0,roll:0}),X()}),r("ed-clear").addEventListener("click",()=>{n.seq.keys.length&&confirm("Remove all keyframes from this clip?")&&(n.pause(),n.fromJSON({name:n.seq.name,path:n.seq.path,keys:[]}))}),r("ed-preset").addEventListener("change",L=>{const U=L.target.value;if(L.target.value="",!U)return;const G=i.captureState().state,k=yu(U,i.cameras,G,{lift:i.ship.userData.turbolift});k&&(n.pause(),n.fromJSON(k),w.textContent=k.name,x.value=n.seq.path,n.seek(0),t.textContent=`Preset loaded · ${k.name} (${k.keys.length} keyframes, ${v(n.duration())} s)`)}),r("ed-save").addEventListener("click",()=>{const L=new Blob([JSON.stringify(n.toJSON(),null,2)],{type:"application/json"}),U=document.createElement("a");U.href=URL.createObjectURL(L),U.download=`${(n.seq.name||"clip").replace(/[^\w-]+/g,"-").toLowerCase()}.clip.json`,U.click(),setTimeout(()=>URL.revokeObjectURL(U.href),5e3),t.textContent="Clip saved as JSON"}),r("ed-load").addEventListener("click",()=>r("ed-file").click()),r("ed-file").addEventListener("change",async L=>{const U=L.target.files?.[0];if(L.target.value="",!!U)try{n.pause(),n.fromJSON(JSON.parse(await U.text())),w.textContent=n.seq.name,x.value=n.seq.path,n.seek(0),t.textContent=`Clip loaded · ${n.seq.name}`}catch(G){console.error(G),t.textContent="Could not read that clip file"}});const et=r("ed-record");async function ft(){if(n.seq.keys.length<2){t.textContent="Add at least two keyframes before recording";return}if(typeof MediaRecorder>"u"){t.textContent="MediaRecorder is not available in this browser";return}const L=r("ed-res").value,U=Number(r("ed-fps").value);if(L!=="window"){const[D,mt]=L.split("x").map(Number);i.setRenderSize(D,mt)}const G=i.canvas.width*i.canvas.height,k=Math.min(8e7,Math.max(12e6,G*U*.12));T=!0,et.classList.add("active"),et.textContent="■ Stop",e(!0,"recording"),M.hidden=!0,n.pause(),n.seek(0),await new Promise(D=>setTimeout(D,250));const j=s.start({fps:U,bitrate:k,audioTrack:i.audio?.recordingTrack()});t.textContent=`Recording ${i.canvas.width}×${i.canvas.height} @ ${U} fps (${j})`,n.seq.loop=!1,r("ed-loop").checked=!1,n.play()}async function Q(){if(!T)return;T=!1,n.pause();const L=i.canvas.height,U=await s.stop();if(i.restoreRenderSize(),e(!1,"recording"),et.classList.remove("active"),et.textContent="● Record",U&&U.size){const G=document.createElement("a");G.href=URL.createObjectURL(U),G.download=`${(n.seq.name||"clip").replace(/[^\w-]+/g,"-").toLowerCase()}-${L}p.webm`,G.click(),setTimeout(()=>URL.revokeObjectURL(G.href),1e4),t.textContent=`Recording saved · ${(U.size/1048576).toFixed(1)} MB WebM`}else t.textContent="Recording produced no data"}et.addEventListener("click",()=>T?Q():ft());const nt=r("ed-frames");let gt=!1;nt.addEventListener("click",async()=>{if(nt.classList.contains("active")){gt=!0;return}if(n.seq.keys.length<2){t.textContent="Add at least two keyframes before rendering";return}const L=r("ed-res").value,U=Number(r("ed-fps").value);gt=!1;try{if(n.pause(),L!=="window"){const[k,j]=L.split("x").map(Number);i.setRenderSize(k,j)}e(!0,"recording"),nt.classList.add("active"),nt.textContent="■ Stop",i.setPlayback(!0);const G=await Ov({canvas:i.canvas,duration:n.duration(),fps:U,step:k=>{n.seek(k),i.camera.lookAt(i.controls.target),i.renderOnce()},onProgress:(k,j)=>{t.textContent=`Rendering frame ${k+1} / ${j+1} · ${i.canvas.width}×${i.canvas.height}`},shouldCancel:()=>gt});t.textContent=gt?`Render stopped after ${G} frames`:`Rendered ${G} PNG frames at ${U} fps`}catch(G){console.error(G),t.textContent=G?.name==="AbortError"?"Render cancelled":`Render failed · ${G.message}`}finally{i.setPlayback(!1),i.restoreRenderSize(),e(!1,"recording"),nt.classList.remove("active"),nt.textContent="Render PNGs"}});function it(){try{localStorage.setItem(Mu,JSON.stringify(n.toJSON()))}catch{}}try{const L=localStorage.getItem(Mu),U=L?JSON.parse(L):null;U&&U.name!=="Showcase film"&&(n.fromJSON(U),w.textContent=n.seq.name,x.value=n.seq.path)}catch{}function st(L){o.hidden=!L,document.getElementById("app").classList.toggle("editor-open",L),r("editor-toggle").classList.toggle("active",L),L?S():n.seq.playing&&n.pause()}return r("editor-toggle").addEventListener("click",()=>st(o.hidden)),r("ed-close").addEventListener("click",()=>st(!1)),addEventListener("keydown",L=>{if(L.target.tagName==="INPUT"||L.target.tagName==="SELECT"||L.target.isContentEditable||L.metaKey||L.ctrlKey||L.altKey)return;const U=L.key.toLowerCase();U==="c"&&st(o.hidden),!o.hidden&&(U===" "?(L.preventDefault(),n.seq.playing?n.pause():n.play()):U==="k"?r("ed-add").click():U==="delete"||U==="backspace"?r("ed-delete").click():U==="home"?r("ed-first").click():U==="end"?r("ed-last").click():(U===","||U===".")&&(n.pause(),n.seek(n.seq.time+(U==="."?1/30:-1/30))))}),S(),{sequencer:n,setOpen:st,get recording(){return T}}}function zv(i){const t=document.getElementById("status"),e=document.getElementById("app"),n=2500,s=new Set;let r=null,o=!1;const a=document.getElementById("ui-tab");function c(z,A="user"){z?s.add(A):s.delete(A);const E=s.size>0;e.classList.toggle("ui-hidden",E),a.hidden=!s.has("user"),document.getElementById("hide-ui").classList.toggle("active",s.has("user"))}function l(){clearTimeout(r),r=setTimeout(()=>{o||e.classList.add("ui-idle")},n)}function u(){e.classList.remove("ui-idle"),l()}addEventListener("pointermove",u,{passive:!0}),addEventListener("pointerdown",u,{passive:!0}),addEventListener("keydown",u),document.querySelectorAll(".hud").forEach(z=>{z.addEventListener("pointerenter",()=>{o=!0,u()}),z.addEventListener("pointerleave",()=>{o=!1,l()})}),l(),document.getElementById("hide-ui").addEventListener("click",()=>c(!s.has("user"),"user")),a.addEventListener("click",()=>c(!1,"user"));const h=document.getElementById("mode-label"),d=document.getElementById("cam-label"),f=document.getElementById("part-note"),g=(z,A)=>{document.querySelectorAll(`[data-${z}]`).forEach(E=>{E.classList.toggle("active",E.dataset[z]===A)})},x={exterior:"Primary hull · command saucer",cutaway:"Longitudinal cutaway · drag Clip to sweep the section plane",explode:"Separated primary, dorsal, engineering, pylons, and warp units",blueprint:"Flat study lighting for silhouette checks",decks:"Horizontal section · drag Deck (or ↑/↓) to step through all 23 decks"},m=document.getElementById("deck"),p=document.getElementById("deck-val");m.addEventListener("input",z=>{i.setDeck(Number(z.target.value),!0)}),i.onDeckChanged(z=>{p.textContent=`${z.id} · ${z.name}`,m.value=String(z.id),t.textContent=`Deck ${z.id} · ${z.name}`,i.state.mode==="decks"&&(g("mode","decks"),h.textContent="Deck plans")}),document.querySelectorAll("[data-mode]").forEach(z=>{z.addEventListener("click",()=>{i.applyMode(z.dataset.mode),h.textContent=z.textContent,g("mode",z.dataset.mode),t.textContent=`Study mode · ${z.textContent}`,f.textContent=x[z.dataset.mode]||x.exterior})}),document.querySelectorAll("[data-light]").forEach(z=>{z.addEventListener("click",()=>{i.applyLight(z.dataset.light),g("light",z.dataset.light),t.textContent=`Lighting · ${z.textContent}`})}),document.querySelectorAll("[data-cam]").forEach(z=>{z.addEventListener("click",()=>{i.goCamera(z.dataset.cam),d.textContent=z.textContent,g("cam",z.dataset.cam),t.textContent=`Camera · ${z.textContent}`})}),document.getElementById("explode").addEventListener("input",z=>{i.setExplode(Number(z.target.value)/100),t.textContent=`Explode ${z.target.value}%`}),document.getElementById("clip").addEventListener("input",z=>{i.setClip(Number(z.target.value)/100),t.textContent=`Section plane ${z.target.value}%`}),document.getElementById("auto-orbit").addEventListener("change",z=>{i.state.autoOrbit=z.target.checked}),document.getElementById("labels").addEventListener("change",z=>{i.setLabels(z.target.checked)}),document.getElementById("grid").addEventListener("change",z=>{i.setGrid(z.target.checked)}),document.getElementById("ortho").addEventListener("change",z=>{i.setOrtho(z.target.checked),t.textContent=z.target.checked?"Orthographic projection":"Perspective projection"}),document.getElementById("snapshot").addEventListener("click",()=>{i.savePNG(`uss-enterprise-${i.state.cam}-${i.state.mode}`),t.textContent="PNG saved"});const w=document.getElementById("dof"),M=document.getElementById("dof-aperture"),_=document.getElementById("dof-focus"),T=document.getElementById("dof-focus-val"),b=()=>{const z=Number(_.value);T.textContent=z<=0?"auto · orbit target":`${z} m`};w.addEventListener("change",z=>{i.setDof({enabled:z.target.checked}),t.textContent=z.target.checked?"Depth of field on · focus follows the orbit target unless set":"Depth of field off"}),M.addEventListener("input",z=>i.setDof({aperture:Number(z.target.value)/100})),_.addEventListener("input",z=>{const A=Number(z.target.value);i.setDof({focus:A,auto:A<=0}),b()}),i.onDofApplied(()=>{w.checked=i.dof.enabled,M.value=String(Math.round(i.dof.aperture*100)),_.value=String(i.dof.auto?0:Math.round(i.dof.focus)),b()}),document.getElementById("quality").addEventListener("change",z=>{i.setQuality(z.target.value),t.textContent=`Quality · ${z.target.value}`});function v(){const z=i.state,A=`#cam=${z.cam}&mode=${z.mode}&light=${z.light}${z.warp?"&warp=1":""}${i.ship.userData.hangar.isOpen?"&hangar=1":""}`;history.replaceState(null,"",A)}function C(){if(!location.hash)return;const z=new URLSearchParams(location.hash.slice(1)),A=z.get("mode"),E=z.get("light"),$=z.get("cam");E&&document.querySelector(`[data-light="${E}"]`)&&document.querySelector(`[data-light="${E}"]`).click(),A&&document.querySelector(`[data-mode="${A}"]`)&&document.querySelector(`[data-mode="${A}"]`).click(),$&&document.querySelector(`[data-cam="${$}"]`)&&(i.goCamera($,!1),d.textContent=document.querySelector(`[data-cam="${$}"]`).textContent,g("cam",$)),z.get("warp")==="1"&&i.setWarp(!0),z.get("hangar")==="1"&&i.setHangar(!0)}document.querySelectorAll("[data-mode],[data-light],[data-cam]").forEach(z=>z.addEventListener("click",()=>setTimeout(v,0))),C(),document.getElementById("hotspots").addEventListener("change",z=>{i.setHotspots(z.target.checked)});const S=document.getElementById("dossier-ship"),y=document.getElementById("dossier-system"),P=document.getElementById("sys-name"),W=document.getElementById("sys-body"),q=document.getElementById("sys-facts");i.onHotspot(z=>{P.textContent=z.name,W.textContent=z.body,q.innerHTML="";for(const A of z.facts){const E=document.createElement("li");E.textContent=A,q.appendChild(E)}S.hidden=!0,y.hidden=!1,t.textContent=`Inspecting · ${z.name}`}),document.getElementById("dossier-back").addEventListener("click",()=>{y.hidden=!0,S.hidden=!1,i.hotspots.selected=null,i.goCamera(i.state.cam)});const V=document.getElementById("ref-dx"),O=document.getElementById("ref-dy");i.reference.onLoad=z=>{t.textContent=`Reference loaded · ${z} — use Orthographic + Profile/Plan/Bow`},document.getElementById("ref-opacity").addEventListener("input",z=>i.reference.setOpacity(Number(z.target.value)/100)),document.getElementById("ref-width").addEventListener("input",z=>i.reference.setWidth(Number(z.target.value)));const B=()=>i.reference.setOffset(Number(V.value),Number(O.value));V.addEventListener("input",B),O.addEventListener("input",B);const Z=()=>i.reference.setFlip(document.getElementById("ref-flipx").checked,document.getElementById("ref-flipy").checked);document.getElementById("ref-flipx").addEventListener("change",Z),document.getElementById("ref-flipy").addEventListener("change",Z),document.getElementById("ref-rotate").addEventListener("click",()=>i.reference.rotate()),document.getElementById("ref-clear").addEventListener("click",()=>{i.reference.clear(),t.textContent="Reference cleared"});const H=z=>document.querySelector(z)?.click(),Y=z=>{const A=document.getElementById(z);A.checked=!A.checked,A.dispatchEvent(new Event("change"))};addEventListener("keydown",z=>{if(z.target.tagName==="INPUT"||z.target.tagName==="SELECT"||z.target.isContentEditable||z.metaKey||z.ctrlKey||z.altKey)return;const A=z.key.toLowerCase(),E=["beauty","bow","bridge","bridgeIn","transporterIn","sickbayIn","saucer","deflector","engineeringIn","hangar","nacelle","stern","profile","plan","belly"];if(A==="1")H('[data-mode="exterior"]');else if(A==="2")H('[data-mode="cutaway"]');else if(A==="3")H('[data-mode="explode"]');else if(A==="4")H('[data-mode="blueprint"]');else if(A==="5")H('[data-mode="decks"]');else if((A==="arrowup"||A==="arrowdown")&&i.state.mode==="decks"){z.preventDefault();const $=Math.min(23,Math.max(1,i.state.deck+(A==="arrowup"?-1:1)));i.setDeck($,!0)}else if(A==="t")H("#tour");else if(A==="v")H("#film");else if(A==="w")H("#warp");else if(A==="o")Y("ortho");else if(A==="l")Y("labels");else if(A==="m")Y("hotspots");else if(A==="g")Y("grid");else if(A==="r")Y("auto-orbit");else if(A==="p")H("#snapshot");else if(A==="e")H("#export");else if(A==="h")H("#hide-ui");else if(A==="b")H("#hangar-doors");else if(A==="j")H("#launch");else if(A==="f")H("#phasers");else if(A==="y")H("#torpedo");else if(A==="s")H("#sound");else if(A==="d")H("#klingon");else if(A==="x")Y("dof");else if(A==="a")H("#alert");else if(A==="n")H("#romulan");else if(A==="z")H("#cloak");else if(A==="arrowright"||A==="arrowleft"){const $=E.indexOf(i.state.cam),ut=E[($+(A==="arrowright"?1:E.length-1))%E.length];H(`[data-cam="${ut}"]`)}else A==="escape"&&document.getElementById("dossier-back").click()}),i.onDiscreteApplied(z=>{if(z.mode){g("mode",z.mode);const A=document.querySelector(`[data-mode="${z.mode}"]`);A&&(h.textContent=A.textContent)}z.light&&g("light",z.light),typeof z.labels=="boolean"&&(document.getElementById("labels").checked=z.labels),typeof z.markers=="boolean"&&(document.getElementById("hotspots").checked=z.markers)}),i.onWarpChanged(z=>et.classList.toggle("active",z)),kv(i,{status:t,setUIHidden:c});const vt=document.getElementById("loading");i.onReady(()=>{vt.classList.add("done"),setTimeout(()=>vt.remove(),900)});const X=document.getElementById("tour");X.addEventListener("click",()=>{const z=!i.state.tour;X.classList.toggle("active",z),i.setTour(z,A=>{const E=document.querySelector(`[data-cam="${A}"]`);E&&(d.textContent=E.textContent,g("cam",A)),t.textContent=`Auto tour · ${E?E.textContent:A}`}),z||(t.textContent="Auto tour ended · manual control")});const et=document.getElementById("warp");et.addEventListener("click",()=>{const z=!i.state.warp;i.setWarp(z),t.textContent=z?"Warp factor 6 · engage":"Sublight · impulse power"});const ft=document.getElementById("hangar-doors");ft.addEventListener("click",()=>{const z=!i.ship.userData.hangar.isOpen;i.setHangar(z),t.textContent=z?"Hangar doors opening":"Hangar doors closing"}),i.onHangarChanged(()=>ft.classList.toggle("active",i.ship.userData.hangar.isOpen)),document.getElementById("launch").addEventListener("click",()=>{i.ship.userData.hangar.launching?(i.recallShuttle(),t.textContent="Galileo recalled to the flight deck"):(i.launchShuttle(),t.textContent="Flight deck: Galileo cleared for launch")});const Q=document.getElementById("sound");Q.addEventListener("click",()=>{const z=!i.audio.enabled;i.audio.setEnabled(z),Q.classList.toggle("active",z),t.textContent=z?"Sound on · procedural engine hum and effects":"Sound off"}),i.onSoundChanged=z=>Q.classList.toggle("active",z),document.getElementById("sound-samples").addEventListener("change",z=>{i.audio.setUseSamples(z.target.checked),t.textContent=z.target.checked?"Sampled sound library":"Procedural synth only"});const nt=document.getElementById("audio-credits"),gt=()=>{const z=i.audio.credits();if(!z.length)return!1;const A=z.map(E=>`${E.work} — ${E.author} (${E.license})`);return nt.textContent=`Sound: ${A.join(" · ")}`,nt.hidden=!1,!0},it=setInterval(()=>{i.audio.samplesReady&&gt()&&clearInterval(it)},1500),st=document.getElementById("caption"),L=st.querySelector(".cap-title"),U=st.querySelector(".cap-sub"),G=document.getElementById("fade");i.setCaption=z=>{if(!z){st.classList.remove("show");return}const[A,E=""]=z.split("|");L.textContent=A.trim(),U.textContent=E.trim(),st.classList.add("show")},i.setFade=z=>{G.style.opacity=String(Math.min(1,Math.max(0,z)))},i.onCaption(i.setCaption),i.onFade(i.setFade);const k=document.getElementById("film");k.addEventListener("click",()=>{i.filmPlaying?i.stopFilm():(i.state.tour&&X.click(),i.playFilm()),k.classList.toggle("active",i.filmPlaying)}),i.sequencer.on(z=>{(z==="pause"||z==="ended")&&k.classList.toggle("active",!!i.filmPlaying)}),(new URLSearchParams(location.search).get("film")==="1"||new URLSearchParams(location.hash.slice(1)).get("film")==="1")&&(history.replaceState(null,"",location.pathname),i.onReady(()=>{setTimeout(()=>{k.click();const z=document.getElementById("sound-hint"),A=()=>{i.audio.enabled&&i.audio.setEnabled(!0),z.hidden=!0,removeEventListener("pointerdown",A),removeEventListener("keydown",A)};addEventListener("pointerdown",A),addEventListener("keydown",A),setTimeout(()=>{i.filmPlaying&&!i.audio.running&&(z.hidden=!1)},2500)},1200)}));const D=document.getElementById("alert");D.addEventListener("click",()=>{const z=!i.state.alert;i.setAlert(z),t.textContent=z?"RED ALERT · all hands to battle stations":"Condition green · stand down from red alert"}),i.onAlertChanged(z=>{D.classList.toggle("active",z),e.classList.toggle("red-alert",z)});const mt=document.getElementById("romulan"),rt=document.getElementById("cloak");mt.addEventListener("click",()=>{const z=!i.romulan.visible||i.romulan.userData.cloakTarget===1;i.setRomulan(z),t.textContent=z?"Romulan Bird-of-Prey decloaking off the port bow":"Bird-of-Prey cloaking — sensors lose contact"}),rt.addEventListener("click",()=>{if(!i.romulan.visible){i.setRomulan(!0);return}const z=i.romulan.userData.cloakTarget<.5;i.setCloak(z),rt.classList.toggle("active",z),t.textContent=z?"Cloaking device engaged":"Decloaking"}),i.onRomulanChanged(z=>{mt.classList.toggle("active",z),rt.classList.toggle("active",!z)});let xt=0;setInterval(()=>{!i.romulan.visible||i.romulan.userData.cloak>.5||i.state.playback||(xt++,xt%4===0&&i.romulanFire())},2e3);const ct=document.getElementById("klingon");ct.addEventListener("click",()=>{const z=!i.klingon.visible;i.setKlingon(z),t.textContent=z?"Klingon battle cruiser decloaking off the bow — shields up":"Klingon cruiser withdrawn"}),i.onKlingonChanged(z=>ct.classList.toggle("active",z));let Et=0;setInterval(()=>{!i.klingon.visible||i.state.playback||(Et++,Et%3===0&&i.klingonFire())},2e3),document.getElementById("phasers").addEventListener("click",()=>{i.firePhasers(),t.textContent="Phasers firing"}),document.getElementById("torpedo").addEventListener("click",()=>{i.fireTorpedo(),t.textContent="Photon torpedo away"}),document.getElementById("export").addEventListener("click",async z=>{const A=z.shiftKey;t.textContent=A?"Exporting GLB with interiors…":"Exporting GLB…";try{await i.exportGLB({interiors:A}),t.textContent=A?"GLB exported · cutaway variant":"GLB exported · uss-enterprise-ncc-1701.glb"}catch(E){console.error(E),t.textContent="Export failed · see console"}}),t.textContent="Reconstruction online · 11-foot studio model scale"}const Vv=document.getElementById("stage"),Eh=Lv(Vv);zv(Eh);window.viewer=Eh;
//# sourceMappingURL=index-xZW57Kip.js.map
